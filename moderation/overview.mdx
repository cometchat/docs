...
<Steps>
	...
	<Step title="Integrate & Test Moderation API">
		...
		<div className="mt-3 flex items-center gap-3 flex-wrap">
            <a className="inline-block border border-gray-300 px-4 py-2 rounded-md font-medium text-gray-700 hover:bg-gray-50" href="/rest-api/moderation">Go to API Docs ↗</a>
		</div>
	</Step>
</Steps>
