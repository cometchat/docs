...
sdk_version: "5.x"
description: "View screen shares from other participants in CometChat Calls SDK v5 on iOS: start/stop events, tracking the presenter, and in-call display. iOS cannot start a screen share."
---
