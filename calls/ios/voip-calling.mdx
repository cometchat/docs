...
sdk_version: "5.x"
description: "Set up CometChat Calls SDK v5 VoIP calling on iOS for call notifications, incoming call handling, and app wake flows."
---
...
- [CometChat Chat SDK](/sdk/ios/overview) and [Calls SDK](/calls/ios/setup) integrated, both initialized and logged in, in the order given in [Ringing: Before You Start](/calls/ios/ringing#before-you-start)
