...
On Android, both transcription controls live in the control panel's **More** menu and are shown by default.

### Transcription Button

The **Start Transcription** / **Stop Transcription** item toggles based on the current state. To hide it:
...
The **Show Captions** / **Hide Captions** item toggles the on-screen captions overlay. To hide it:
