        ...
        participantAdapter = ParticipantAdapter(
            ...
            onPinClick = { participant ->
                if (participant.isPinned) {
                    ...
                    callSession.pinParticipant(participant.uid, participant.pid)
                }
            }
        )
        ...
        participantAdapter = new ParticipantAdapter(new ParticipantAdapter.OnActionListener() {
            ...
            public void onPinClick(Participant participant) {
                if (participant.isPinned()) {
                    ...
                    callSession.pinParticipant(participant.getUid(), participant.getPid());
                }
            }
        });
...
class CallActivity : AppCompatActivity() {
    ...
    private fun setupUI() {
        ...
        participantAdapter = ParticipantAdapter(
            ...
            onPinClick = { 
                ...
                else callSession.pinParticipant(it.uid, it.pid)
            }
        )
        recyclerView.adapter = participantAdapter
    ...
    private fun joinCall() {
        ...
        val callContainer = findViewById<RelativeLayout>(R.id.callContainer)
...
public class CallActivity extends AppCompatActivity {
    ...
    private void joinCall() {
        ...
        RelativeLayout callContainer = findViewById(R.id.callContainer);
