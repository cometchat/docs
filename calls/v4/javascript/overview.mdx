...
1. CometChat SDK installed and configured. See the [Setup](/sdk/javascript/setup-sdk) guide.
...
For detailed setup instructions, see the [Calls SDK Setup](/calls/v4/javascript/setup) guide.
...
<CardGroup cols={3}>
  <Card title="Ringing" icon="phone-volume" href="/calls/v4/javascript/ringing">
  ...
  <Card title="Standalone Calling" icon="phone-flip" href="/calls/v4/javascript/standalone-calling">
...
[Get started with Ringing →](/calls/v4/javascript/ringing)
...
[Get started with Call Session →](/calls/v4/javascript/call-session)
...
[Get started with Standalone Calling →](/calls/v4/javascript/standalone-calling)
...
<CardGroup cols={2}>
  ...
  <Card title="Screen Sharing" icon="display" href="/calls/v4/javascript/presenter-mode">
    Share your screen or specific application windows during calls.
  </Card>
  <Card title="Video View Customization" icon="sliders" href="/calls/v4/javascript/video-view-customisation">
  ...
  <Card title="Call Logs" icon="list" href="/calls/v4/javascript/call-logs">
    Retrieve and display call history including duration, participants, and status.
  </Card>
  <Card title="Session Timeout" icon="clock" href="/calls/v4/javascript/session-timeout">
