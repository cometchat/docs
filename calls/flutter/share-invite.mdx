...
sdk_version: "5.x"
description: "Add invite sharing in CometChat Calls SDK v5 on Flutter so users can share call links and bring participants into sessions."
---
...
Listen for the share button click using `ButtonClickListeners`:
