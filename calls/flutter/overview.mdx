...
sdk_version: "5.x"
description: "Use CometChat Calls SDK v5 for Flutter to add voice and video calling, call sessions, participants, layouts, and in-call features."
---
...
sequenceDiagram
    ...
    App->>CometChatCalls: generateCallToken()
