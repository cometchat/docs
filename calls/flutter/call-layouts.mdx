...
Monitor layout changes using `LayoutListeners`:
...
class _LayoutListener extends LayoutListeners {
  ...
  // override only what you need (onParticipantListVisible, onParticipantListHidden, onPictureInPictureLayoutEnabled, onPictureInPictureLayoutDisabled).
}
