...
sdk_version: "5.x"
description: "Configure CometChat Calls SDK v5 audio modes on React Native for speakers, earpiece, Bluetooth, routing, and call audio behavior."
---
...
function AudioModeSelector() {
  ...
  const [availableModes] = useState<AudioMode[]>(['SPEAKER', 'EARPIECE', 'BLUETOOTH', 'HEADPHONES']);
