...
sdk_version: "5.x"
description: "Use CometChat Calls SDK v5 for React Native to add voice and video calling, call sessions, participants, layouts, and in-call features."
---
...
<Info>
  **Quick Reference for AI Agents & Developers**
  ...
  ```bash theme={null}
  # The Calls SDK plus its required peer dependencies
  ...
  * **Setup** (permissions, pods, Gradle) → [Setup](/docs/calls/react-native/setup)
  * **Authentication** → [Authentication](/docs/calls/react-native/authentication)
  * **Join a session** → [Join Session](/docs/calls/react-native/join-session)
  * **Session settings** → [Session Settings](/docs/calls/react-native/session-settings)
  * **Events** → [Events](/docs/calls/react-native/events)
  * **1:1 ringing** → [Ringing](/docs/calls/react-native/ringing)
  * **Ring a closed app** → [VoIP Calling](/docs/calls/react-native/voip-calling)
  * **Migrating from v4** → [Migration Guide](/docs/calls/react-native/migration-guide-v5)
</Info>
...
<Card title="Transcription" icon="closed-captioning" href="/calls/react-native/transcription">
