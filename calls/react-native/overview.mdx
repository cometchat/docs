...
<Info>
  ...
  * **Setup** (permissions, pods, Gradle) → [Setup](/calls/react-native/setup)
  * **Authentication** → [Authentication](/calls/react-native/authentication)
  * **Join a session** → [Join Session](/calls/react-native/join-session)
  * **Session settings** → [Session Settings](/calls/react-native/session-settings)
  * **Events** → [Events](/calls/react-native/events)
  * **1:1 ringing** → [Ringing](/calls/react-native/ringing)
  * **Ring a closed app** → [VoIP Calling](/calls/react-native/voip-calling)
  * **Migrating from v4** → [Migration Guide](/calls/react-native/migration-guide-v5)
</Info>
