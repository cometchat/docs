...
sdk_version: "5.x"
description: "Customize CometChat Calls SDK v5 call layouts on React Native for participant grids, speaker views, screen sharing, and call UI."
---
...
| Layout | Description |
|------|-------------|
| `'TILE'` | Starts with Tile layout |
| `'SIDEBAR'` | Starts with Sidebar layout |
| `'SPOTLIGHT'` | Starts with Spotlight layout |
...
const sessionSettings = {
  layout: 'SPOTLIGHT',
  enableSpotlightSwap: true, // Allow clicking tiles to spotlight
  enableSpotlightDrag: true, // Allow dragging tiles
};
```

| Option | Default | Description |
|--------|---------|-------------|
| `enableSpotlightSwap` | `true` | Click a participant tile to spotlight them |
| `enableSpotlightDrag` | `true` | Drag tiles to reposition in Spotlight mode |
