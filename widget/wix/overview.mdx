...
**Ready-to-Embed Code** — After configuration, Widget Builder generates a code snippet you add to your Wix site through **Settings → Custom Code**.
...
1. **Open Custom Code** — In your Wix dashboard, go to **Settings → Custom Code**
2. **Paste the code snippet**, set it to load on all pages at **Body – end**
