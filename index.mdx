...
<Tip>Using Cursor, VS Code, Claude, Lovable, or any MCP-enabled tool? Add our CometChat Docs MCP so your AI always pulls the latest CometChat documentation. [Add CometChat Docs MCP](https://www.cometchat.com/docs/mcp-server)</Tip>
