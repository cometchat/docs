...
| --- | --- |
| React | 18 or 19 |
| React Router | v6 or v7 — browser-only, or v7 framework mode with SSR |
| UI Kit | `@cometchat/chat-uikit-react` v7 — see the [React UI Kit v7](/ui-kit/react/overview) docs |

The Builder exports a React code package; [Integration](/chat-builder/react-router/integration) covers dropping it into a React Router project, including what framework mode needs.
