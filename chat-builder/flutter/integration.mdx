...
description: "Integrate CometChat UI Kit Builder into Flutter apps with exported assets, app keys, dependencies, and platform setup."
---
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/ui-kit/flutter/message-template"
  >
    Customize message bubble content, headers, footers, and status views.
  </Card>
  <Card
    title="Component View Slots"
    href="/ui-kit/flutter/customization-view-slots"
  >
