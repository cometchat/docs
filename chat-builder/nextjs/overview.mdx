...
The Builder exports a React code package; [Integration](/chat-builder/nextjs/integration) covers dropping it into a Next.js project, which mainly means keeping it out of server rendering.
