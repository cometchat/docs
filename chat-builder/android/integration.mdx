...
<CardGroup cols={2}>
  <Card title="Builder Settings reference" href="/chat-builder/android/builder-settings">
    Every feature toggle, layout option, and style key in `cometchat-builder-settings.json`.
  </Card>
  <Card title="Component-level customizations" href="/chat-builder/android/builder-customisations">
    Apply settings to components via `BuilderSettingsHelper` and tweak styles in `themes.xml`.
  </Card>
  <Card title="Message Templates" href="/ui-kit/android/message-template">
  ...
  <Card title="DataSource & ChatConfigurator" href="/ui-kit/android/customization-datasource">
