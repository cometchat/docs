...
description: "Customize React UI Kit Builder components by adjusting CometChat app props, styling, group messages, and behavior."
---

Your settings file, `src/builder/cometchat-builder-settings.json`, handles feature toggles, layout and theming — see [UI Kit Builder Settings](/chat-builder/react/builder-settings). This page covers what to do when you need more than a setting.
...
Which one applies depends on `layout.chatType` when the sidebar is hidden — see [Builder Settings](/chat-builder/react/builder-settings#3-layout-layout).
