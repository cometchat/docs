...
> Follow these steps to create a Backend Tool Action Agent in Mastra that can call APIs or perform server-side tasks on behalf of the user.

# Build Your Backend Tool Action Agent with Mastra
