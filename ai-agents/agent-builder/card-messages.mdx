...
<Frame>
  <video autoPlay loop muted playsInline className="w-full rounded-xl" aria-label="Enabling the Card Messages tool on an agent, which opens the Card Builder prompt" src="/images/card-builder/agent-card-messages.mp4" />
</Frame>
