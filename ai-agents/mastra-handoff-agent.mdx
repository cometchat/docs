---
title: "Build Your Handoff Agent with Mastra"
description: "Follow these steps to create a Handoff Agent in Mastra that can transfer a conversation to the right human or system when needed."
---

Imagine an agent that knows its limits. When it detects a user needs **human support**, or another specialist agent, it can gracefully **handoff** the chat instead of fumbling for an answer.
...
* Add a **relay agent** that can ask multiple humans/agents and return the answer.  
