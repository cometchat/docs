...
* Root: [mastra-knowledge-agent](https://github.com/cometchat/ai-agent-mastra-examples/tree/main/mastra-knowledge-agent)  
* Agents: [src/mastra/agents](https://github.com/cometchat/ai-agent-mastra-examples/tree/main/mastra-knowledge-agent/src/mastra/agents)  
* Tools: [src/mastra/tools](https://github.com/cometchat/ai-agent-mastra-examples/tree/main/mastra-knowledge-agent/src/mastra/tools)  
* Server/API: [src/mastra/server](https://github.com/cometchat/ai-agent-mastra-examples/tree/main/mastra-knowledge-agent/src/mastra/server)
