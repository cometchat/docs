...
- System prompt (`buildSystemPrompt`) reminds the model when to call each tool, to summarize results as Markdown tables, and to fire confetti when users celebrate.
