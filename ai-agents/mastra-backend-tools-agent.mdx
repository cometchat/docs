---
title: "Build Your Backend Action Agent with Mastra"
sidebarTitle: "Backend Action Agent"
...
Core files and folders for the Backend Action Agent (browse source on GitHub):
...
<Steps>
  ...
  <Step title="Adjust settings">Theme, layout, features; ensure the Backend Action agent is attached.</Step>
...
Once your Backend Action Agent is configured, you can integrate it into your app using the CometChat No Code - Widget:
...
> **Note:** The **Backend Action agent** you connected in earlier steps is already part of the exported configuration, so your end-users will chat with that agent immediately.
...
<CardGroup>
  <Card
    ...
    href="https://github.com/cometchat/ai-agent-mastra-examples/tree/main/mastra-backend-tools-agent"
    horizontal
  />
  <Card
    title="Agent"
    description="deals agent"
    href="https://github.com/cometchat/ai-agent-mastra-examples/blob/main/mastra-backend-tools-agent/src/mastra/agents/deals-agent.ts"
    horizontal
  />
  <Card
    title="Tools"
    description="get-deals tool and registry"
    href="https://github.com/cometchat/ai-agent-mastra-examples/tree/main/mastra-backend-tools-agent/src/mastra/tools"
    horizontal
  />
  <Card
    title="Server"
    description="Mastra server entry"
    href="https://github.com/cometchat/ai-agent-mastra-examples/blob/main/mastra-backend-tools-agent/src/mastra/index.ts"
    horizontal
  />
</CardGroup>
