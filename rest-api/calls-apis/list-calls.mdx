...
openapi: get /calls
description: "lists all the calls that are available in the app. It can include participants, recordings and transcriptions property in the response (if present)."
---
...
The `transcriptions` array carries at most the 5 most recent transcriptions of each call. Use [Get Call Transcriptions](/rest-api/calls-apis/get-call-transcriptions) for the full, paginated list.
...
| Get calls with transcriptions | `hasTranscription=true` |
