...
description: "Get CometChat call details by sessionId with REST API, including participants, metrics, duration, recording and transcription information."
---

Retrieve detailed information about a specific call using its session ID. This endpoint returns complete call data including all participants, their individual metrics, and recording and transcription information.

The `transcriptions` array carries at most the 5 most recent transcriptions of the call. Use [Get Call Transcriptions](/rest-api/calls-apis/get-call-transcriptions) for the full, paginated list.
