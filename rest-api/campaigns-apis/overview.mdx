...
| ----------------------------------------------------------------------------------------- | -------- | --------------------------------------------- |
| [List channels](/rest-api/campaigns-apis/channels/list-channels)                          | `GET`    | `/channels`                                   |
| [Check channel availability](/rest-api/campaigns-apis/channels/check-availability)        | `GET`    | `/channels/availability`                      |
| [List templates](/rest-api/campaigns-apis/templates/list-templates)                       | `GET`    | `/templates`                                  |
| [Get template](/rest-api/campaigns-apis/templates/get-template)                           | `GET`    | `/templates/{templateId}`                     |
| [Delete feed item](/rest-api/campaigns-apis/notification-feed/delete-feed-item)           | `DELETE` | `/notification-feed/{feedItemId}`             |
