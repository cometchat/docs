...
{/* Features */}
<div className="mb-10">
  <h2 className="text-gray-700 dark:text-white text-2xl font-semibold">Features</h2>

  <CardGroup className="mt-4">
    <Card title="Model Agnostic" description="Connect any AI provider or custom model to your agents." />
    <Card title="Customizable UI" description="Easily embed chat UIs or use headless APIs." />
    <Card title="Actionable Insights" description="Monitor agent performance and user interactions." />
    <Card title="Seamless Integration" description="Wire agents into your app’s logic and state." />
  </CardGroup>
