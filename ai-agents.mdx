  ...
  <Steps className="mt-6">
    ...
    <Step title="Add to your frontend" description="Choose no‑code widget, prebuilt components, or headless SDK.">
      ...
      <CardGroup cols={3} className="mt-4">
        <Card title="Widget" icon={<img src="/images/icons/ai-agent.svg" alt="Widget" />} description="No‑code" href="/widget/ai-agents" horizontal />
        ...
        <Card title="JavaScript SDK" icon={<img src="/images/icons/js.svg" alt="JavaScript SDK" />} href="/web-shared/javascript-apis" horizontal>Headless UI</Card>
      </CardGroup>
      <CardGroup cols={3} className="mt-4">
