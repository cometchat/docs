...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Mastra" icon={<img src="/images/mastra.svg" alt="Mastra" />} href="https://mastra.ai/agents" horizontal/>
   </Columns>
</div>
...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Dashboard" icon={<img src="/images/mastra.svg" alt="CometChat Dashboard" />} href="https://app.cometchat.com/apps" horizontal />
   </Columns>
</div>
...
<div className="mb-10">
	<h2 className="text-gray-700 dark:text-white text-2xl font-semibold">Customise your Agent.</h2>
	<p className="text-gray-600 dark:text-gray-300">UI and UX of agent.</p>

   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Chat Builder" icon={<img src="/images/mastra.svg" alt="Builder" />} href="https://preview.cometchat.com/" horizontal />
   </Columns>
</div>
...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Docs" icon={<img src="/images/mastra.svg" alt="Docs" />} href="/ai-agents-mastra" horizontal />
   </Columns>
</div>
