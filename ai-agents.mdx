...
<div className="mb-10">
  ...
  <CardGroup className="mt-4" cols={3}>
    <Card title="Create & Customize with Ease" description="Create, train, and tailor intelligent chatbots, agents, and copilots to your exact use cases." />
    <Card title="No-Code Integration" description="Add AI agents without writing code using embeddable widgets and guided setup." />
    <Card title="Seamless Integration" description="Deploy via embedded UI or headless APIs wired directly to your app’s logic and state." />
    <Card title="Context-Aware Intelligence" description="Leverage your app’s data and user context for relevant, personalized responses." />
    <Card title="Model-Agnostic Flexibility" description="Swap or upgrade AI models anytime without rebuilding the user experience." />
    <Card title="Frontend Actions" description="Let agents trigger real-time UI updates and interactive components in your app." />
    <Card title="Engaging Experiences" description="Deliver natural, intuitive AI interactions that feel native to your product." />
  </CardGroup>
