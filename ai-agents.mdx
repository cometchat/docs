...
<div className="mb-10">
  ...
  <p className="text-gray-600 dark:text-gray-300">
    CometChat AI Agents can be integrated into your application in two primary ways:
  </p>

  <Steps className="mt-4">
    <Step title="Embed UI" description="Use our pre-built chat widget to quickly add AI agents with minimal setup." />
    <Step title="Headless API" description="Integrate AI agents directly into your app’s logic and state for full control." />
  </Steps>
