  ...
  <Steps className="mt-6">
    ...
    <Step title="Setup Frontend Actions & Tools" description="Extend what the agent can do in your UI.">
      ...
      <div className="flex flex-wrap gap-3 mt-4">
        <a href="/ai-agent-mastra#actions" className="inline-flex items-center gap-1 px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800" target="/ai-agents/actions">Get Started with Actions ↗</a>
        <a href="/ai-agent-mastra#tools" className="inline-flex items-center gap-1 px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-800" target="/ai-agents/tools">Get Started with Tools ↗</a>
      </div>
