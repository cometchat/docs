...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Mastra" icon={<img src="/images/mastra.svg" alt="Mastra" />} href="https://mastra.ai/agents" />
   </Columns>
</div>
...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Dashboard" icon={<img src="/images/mastra.svg" alt="CometChat Dashboard" />} href="https://app.cometchat.com/apps" />
   </Columns>
</div>
...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Chat Builder" icon={<img src="/images/mastra.svg" alt="Builder" />} href="https://preview.cometchat.com/" />
   </Columns>
</div>
...
<div className="mb-10">
   ...
   <Columns cols={4} className="items-center gap-x-12">
      <Card title="Docs" icon={<img src="/images/mastra.svg" alt="Docs" />} href="/ai-agents-mastra" />
   </Columns>
</div>
