  ...
  <Steps className="mt-6">
    <Step title="Connect your AI Agent" description="Link an existing agent or provider deployment.">
      <CardGroup cols={4} className="mt-4">
        <Card title="Mastra" href="/ai-agent-mastra" />
        <Card title="LangGraph" description="Coming Soon" />
        <Card title="Agno" description="Coming Soon" />
        <Card title="CrewAI Flows" description="Coming Soon" />
      </CardGroup>
    ...
    <Step title="Add to your frontend" description="Choose no‑code widget, prebuilt components, or headless SDK.">
      <CardGroup cols={3} className="mt-4">
        <Card title="Widget" description="No‑code" href="/widget/overview" />
        <Card title="React UI Kit" description="Prebuilt" href="/ui-kit/react/overview" />
        <Card title="JS SDK" description="Headless" href="/web-shared/javascript-apis" />
      </CardGroup>
      <CardGroup cols={4} className="mt-4">
        <Card title="React Native" description="Coming Soon" />
        <Card title="Android" description="Coming Soon" />
        <Card title="iOS Swift" description="Coming Soon" />
        <Card title="Flutter" description="Coming Soon" />
      </CardGroup>
    </Step>
  </Steps>
</div>
