...
<Card title="iOS (SDK — recommended)" icon={<img src="/images/icons/swift.svg" alt="iOS Push Notifications SDK" />} href="/notifications/ios-push-notifications-sdk">
Drop-in SDK — APNs, VoIP and CallKit handled for you. Works with or without the UI Kit.
</Card>

<Card title="iOS (APNs — manual)" icon={<img src="/images/icons/swift.svg" alt="iOS (APNs)" />} href="/notifications/ios-apns-push-notifications">
