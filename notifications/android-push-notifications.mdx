...
<Info>
**Complete the [shared setup](/notifications/push-overview#shared-setup) first** — enable Push Notifications, add your FCM provider, and configure Firebase (`google-services.json` + service account JSON). This guide covers only the Android app wiring.
</Info>
...
## 2. Manifest permissions and services
...
## 3. Application wiring, sample code, and callbacks
...
### 7.2 Add the ShortcutBadger dependency
...
### 7.4 Update the app badge from the push payload
...
### 7.5 Show unread count in the notification
...
### 7.6 Clear badge when the app opens
...
{/* ## 9. What arrives in the push payload
