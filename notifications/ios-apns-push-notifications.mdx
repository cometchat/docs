...
<Info>
**Complete the [shared setup](/notifications/push-overview#shared-setup) first** — enable Push Notifications, add your **APNs Device** and **APNs VoIP** providers, and finish the Apple/Xcode setup (`.p8` key + capabilities). This guide covers only the iOS app wiring.
</Info>
