...
- **Notify when my message is quoted** *(quoted replies only)* — the sender of the original message is notified whenever someone quote-replies (swipe-to-reply) to their message, independent of threads or mentions. In the SDK this maps to `QuotedRepliesOptions.SUBSCRIBE_TO_QUOTES_ON_OWN_MESSAGES`.
