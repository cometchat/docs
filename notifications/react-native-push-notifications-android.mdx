...
- Prerequisite: the shared dashboard + Firebase setup in the [overview](/notifications/push-overview#shared-setup).
...
<Info>
**Complete the [shared setup](/notifications/push-overview#shared-setup) first** — enable Push Notifications, add your FCM provider, and configure Firebase (`google-services.json` + service account JSON). This guide covers only the React Native app wiring.
</Info>
