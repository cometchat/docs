---
title: "React Native Push Notifications (iOS) — Legacy"
...
<Warning>
**Legacy guide.** This page covers the previous setup, which copies the sample app's notification stack (APNs, CallKeep, react-native-voip-push-notification). For new integrations, use the `@cometchat/push-notifications-react-native` package — see [React Native Push Notifications (iOS)](/notifications/react-native-push-notifications-ios).
</Warning>
...
<CardGroup cols={2}>
<Card title="Push Notifications (Android)" icon="android" href="/notifications/react-native-push-notifications-android-legacy">
