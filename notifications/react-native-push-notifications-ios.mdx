...
<Note>
Still on the previous setup that copies the sample app's notification stack? The [legacy iOS guide](/notifications/react-native-push-notifications-ios-legacy) still covers it.
</Note>
