...
- Prerequisite: the shared dashboard + Apple/APNs setup in the [Getting Started](/notifications/push-getting-started) guide.
...
<Info>
**Complete the [Getting Started](/notifications/push-getting-started) guide first** — enable Push Notifications, add your **APNs** (and **APNs VoIP**) providers, and finish the Apple/Xcode setup (`.p8` key + capabilities). This guide covers only the React Native app wiring.
</Info>
