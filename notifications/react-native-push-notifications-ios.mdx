...
[`PNNotificationTapInfo`](#63-local-notifications-and-navigation) your handler receives are not the same shape:
...
[6.3](#63-local-notifications-and-navigation)). Read the count from `aps.badge`, or from the Chat SDK.
</Warning>
