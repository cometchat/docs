...
* **[Presence Subscription](/docs/sdk/flutter/user-presence):** Represents the subscription type for user presence (real-time online/offline status)
...
Know more about auto mode connection [click here](/docs/sdk/flutter/connection-behaviour)
...
Know more about manual mode connection [click here](/docs/sdk/flutter/connection-behaviour)
