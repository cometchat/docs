...
1. A [Text Message](/docs/sdk/flutter/send-message#text-message), the most common and standard message type.
2. A [Media Message](/docs/sdk/flutter/send-message#media-message), for sending photos, videos and files.
3. A [Custom Message](/docs/sdk/flutter/send-message#custom-message), for sending completely custom data using Map structures.
4. A [Interactive Messages](/docs/sdk/flutter/interactive-messages) , for sending end-user interactive messages of type form, card and custom Interactive
...
It is also possible to send interactive messages from CometChat , to know more [click here](/docs/sdk/flutter/interactive-messages)
