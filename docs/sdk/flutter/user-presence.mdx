...
When you [retrieve the list of users](/docs/sdk/flutter/retrieve-users) , in the[User](/docs/sdk/flutter/user-management#user-class) object, you will receive 2 keys:
