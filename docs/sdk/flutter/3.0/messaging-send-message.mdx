...
1. A [Text Message](/docs/sdk/flutter/3.0/messaging-send-message#text-message), the most common and standard message type.
2. A [Media Message](/docs/sdk/flutter/3.0/messaging-send-message#media-message), for sending photos, videos and files.
3. A [Custom Message](/docs/sdk/flutter/3.0/messaging-send-message#custom-message), for sending completely custom data using Map structures.
