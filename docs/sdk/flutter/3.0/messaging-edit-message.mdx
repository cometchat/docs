...
1. Adding a listener to receive [real-time message edit events](/docs/sdk/flutter/3.0/messaging-edit-message#real-time-message-edit-events) when your app is running
2. Calling a method to retrieve [missed message edit events](/docs/sdk/flutter/3.0/messaging-edit-message#missed-message-edit-events) when your app was not running
