...
2. You [log in the user to CometChat](/docs/sdk/flutter/3.0/authentication) (programmatically)
...
For more details on the fields present in the User class, please check [this](/docs/sdk/flutter/3.0/users-user-management#user-class)
