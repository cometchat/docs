...
We recommend before trying this, you refer to the [Message structure and hierarchy guide](/docs/sdk/flutter/3.0/message-structure-and-hierarchy) to get familiar with the various categories of messages.
...
We recommend you refer to the [Message structure and hierarchy guide](/docs/sdk/flutter/3.0/message-structure-and-hierarchy) to get familiar with the various types of messages before trying this out.
