...
| `setMainVideoContainerSetting(videoSettings)`      | This method can be used to customize the main video container. You can read more about this [here](/docs/sdk/flutter/3.0/video-view-customisation).                                                                                                                                                                                                 |
