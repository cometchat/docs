...
Before starting a call session you have to generate a call token using the generateToken() method of the CometChatCalls SDK as mentioned [here](/docs/sdk/javascript/direct-call#generate-call-token).
