...
This guide demonstrates how to add chat to a JavaScript application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/javascript/key-concepts) guide.
...
* [Presence Subscription](/docs/sdk/javascript/user-presence): Represents the subscription type for user presence (real-time online/offline status)
* **autoEstablishSocketConnection(boolean value)**: This property takes a boolean value which when set to `true` informs the SDK to manage the web-socket connection internally. If set to `false`, it informs the SDK that the web-socket connection will be managed manually. The default value for this parameter is true. For more information on this, please check the [Managing Web-Socket connections manually](/docs/sdk/javascript/managing-web-sockets-connections-manually) section. The default value for this property is **true.**
...
This straightforward authentication method is ideal for proof-of-concept (POC) development or during the early stages of application development. For production environments, however, we strongly recommend using an [Auth Token](/docs/sdk/javascript/authentication-overview#login-using-auth-token) instead of an Auth Key to ensure enhanced security.
...
* Please refer to the section to integrate [React UI Kit](/docs/ui-kit/react/overview) into your website.
* Please refer to the section to integrate [Angular UI Kit](/docs/ui-kit/angular/overview) into your website.
* Please refer to the section to integrate [Vue UI Kit](/docs/ui-kit/vue/overview) into your website.

## Integrate our Chat Widget

* Please refer to the section to integrate [Chat Widget](/docs/widget/html-bootstrap-jquery) into your Website.
