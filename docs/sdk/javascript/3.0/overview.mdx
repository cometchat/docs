...
This guide demonstrates how to add chat to a JavaScript application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/javascript/3.0/key-concepts) guide.
...
[React Sample App](https://github.com/cometchat-pro/javascript-react-chat-app/tree/v3)

[Angular Sample App](https://github.com/cometchat-pro/javascript-angular-chat-app/tree/v3)

[Vue Sample App](https://github.com/cometchat-pro/javascript-vue-chat-app/tree/v3)
...
<Tabs>
<Tab title="Home.js (Functional Component)">
```javascript
...
* [Presence Subscription](/docs/sdk/javascript/3.0/user-presence): Represents the subscription type for user presence (real-time online/offline status)
* **autoEstablishSocketConnection(boolean value)**: This property takes a boolean value which when set to `true` informs the SDK to manage the web-socket connection internally. If set to `false` , it informs the SDK that the web-socket connection will be managed manually. The default value for this parameter is true. For more information on this, please check the [Managing Web-Socket connections manually](/docs/sdk/javascript/3.0/advanced-managing-web-socket-connections-manually) section. The default value for this property is **true.**
...
* Please refer to the [React UI Kit](/docs/ui-kit/react/v3/overview) section to integrate React UI Kit in your website.
* Please refer to the [Angular UI Kit](/docs/ui-kit/angular/3.0/overview) section to integrate Angular UI Kit in your website.
* Please refer to the [Vue UI Kit](/docs/ui-kit/vue/3.0/overview) section to integrate Vue UI Kit in your website.

## Integrate our Chat Widget

* Please refer to the [Chat Widget](/docs/widget/html-bootstrap-jquery) section to integrate Chat Widget in your Website.
