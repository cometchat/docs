...
Please follow the [setup](/docs/sdk/javascript/3.0/setup) instructions to upgrade to latest version of V3 before proceeding further
...
You can read more about the `markAsDelivered()` method [here](/docs/sdk/javascript/3.0/messaging-receipts#mark-messages-as-delivered).
...
You can read more about the `markAsRead()` method [here](/docs/sdk/javascript/3.0/messaging-receipts#mark-messages-as-read).
...
<Tabs>
<Tab title="Fetching User/Group Tags in Conversation">
```javascript
