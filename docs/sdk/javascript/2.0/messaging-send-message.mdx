...
1. A [text message](/docs/sdk/javascript/2.0/messaging-send-message#text-message) the most common and standard message type.
2. A [media message](/docs/sdk/javascript/2.0/messaging-send-message#media-message), for sending photos, videos and files.
3. A [custom message](/docs/sdk/javascript/2.0/messaging-send-message#custom-message), for sending completely custom data using JSON structures.
