...
This guide demonstrates how to add chat to an iOS application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/ios/2.0/key-concepts) guide.
...
Please refer [iOS UI Kit](/docs/ui-kit/ios/v2/overview) section to integrate iOS UI Kit inside your app.
