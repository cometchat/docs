...
Please follow the [setup](/docs/sdk/ios/setup) instructions to upgrade to the latest V3 version.
...
You can read more about the `markAsDelivered()` method [here](/docs/sdk/ios/delivery-read-receipts#mark-messages-as-delivered)
...
You can read more about the `markAsRead()` method [here](/docs/sdk/ios/delivery-read-receipts#mark-messages-as-read).
