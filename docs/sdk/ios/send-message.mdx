...
1. A [text message](/docs/sdk/ios/send-message#text-message), the most common and standard message type.
2. A [media message](/docs/sdk/ios/send-message#media-message), for sending photos, videos and files.
3. A [custom message](/docs/sdk/ios/send-message#custom-message), for sending completely custom data using JSON structures.
4. [A Interactive Messages](/docs/sdk/ios/interactive-messages) , for sending end-user interactive messages of type form, card and custom Interactive
...
It is also possible to send interactive messages from CometChat , to know more [click here](/docs/sdk/ios/interactive-messages)
