...
This below table is applicable only when [these steps are followed](/docs/sdk/ios/prepare-your-app-for-background-updates#step-1-add-background-modes-in-capabilities).

autoEstablishSocketConnection usage can be found in [Managing Web-Socket connections manually](/docs/sdk/ios/managing-web-socket-connections-manually).
