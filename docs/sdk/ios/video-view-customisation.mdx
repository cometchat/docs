...
Once you have decided to implement [Default Calling](/docs/sdk/ios/default-calling) or [Direct Calling](/docs/sdk/ios/direct-calling) calling and followed the steps to implement them. Just few additional methods will help you quickly customize the main video container.

Please make sure your callSettings is configured accordingly for [Default Calling](/docs/sdk/ios/default-calling) or [Direct Calling](/docs/sdk/ios/direct-calling).
