...
This guide demonstrates how to add chat to an iOS application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/ios/3.0/key-concepts) guide.
...
* [Presence Subscription](/docs/sdk/ios/3.0/user-presence): Represents the subscription type for user presence (real-time online/offline status)
...
Please refer [iOS UI Kit](/docs/ui-kit/ios/v3/overview) section to integrate iOS UI Kit inside your app.
