...
1. Adding a listener to receive [real-time messages](/docs/sdk/ios/3.0/receive-a-message#real-time-messages) when your app is running
2. Calling a method to retrieve [missed messages](/docs/sdk/ios/3.0/receive-a-message#missed-messages) when your app was not running
