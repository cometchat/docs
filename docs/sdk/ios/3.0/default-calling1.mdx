...
As mentioned in the [Overview](/docs/sdk/ios/3.0/calling) section, Once the call is initiated, there are three options that can be possible:
...
| setMainVideoAspectRatio(\_ asceptRatio: CallSettings.AsceptRatio) | This method can be used to customize the main video container. You can read more about this [here](/docs/sdk/ios/3.0/video-view-customisation1).                                                                                                                                                                                                                                             |
