...
1. A [text message](/docs/sdk/ios/3.0/send-a-message#text-message), the most common and standard message type.
2. A [media message](/docs/sdk/ios/3.0/send-a-message#media-message), for sending photos, videos and files.
3. A [custom message](/docs/sdk/ios/3.0/send-a-message#custom-message), for sending completely custom data using JSON structures.
