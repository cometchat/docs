...
1. [User Delegate (Listener)](/docs/sdk/ios/3.0/all-real-time-delegates-listeners#user-delegate-methods)
2. [Group Delegate (Listener)](/docs/sdk/ios/3.0/all-real-time-delegates-listeners#group-delegate-methods)
3. [Message Delegate (Listener)](/docs/sdk/ios/3.0/all-real-time-delegates-listeners#message-delegate-methods)
4. [Call Delegate (Listener)](/docs/sdk/ios/3.0/all-real-time-delegates-listeners#call-delegate-methods)
