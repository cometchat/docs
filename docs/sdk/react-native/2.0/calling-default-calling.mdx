...
As mentioned in the [Overview](/docs/sdk/react-native/2.0/calling-default-calling) section, Once the call is initiated, there are three options that can be possible:
