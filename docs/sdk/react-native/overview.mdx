...
This guide demonstrates how to add chat to a React Native application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/react-native/key-concepts) guide.
...
\
The calling component requires some configuration. Please follow the steps mentioned [here](/docs/sdk/react-native/overview#calling-component-configuration).
...
* [Presence Subscription](/docs/sdk/react-native/user-presence): Represents the subscription type for user presence (real-time online/offline status)
* **autoEstablishSocketConnection(boolean value)**: This property takes a boolean value which when set to true informs the SDK to manage the web-socket connection internally. If set to false, it informs the SDK that the web-socket connection will be managed manually. The default value for this parameter is true. For more information on this, please check the [Managing connections manually](/docs/sdk/react-native/managing-web-sockets-connections-manually) section. The default value for this property is **true.**
...
This straightforward authentication method is ideal for proof-of-concept (POC) development or during the early stages of application development. For production environments, however, we strongly recommend using an [Auth Token](/docs/sdk/react-native/authentication-overview#login-using-auth-token) instead of an Auth Key to ensure enhanced security.
...
Please refer to the [React Native UI Kit](/docs/ui-kit/react-native/overview)section to integrate React Native UI Kit inside your app.
