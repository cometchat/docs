...
Once the call request is sent and the receiver has accepted the call, both the initiator and the receiver need to call the [startSession()](/docs/sdk/react-native/direct-call#start-call-session) method.
