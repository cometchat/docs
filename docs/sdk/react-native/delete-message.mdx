...
While [deleting a message](/docs/sdk/react-native/delete-message#delete-a-message) is straightforward, receiving events for deleted messages with CometChat has two parts:

1. Adding a listener to receive [real-time message deletes](/docs/sdk/react-native/delete-message#real-time-message-delete-events) when your app is running.
2. Calling a method to retrieve [missed message deletes](/docs/sdk/react-native/delete-message#missed-message-delete-events) when your app was not running.
