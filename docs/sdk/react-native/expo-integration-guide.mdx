...
To add CometChat Calls SDK, please refer to the steps mentioned [here](/docs/sdk/react-native/calling-setup#add-the-cometchatcalls-dependency).
...
To initialize CometChat Calls SDK, please refer to the guide [here](/docs/sdk/react-native/calling-setup#initialize-cometchatcalls)
