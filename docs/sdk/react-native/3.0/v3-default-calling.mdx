...
As mentioned in the [Overview](/docs/sdk/react-native/3.0/v3-default-calling) section, Once the call is initiated, there are three options that can be possible:
