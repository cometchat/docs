...
This guide demonstrates how to add chat to a React Native application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/react-native/3.0/key-concepts) guide.
...
The calling component requires some configuration. Please follow the steps mentioned [here](/docs/sdk/react-native/3.0/overview#calling-component-configuration).
...
* [Presence Subscription](/docs/sdk/react-native/3.0/user-presence): Represents the subscription type for user presence (real-time online/offline status)
* **autoEstablishSocketConnection(boolean value)**: This property takes a boolean value which when set to true informs the SDK to manage the web-socket connection internally. If set to false, it informs the SDK that the web-socket connection will be managed manually. The default value for this parameter is true. For more information on this, please check the [Managing Web-Socket connections manually](/docs/sdk/react-native/3.0/managing-web-socket-connections-manually) section. The default value for this property is **true.**
