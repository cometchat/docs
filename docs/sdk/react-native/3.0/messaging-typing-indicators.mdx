...
<Tabs>
<Tab title="JavaScript (Start User Typing)">
```javascript
let receiverId = "UID";
...
<Tab title="JavaScript (Start Group Typing)">
```javascript
let receiverId = "GUID";
...
<Tab title="Typescript (Start User Typing)">
```typescript
...
<Tab title="Typescript (Start Group Typing)">
```typescript
...
<Tabs>
<Tab title="JavaScript (Stop User Typing)">
```javascript
let receiverId = "UID";
let receiverType = CometChat.RECEIVER_TYPE.USER;
...
<Tab title="JavaScript (Stop Group Typing)">
```javascript
let receiverId = "GUID";
let receiverType = CometChat.RECEIVER_TYPE.GROUP;
...
<Tab title="Typescript (Stop User Typing)">
```typescript
let receiverId: string = "UID";
let receiverType: string = CometChat.RECEIVER_TYPE.USER;
...
<Tab title="Typescript (Stop Group Typing)">
```typescript
let receiverId: string = "GUID";
let receiverType: string = CometChat.RECEIVER_TYPE.GROUP;
