...
1. [Text Message](/docs/sdk/react-native/send-message#text-message) is the most common and standard message type.
2. [Media Message](/docs/sdk/react-native/send-message#media-message), for sending photos, videos and files.
3. [custom message](/docs/sdk/react-native/send-message#custom-message), for sending completely custom data using JSON structures.
4. [Interactive Message](/docs/sdk/react-native/interactive-messages) for sending end-user interactive messages of type form, card and custom Interactive You can also send metadata along with a text, media or custom message. Think, for example, if you want to share the user's location with every message, you can use the metadata field.
...
It is also possible to send interactive messages from CometChat, to know more [click here](/docs/sdk/react-native/interactive-messages)
