...
Once you have decided to implement [Default Calling](/docs/sdk/react-native/default-call) or [Direct Calling](/docs/sdk/react-native/direct-call) and followed the steps to implement them. Just few additional listeners and methods will help you quickly implement call recording in your app.

You need to make changes in the `CometChatCalls.OngoingCallListener` constructor and add the required listeners for recording. Please make sure your callSettings is configured accordingly for [Default Calling](/docs/sdk/react-native/default-call) or [Direct Calling](/docs/sdk/react-native/direct-call).
