...
Once you have decided to implement [Direct Calling](/docs/sdk/ionic/direct-call) followed the steps to implement them. Just few additional listeners and methods will help you quickly implement call recording in your app.

You need to make changes in the `CometChatCalls.startSession()` method and add the required listeners for recording. Please make sure your callSettings is configured accordingly for [Direct Calling](/docs/sdk/ionic/direct-call).
