...
1. [Text Message](/docs/sdk/ionic/send-message#text-message) is the most common and standard message type.
2. [Media Message](/docs/sdk/ionic/send-message#media-message), for sending photos, videos and files.
3. [Custom Message](/docs/sdk/ionic/send-message#custom-message), for sending completely custom data using JSON structures.
4. [Interactive Messages](/docs/sdk/ionic/interactive-messages), for sending end-user interactive messages of type form, card and custom Interactive
...
It is also possible to send interactive messages from CometChat, to know more [click here](/docs/sdk/ionic/interactive-messages)
