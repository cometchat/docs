...
Please follow the [setup](/docs/sdk/ionic/3.0/setup) instructions to upgrade to the latest V3 version.
...
You can read more about the `markAsDelivered()` method [here](/docs/sdk/ionic/3.0/messaging-receipts#mark-messages-as-delivered).
...
You can read more about the `markAsRead()` method [here](/docs/sdk/ionic/3.0/messaging-receipts#mark-messages-as-read).
