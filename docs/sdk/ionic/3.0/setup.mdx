...
The calling component requires some additional configuration. Please follow the steps mentioned [here](/docs/sdk/ionic/3.0/setup#calling-component-configuration).
