...
Once you have decided to implement [Direct Calling](/docs/sdk/ionic/direct-call) and followed the steps to implement them. Just few additional methods will help you quickly customize the main video container.

Please make sure your callSettings is configured accordingly for [Direct Calling](/docs/sdk/ionic/direct-call).
