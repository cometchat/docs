...
1. [User Listener](/docs/sdk/ionic/2.0/resources-all-real-time-listeners#user-listener)
2. [Group Listener](/docs/sdk/ionic/2.0/resources-all-real-time-listeners#group-listener)
3. [Message Listener](/docs/sdk/ionic/2.0/resources-all-real-time-listeners#message-listener)
