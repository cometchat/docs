...
This guide demonstrates how to add chat to a Cordova/ionic application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/ionic/2.0/key-concepts) guide.
...
The calling component requires some configuration. Please follow the steps mentioned [here](/docs/sdk/ionic/2.0/overview#calling-component-configuration).
...
* [Presence Subscription](/docs/sdk/ionic/2.0/user-presence)
