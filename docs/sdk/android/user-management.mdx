...
2. You [log in the user to CometChat](/docs/sdk/android/authentication-overview) (programmatically)
...
For more details on the fields present in the User class, please check [this](/docs/sdk/android/user-management#user-class)
