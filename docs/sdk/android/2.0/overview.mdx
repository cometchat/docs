...
This guide demonstrates how to add chat to an Android application. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/android/2.0/key-concepts) guide.
...
* Please refer [Overview](/docs/ui-kit/android/overview) section to integrate Android Java UI Kit inside your app.
