...
1. A [Text Message](/docs/sdk/android/2.0/send-message#text-message), the most common and standard message type.
2. A [Media Message](/docs/sdk/android/2.0/send-message#media-message), for sending photos, videos and files.
3. A [Custom Message](/docs/sdk/android/2.0/send-message#custom-message), for sending completely custom data using JSON structures.
