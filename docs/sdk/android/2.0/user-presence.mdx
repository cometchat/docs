...
When you [retrieve the list of users](/docs/sdk/android/2.0/retrieve-users), in the [User](/docs/sdk/android/2.0/user-management#user-class) object, you will receive 2 keys:
