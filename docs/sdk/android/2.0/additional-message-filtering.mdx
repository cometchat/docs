...
We recommend before trying this, you refer to the [Message structure and hierarchy guide](/docs/sdk/android/2.0/message-structure-and-hierarchy) to get familiar with the various categories of messages.
...
We recommend before trying this, you refer to the [Message structure and hierarchy guide](/docs/sdk/android/2.0/message-structure-and-hierarchy) to get familiar with the various types of messages.
