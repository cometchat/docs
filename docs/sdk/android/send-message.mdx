...
1. A [Text Message](/docs/sdk/android/send-message#text-message), the most common and standard message type.
2. A [Media Message](/docs/sdk/android/send-message#media-message), for sending photos, videos and files.
3. A [Custom Message](/docs/sdk/android/send-message#custom-message), for sending completely custom data using JSON structures.
4. A [Interactive Messages](/docs/sdk/android/interactive-messages), for sending end-user interactive messages of type form, card and custom Interactive
...
It is also possible to send interactive messages from CometChat , to know more [click here](/docs/sdk/android/interactive-messages)
