...
Know more about auto mode connection [click here](/docs/sdk/android/connection-behaviour#auto-mode)
...
Know more about manual mode connection [click here](/docs/sdk/android/connection-behaviour#manual-mode)
