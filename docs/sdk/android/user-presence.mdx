...
When you [retrieve the list of users](/docs/sdk/android/retrieve-users), in the [User](/docs/sdk/android/user-management#user-class) object, you will receive 2 keys:
