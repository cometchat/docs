...
1. [UserListener](/docs/sdk/android/3.0/resources-all-real-time-listeners#user-listener)
2. [GroupListener](/docs/sdk/android/3.0/resources-all-real-time-listeners#group-listener)
3. [MessageListener](/docs/sdk/android/3.0/resources-all-real-time-listeners#message-listener)
4. [CallListener](/docs/sdk/android/3.0/resources-all-real-time-listeners#call-listener)
