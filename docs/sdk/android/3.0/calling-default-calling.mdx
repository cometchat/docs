...
As mentioned in the [Overview](/docs/sdk/android/3.0/overview) section, Once the call is initiated, there are three options that can be possible:
...
| `setMainVideoContainerSetting(MainVideoContainerSetting containerSettings)` | This method can be used to customize the main video container. You can read more about this [here](/docs/sdk/android/3.0/video-view-customisation).                                                                                                                                                                                                 |
