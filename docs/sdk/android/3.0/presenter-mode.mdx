...
| `setDefaultAudioMode(boolean value)`                   | This method can be used if you wish to start the call with a specific audio mode. The available options are 1. CometChatCallsConstants.AUDIO\_MODE\_SPEAKER = "SPEAKER" 2. CometChatCallsConstants.AUDIO\_MODE\_EARPIECE = "EARPIECE" 3. CometChatCallsConstants.AUDIO\_MODE\_BLUETOOTH = "BLUETOOTH" 4. CometChatCallsConstants.AUDIO\_MODE\_HEADPHONES = "HEADPHONES" |
