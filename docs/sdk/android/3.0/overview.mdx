...
This guide demonstrates how to add chat to an Android application. Before you begin, we strongly recommend you read the [Key Concepts](/docs/sdk/android/3.0/key-concepts) guide.
...
* [Presence Subscription](/docs/sdk/android/3.0/user-presence): Represents the subscription type for user presence (real-time online/offline status)
* **autoEstablishSocketConnection(boolean value)**: This property takes a boolean value which when set to true informs the SDK to manage the web-socket connection internally. If set to false, it informs the SDK that the web-socket connection will be managed manually. The default value for this parameter is true. For more information on this, please check the [Managing Web-Socket connections manually](/docs/sdk/android/3.0/advanced-managing-web-socket-connections-manually) section. The default value for this property is **true.**
...
* Please refer [Android Java UI Kit](/docs/ui-kit/android/v3/overview) section to integrate Android Java UI Kit inside your app.
* Please refer [Android Kotlin UI Kit](/docs/ui-kit/kotlin/overview) section to integrate Android Kotlin UI Kit inside your app.
