...
This element uses [Icon element](/docs/web-elements/icon) and [Label element](/docs/web-elements/label) to show text and icon(with background) and along with an alignment property to align the icon around the text. The purpose of this element is to initiate an action.
