...
| avatarStyle          | [avatarStyle](/docs/web-elements/avatar#avatar-style)       | Styling properties and values of the avatar element                 |
| statusIndicatorStyle | [statusIndicatorStyle](/docs/web-elements/status-indicator) | Styling properties and values of the status indicator element       |
| listItemStyle        | [ListItemStyle](/docs/web-elements/list-item#listitemstyle) | Styling properties and values of the element                        |
