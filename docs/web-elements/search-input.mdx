...
This element is built on top of [Input](/docs/web-elements/input) element and enables users to enter a search string.
...
| searchInputStyle | [SearchInputStyle](/docs/web-elements/search-input#searchinputstyle) | Styling properties and values of the element                                 |
