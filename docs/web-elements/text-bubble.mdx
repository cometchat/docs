...
| textStyle      | [TextBubbleStyle](/docs/web-elements/text-bubble#textbubblestyle) | Styling properties and values of the [Text bubble](/docs/web-elements/text-bubble) element |
| textFormatters | [TextFormatters\[\]](/docs/web-shared/text-formatters)            | Accepts Array of textFormatters                                                            |
