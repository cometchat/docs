...
| --------------- | -------------------------------------------------------- | --------------------------------------------------------------------------------- |
| placement       | [Placement](/docs/web-elements/pop-over#placement)       | Group of constants representing the positioning or alignment of popover placement |
| hasToolTip      | boolean                                                  | When set to true, displays the cursor                                             |
| popoverStyle    | [PopoverStyle](/docs/web-elements/pop-over#popoverstyle) | Styling properties and values of the element                                      |
