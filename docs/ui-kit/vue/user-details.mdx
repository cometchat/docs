...
| ---- | ----------------------------------------------------------------- | ---------------------------------------------- |
| user | [CometChat.User](/docs/sdk/javascript/user-management#user-class) | View details of this particular CometChat user |
...
| detailsStyle         | [DetailsStyle](/docs/web-shared/detailsstyle)               | Styling properties and values of the [Details](/docs/ui-kit/vue/user-details) component               |
