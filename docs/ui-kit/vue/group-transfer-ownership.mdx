...
| ----- | ------------------------------------------------------------ | ----------------------------------------------------- |
| group | [Group Class](/docs/sdk/javascript/create-group#group-class) | Transfer ownership of this particular CometChat group |
...
| transferOwnershipStyle | [TransferOwnershipStyle](/docs/web-shared/transferownershipstyle) | Styling properties and values of the [TransferOwnership](/docs/ui-kit/vue/group-transfer-ownership) component |

## Events

To handle events supported by `CometChatTransferOwnership` you have to add the listeners mentioned [here](/docs/web-shared/groups-events).
