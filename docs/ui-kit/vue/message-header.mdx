...
| messageHeaderStyle   | [MessageHeaderStyle](/docs/web-shared/messageheaderstyle)   | Styling properties and values of the [MessageHeader](/docs/ui-kit/vue/message-header) component       |
