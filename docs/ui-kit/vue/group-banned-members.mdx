...
| ----- | ------------------------------------------------------------ | ---------------------------------------------- |
| group | [Group Class](/docs/sdk/javascript/create-group#group-class) | Ban members of this particular CometChat group |
...
| Name                        | Type                                                                                 | Description                                                                                                                              |
| --------------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| searchRequestBuilder        | [CometChat.BannedMembersRequestBuilder](/docs/sdk/javascript/group-kick-ban-members) | Class that allows you to set various parameters to the `BannedMembersRequestBuilder` class based on which the group members are searched |
| bannedMembersRequestBuilder | [CometChat.BannedMembersRequestBuilder](/docs/sdk/javascript/group-kick-ban-members) | Class that allows you to set various parameters to the `BannedMembersRequestBuilder` class based on which the group members are fetched  |
...
| Name    | Type                                                                                                          | Description                                                             |
| ------- | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| options | Function as PropType\<(bannedMember: CometChat.GroupMember) => [CometChatOption](/docs/web-shared/option)\[]> | User-defined actions which appears for each banned member on mouseover. |
...
| bannedMembersStyle   | [BannedMembersStyle](/docs/web-shared/bannedmembersstyle)   | Styling properties and values of the [Banned Members](/docs/ui-kit/vue/group-banned-members) component |

## Events

To handle events supported by `CometChatBannedMembers` component you have to add the listeners mentioned [here](/docs/web-shared/groups-events).
