...
`CometChatUIKit` is a class that contains all necessary methods to help initialise the [CometChat SDK](/docs/sdk/javascript/overview) with valid credentials for the UI Kit to utilise.

### Init

This method initialises the settings required for [CometChat SDK](/docs/sdk/javascript/overview). First, ensure UIKitSettings is set and then call the `init()` method on app startup
...
This method allows you to send [Form Message](/docs/web-shared/form-message) which are the extension of Interactive Message
...
This method allows you to send [Card Message](/docs/web-shared/card-message) which are the extension of Interactive Message
...
This method allows you to send [Custom Interactive Message](/docs/web-shared/custom-interactive-message) which are the extension of Interactive Message
