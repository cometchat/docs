...
| ------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| configuration | [AIConversationSummaryConfiguration](/docs/web-shared/ai-conversation-summary-configuration) | This is a configuration to customise behaviour & UI of `AI Conversation Summary`. |
