...
| ----- | ------------------------------------------------------------- | ----------------------------------------------- |
| user  | [User Class](/docs/sdk/javascript/user-management#user-class) | View details of this particular CometChat user  |
| group | [Group Class](/docs/sdk/javascript/create-group#group-class)  | View details of this particular CometChat group |
...
| Name                   | Type                                                                                  | Description                                                                                                            |
| ---------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| messagesRequestBuilder | [CometChat.MessagesRequestBuilder](/docs/sdk/javascript/additional-message-filtering) | Class that allows you to set various parameters to the `MessagesRequest` class based on which the messages are fetched |
...
| Name      | Type                                                             | Description                                                                        |
| --------- | ---------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| templates | [CometChatMessageTemplate](/docs/web-shared/message-template)\[] | It defaults to templates for 5 message type i.e. text, audio, video, image, files. |
...
| Name               | Type                                                          | Description                                                                                                                                                                                                     |
| ------------------ | ------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| alignment          | [MessageListAlignment](/docs/web-shared/messagelistalignment) | This refers to the visual arrangement or positioning of the message bubble within the message list. Defaults to `standard` alignment i.e. Sent messages aligned to right and received messages aligned to left. |
| timestampAlignment | [TimestampAlignment](/docs/web-shared/timestampalignment)     | This refers to the visual arrangement or positioning of the message timestamp within the message list. Defaults to `top` alignment.                                                                             |
...
| Name           | Description                                                                                                                                                                                         |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| textFormatters | [TextFormatters](/docs/web-shared/text-formatters) is an array of formatters that Applies and adjusts styling for text bubbles according to specified regex patterns defined in various formatters. |
...
| Name                            | Type                                                                                   | Description                                                                                                                                     |
| ------------------------------- | -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| messageInformationConfiguration | [MessageInformation configuration](/docs/web-shared/message-information-configuration) | Properties of the [MessageInformation](/docs/ui-kit/vue/message-information) component that are available for customisation via this component. |
| reactionsConfiguration          | [Reactions configuration](/docs/web-shared/reactions-configuration)                    | Properties of the [Reactions](/docs/web-shared/reactions) component that are available for customisation via this component.                    |
...
| Name                 | Type                                                        | Description                                                                                            |
| -------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| avatarStyle          | [AvatarStyle](/docs/web-elements/avatar#avatar-style)       | Styling properties and values of the [Avatar](/docs/web-elements/avatar) component                     |
| statusIndicatorStyle | [StatusIndicatorStyle](/docs/web-elements/status-indicator) | Styling properties and values of the [Status Indicator](/docs/web-elements/status-indicator) component |
| listItemStyle        | [ListItemStyle](/docs/web-elements/list-item#listitemstyle) | Styling properties and values of the [List item](/docs/web-elements/list-item) component               |
| backdropStyle        | [BackdropStyle](/docs/web-elements/backdrop#backdropstyle)  | Styling properties and values of the [Backdrop](/docs/web-elements/backdrop) component                 |
| messageListStyle     | [MessageListStyle](/docs/web-shared/messageliststyle)       | Styling properties and values of the [Message List](/docs/ui-kit/vue/message-list) component           |
