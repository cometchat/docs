...
| ----- | ---------------------------------------------------------------- | ----------------------------------------------- |
| group | [CometChat.Group](/docs/sdk/javascript/create-group#group-class) | View details of this particular CometChat group |
...
| Name | Type                                                         | Description                                                                              |
| ---- | ------------------------------------------------------------ | ---------------------------------------------------------------------------------------- |
| data | [CometChatDetailsTemplate](/docs/web-shared/detailstemplate) | Data model that serve as a starting point of the details component for a particular user |
...
| Name                           | Type                                                                                | Description                                                           |
| ------------------------------ | ----------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| groupMembersConfiguration      | [GroupMembersConfiguration](/docs/web-shared/group-members-configuration)           | Configurable properties of the `CometChatGroupMembers` component      |
| addMembersConfiguration        | [AddMembersConfiguration](/docs/web-shared/add-members-configuration)               | Configurable properties of the `CometChatAddMembers` component        |
| bannedMembersConfiguration     | [BannedMembersConfiguration](/docs/web-shared/banned-members-configuration)         | Configurable properties of the `CometChatBannedMembers` component     |
| transferOwnershipConfiguration | [TransferOwnershipConfiguration](/docs/web-shared/transfer-ownership-configuration) | Configurable properties of the `CometChatTransferOwnership` component |
...
| leaveDialogStyle     | [ConfirmDialogStyle](/docs/web-elements/confirm-dialog#confirmdialogstyle) | Styling properties and values of the [ConfirmDialog](/docs/web-elements/confirm-dialog) component     |
| detailsStyle         | [DetailsStyle](/docs/web-shared/detailsstyle)                              | Styling properties and values of the [Details](/docs/ui-kit/vue/group-details) component              |
