...
| Name                      | Type                                              | Description                                    |
| ------------------------- | ------------------------------------------------- | ---------------------------------------------- |
| tabs                      | [TabItem](/docs/web-shared/tabitem)\[]            | List of tabs to be displayed                   |
...
| tabVisibility             | [TabsVisibility](/docs/web-shared/tabsvisibility) | Sets which tabs needed to be visible or hidden |
...
| Name           | Type                                            | Description                                                            |
| -------------- | ----------------------------------------------- | ---------------------------------------------------------------------- |
| selectionMode  | [SelectionMode](/docs/web-shared/selectionmode) | Allows user to select one or more users / groups from the contact list |
...
| Name          | Type                                            | Description                                                                          |
| ------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------ |
| contactsStyle | [ContactsStyle](/docs/web-shared/contactsstyle) | Styling properties and values of the [Contacts](/docs/ui-kit/vue/contacts) component |
...
| Name                | Type                                                          | Description                                                                                 |
| ------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| usersConfiguration  | [UsersConfiguration](/docs/web-shared/users-configuration)    | Properties of the users component that are available for customisation via this component.  |
