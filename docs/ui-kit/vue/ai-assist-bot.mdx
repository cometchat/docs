...
| ------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- |
| configuration | [AIAssistBotConfiguration](/docs/web-shared/ai-assist-bot-configuration) | This is a configuration to customise behaviour & UI of `AI Assist Bot Configuration`. |
