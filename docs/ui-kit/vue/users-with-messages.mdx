...
[Users](/docs/ui-kit/vue/users): This component lists all the users registered on CometChat.
...
| Name                   | Type                                                    | Description                         |
| ---------------------- | ------------------------------------------------------- | ----------------------------------- |
| usersWithMessagesStyle | [WithMessagesStyle](/docs/web-shared/withmessagesstyle) | Styling properties of the component |
