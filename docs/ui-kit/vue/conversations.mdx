...
| Name                        | Type                                                                                                                | Description                                                                                                                      |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| conversationsRequestBuilder | [CometChat.ConversationsRequestBuilder](/docs/sdk/javascript/retrieve-conversations#retrieve-list-of-conversations) | Class that allows you to set various parameters to the `ConversationsRequest` class based on which the conversations are fetched |
...
| Name           | Description                                                                                                                                                                                         |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| textFormatters | [TextFormatters](/docs/web-shared/text-formatters) is an array of formatters that Applies and adjusts styling for last message according to specified regex patterns defined in various formatters. |
...
| Name          | Type                                                                     | Description                                                                          |
| ------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| selectionMode | [SelectionMode](/docs/web-shared/selectionmode)                          | Allows user to select individual or multiple items for applying specific operations. |
...
| statusIndicatorStyle          | [StatusIndicator](/docs/web-elements/status-indicator)                     | Styling properties and values of the [StatusIndicator](/docs/web-elements/status-indicator) component |
| badgeStyle                    | [BadgeStyle](/docs/web-elements/badge#badge-style)                         | Styling properties and values of the [Badge](/docs/web-elements/badge) component                      |
| receiptStyle                  | [ReceiptStyle](/docs/web-elements/receipt#receiptstyle)                    | Styling properties and values of the [Receipt](/docs/web-elements/receipt) component                  |
| listItemStyle                 | [ListItemStyle](/docs/web-elements/list-item#listitemstyle)                | Styling properties and values of the [ListItem](/docs/web-elements/list-item) component               |
| deleteConversationDialogStyle | [ConfirmDialogStyle](/docs/web-elements/confirm-dialog#confirmdialogstyle) | Styling properties and values of the [ConfirmDialog](/docs/web-elements/confirm-dialog) component     |
...
| conversationsStyle            | [ConversationsStyle](/docs/web-shared/conversationsstyle)                  | Styling properties and values of the [Conversations](/docs/ui-kit/vue/conversations) component        |

## Events

To handle events supported by `CometChatConversations` component you have to add the listeners mentioned [here](/docs/web-shared/conversations-events).
