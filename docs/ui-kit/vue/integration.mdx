...
to know more about the Nuxt.js integration [click here](/docs/ui-kit/vue/nuxtjs-integration)
...
This developer kit is an add-on feature to [CometChat JavaScript SDK](/docs/sdk/javascript/overview), so installing it will also install the core Chat SDK.
...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------- |
| **`UI Components`** | CometChat's UI Kit is a set of pre-built UI components that allows you to easily craft an in-app chat with all the essential messaging features. | [Navigate](/docs/ui-kit/vue/ui-components-overview) |
