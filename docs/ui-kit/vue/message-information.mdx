...
| template | [CometChatMessageTemplate](/docs/web-shared/message-template) | Override the default message bubble view |
...
| messageInformationStyle | [MessageInformationStyle](/docs/web-shared/messageinformationstyle) | Styling properties and values of the [Message Information](/docs/ui-kit/vue/message-information) component |
