...
| ------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| configuration | [AIConversationStarterConfiguration](/docs/web-shared/ai-conversation-starter-configuration) | This is a configuration to customise behaviour & UI of AI Conversation Starter. |
