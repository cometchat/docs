...
| ----- | ------------------------------------------------------------ | ---------------------------------------------- |
| group | [Group Class](/docs/sdk/javascript/create-group#group-class) | Add members of this particular CometChat group |
...
| Name                 | Type                                                                                        | Description                                                                                                       |
| -------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| searchRequestBuilder | [CometChat.UsersRequestBuilder](/docs/sdk/javascript/retrieve-users#retrieve-list-of-users) | Class that allows you to set various parameters to the `UsersRequest` class based on which the users are searched |
| usersRequestBuilder  | [CometChat.UsersRequestBuilder](/docs/sdk/javascript/retrieve-users#retrieve-list-of-users) | Class that allows you to set various parameters to the `UsersRequest` class based on which the users are fetched  |
...
| Name    | Type                                                                                          | Description                                                     |
| ------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| options | Function as PropType\<(user:CometChat.User) => [CometChatOption](/docs/web-shared/option)\[]> | User-defined actions which appears for each group on mouseover. |
...
| addMembersStyle      | [AddMembersStyle](/docs/web-shared/addmembersstyle)         | Styling properties and values of the [AddMembers](/docs/ui-kit/vue/group-add-members) component       |

## Events

To handle events supported by `CometChatAddMembers` component you have to add the listeners mentioned [here](/docs/web-shared/groups-events).
