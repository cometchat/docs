...
| ------------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------- |
| configuration | [AISmartRepliesConfiguration](/docs/web-shared/ai-smart-replies-configuration) | This is a configuration to customise behaviour & UI of `AI Smart Replies`. |
