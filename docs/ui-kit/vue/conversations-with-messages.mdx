...
[Conversations](/docs/ui-kit/vue/conversations) : This component lists the most recent or latest conversations or contacts with whom you have exchanged messages.
...
| Name                           | Type                                                    | Description                                                                                                                |
| ------------------------------ | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| conversationsWithMessagesStyle | [WithMessagesStyle](/docs/web-shared/withmessagesstyle) | Styling properties and values of the [Conversations with Messages](/docs/ui-kit/vue/conversations-with-messages) component |
...
| Name                       | Type                                                                        | Description                                                                                        |
| -------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| conversationsConfiguration | [Conversations configuration](/docs/web-shared/conversations-configuration) | Properties of the conversations component that are available for customisation via this component. |
