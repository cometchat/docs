...
`Documentation` [Retrive Users -Learn how to fetch various types of users.](/docs/sdk/android/2.0/retrieve-users)
...
`Documentation`[Retrive Groups -Learn how to fetch various types of groups.](/docs/sdk/android/2.0/retrieve-groups)
...
`Documentation` [Retrive Conversations -Learn how to build a recent chats list using conversations.](/docs/sdk/android/2.0/retrieve-conversations)
