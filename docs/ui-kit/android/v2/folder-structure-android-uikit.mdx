...
`Documentation` [CometChatUI](/docs/ui-kit/android/v2/ui-components#cometchatui)

### **Chats**

`ui_components/chats` includes a file which is used to display chat list.

`Documentation` [CometChatConversationList](/docs/ui-kit/android/v2/ui-components#cometchatconversationlist)

### **Users**

`ui_components/users` includes a files which are used to display a user list

`Documentation` [CometChatUserList](/docs/ui-kit/android/v2/ui-components#cometchatuserlist)
...
| `ui_components/groups/group_list`           | It includes files which is used to show "Group List".<br/>`Documentation` [CometChatGroupList](/docs/ui-kit/android/v2/ui-components#cometchatgrouplist)                                         |
...
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ui_components/messages/message_list`        | It includes files which are used to load 1-1 & group chats. It also the operations such as "edit","delete","forward" and many others.<br/>`Documentation` [CometChatMessageList](/docs/ui-kit/android/v2/ui-components#cometchatmessagelist)             |
...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| ui\_componets/calls/call\_list     | It includes files which are used to display calls list Documentation [CometChatCallList](/docs/ui-kit/android/v2/ui-components#cometchatcalllist) |              |
...
`Documentation` [CometChatUserProfile](/docs/ui-kit/android/v2/ui-components#cometchatuserprofile)
...
`Documentation` [Shared Components](/docs/ui-kit/android/v2/ui-components#shared)
...
<Card
  ...
  href="/docs/ui-kit/android/v2/customize-ui-kit"
>
  This guide helps you to customize, modify, and enable/disable features present in UIKit.

  <img src="/images/0071b576-comet-chat-36c5d9a5aada118e08d1a9b7e7b9467e.svg" />
</Card>
