...
✅ You have read [CometChat Key Concepts](/docs/ui-kit/android/v2/key-concepts)
...
[📝 Add CometChat Dependency](/docs/sdk/android/2.0/setup#add-the-cometchat-dependency) `Documentation`
...
📝 Please refer to our [**SDK Documentation**](/docs/sdk/android/2.0/overview) for more information on how to configure the CometChat Pro SDK and implement various features using the same.
