...
`CometChatCreateGroup` serves as a versatile [Component](/docs/ui-kit/android/v4/components-overview#components), empowering users to create diverse group types, encompassing public, private, and password-protected options. This functionality grants users the flexibility to tailor their group settings to suit their preferences and requirements.
...
[Events](/docs/ui-kit/android/v4/components-overview#events) are emitted by a `Component`. By using [CometChatGroupEvents](/docs/ui-kit/android/v4/groups#events) you can extend existing functionality. Being global events, they can be applied in Multiple Locations and are capable of being Added or Removed.
