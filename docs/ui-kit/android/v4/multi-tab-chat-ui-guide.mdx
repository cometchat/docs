...
In this guide you will learn how to create a tabbed layout component using [bottom navigation](https://m2.material.io/components/bottom-navigation#using-tabs) to use widgets like [CometChatUsersWithMessages](/docs/ui-kit/android/v4/users-with-messages), [CometChatGroupsWithMessages](/docs/ui-kit/android/v4/groups-with-messages) and [CometChatConversationsWithMessages](/docs/ui-kit/android/v4/users-with-messages) simultaneously.
...
Please make sure you have followed our [Integration](/docs/ui-kit/android/v4/getting-started) guidelines.
