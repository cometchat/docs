...
The `CometChatCallLogsWithDetails` is a [Composite Component](/docs/ui-kit/android/v4/components-overview#composite-components) encompassing components such as [Call Logs](/docs/ui-kit/android/v4/call-logs) and [CometChatCallLogsWithDetails](/docs/ui-kit/android/v4/call-log-details). Both of these component contributes to the functionality and structure of the overall `CometChatCallLogsWithDetails` component.
...
While the `CometChatCallLogsWithDetails` component does not have filters, its components do, For more detail on individual filters of its component refer to [Call Logs](/docs/ui-kit/android/v4/call-logs) and [CometChatCallLogsWithDetails](/docs/ui-kit/android/v4/call-log-details).

By utilizing the [Configurations](#configurations) object of its components, you can apply filters.

##### 1. CallLogRequestBuilder

The [CallLogRequestBuilder](/docs/ui-kit/android/v4/call-logs) enables you to filter and customize the call list based on available parameters in CallLogRequestBuilder. This feature allows you to create more specific and targeted queries during the call. The following are the parameters available in [CallLogRequestBuilder](/docs/ui-kit/android/v4/call-logs)
...
To apply customized styles to the `Avatar` component in the `CometChatCallLogsWithDetails` Component, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/docs/ui-kit/android/v4/avatar#avatarstyle)
...
To apply customized styles to the `ListItemStyle` component in the `CometChatCallLogsWithDetails` Component, you can use the following code snippet. For further insights on `ListItemStyle` Styles [refer](/docs/ui-kit/android/v4/list-item)
