...
A MessageTemplate provides you with the capability to define and customize both the structure and the behavior of the [MessageBubble](/docs/ui-kit/android/v4/message-bubble). It acts as a schema or design blueprint for the creation of a variety of [MessageBubble](/docs/ui-kit/android/v4/message-bubble) components, allowing you to manage the appearance and interactions of [MessageBubble](/docs/ui-kit/android/v4/message-bubble) within your application effectively and consistently.
...
2. **Category**
   ...
   Please refer to our guide on [Message Categories](/docs/sdk/android/message-structure-and-hierarchy) for a deeper understanding of message categories.
...
4. **Content View**
   ...
   The `.setContentView()` method allows you to assign a custom content view to the MessageBubble. By default, it displays the [Text Bubble](/docs/ui-kit/android/v4/text-bubble), [Image Bubble](/docs/ui-kit/android/v4/image-bubble), [File Bubble](/docs/ui-kit/android/v4/file-bubble), [Audio Bubble](/docs/ui-kit/android/v4/audio-bubble), or [Video Bubble](/docs/ui-kit/android/v4/video-bubble), depending on the message type.
...
Let's dive into how you can use the [properties](#properties) of MessageTemplate to customize an existing template or add a new one to the [MessageList](/docs/ui-kit/android/v4/message-list) component.
...
You will be using [Messages](/docs/ui-kit/android/v4/messages#overview) Component for example here so to apply Template to Messages you will need to use `MessageListConfiguration`. This is because the [Set Templates](/docs/ui-kit/android/v4/message-list#settemplate) function, which is used to apply the custom templates, belongs to the [MessageList](/docs/ui-kit/android/v4/message-list) component.
