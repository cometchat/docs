...
`CometChatDetails` is a [Composite Component](/docs/ui-kit/android/v4/components-overview#composite-components) that provides additional information and settings related to a specific group.
...
All exposed properties of `GroupMembersConfiguration` can be found under [Group Members](/docs/ui-kit/android/v4/group-members#configuration). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
...
All exposed properties of `AddMembersConfiguration` can be found under [Add Members](/docs/ui-kit/android/v4/group-add-members). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
