...
The `SchedulerMessage` class is used to create an interactive scheduler message that can be sent via CometChat. It extends the [Interactive Messages](/docs/sdk/android/interactive-messages) class from CometChat.
...
| interactions           | [Interaction](/docs/sdk/android/interactive-messages#interaction) | Gives the list of elements you have interacted with                   |
