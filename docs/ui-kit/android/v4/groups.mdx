...
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [CometChatListBase](/docs/ui-kit/android/v4/list-base) | `CometChatListBase` is a container component having a title, search box, customizable `background`, and a List View                             |
| [CometChatListItem](/docs/ui-kit/android/v4/list-item) | `CometChatListItem` is a component that renders data obtained from a Group object on a Tile having a title, subtitle, leading and trailing view |
...
The SearchRequestBuilder uses [GroupsRequestBuilder](/docs/sdk/android/retrieve-groups) enables you to filter and customize the search list based on available parameters in GroupsRequestBuilder. This feature allows you to keep uniformity between the displayed Groups List and searched Group List.
...
To apply customized styles to the `Avatar` component in the Groups Component, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/docs/ui-kit/android/v4/avatar)
...
To apply customized styles to the Status Indicator component in the Groups Component, You can use the following code snippet. For further insights on Status Indicator Styles [refer](/docs/ui-kit/android/v4/status-indicator)
...
To apply customized styles to the `List Item` component in the `Groups` Component, you can use the following code snippet. For further insights on `List Item` Styles [refer](/docs/ui-kit/android/v4/list-item)
