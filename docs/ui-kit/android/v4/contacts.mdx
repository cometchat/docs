...
| **setSelectionMode(UIKitConstants.SelectionMode selectionMode)** | UIKitConstants.SelectionMode | `selectionMode` is used to set the selection mode for the [CometChatUsers](/docs/ui-kit/android/v4/users) and [CometChatGroups](/docs/ui-kit/android/v4/groups) subviews embedded inside `CometChatContacts`.                                                                                                              |
