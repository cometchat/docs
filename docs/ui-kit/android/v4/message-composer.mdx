...
MessageComposer is a [Component](/docs/ui-kit/android/v4/components-overview#components) that enables users to write and send a variety of messages, including text, image, video, and custom messages.
...
MessageComposer is comprised of the following [Base Components](/docs/ui-kit/android/v4/components-overview#base-components):

| Base Components                                       | Description                                                                                                            |
| ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [MessageInput](/docs/ui-kit/android/v4/message-input) | This provides a basic layout for the contents of this component, such as the TextField and buttons                     |
| [ActionSheet](/docs/ui-kit/android/v4/action-sheet)   | The ActionSheet component presents a list of options in either a list or grid mode, depending on the user's preference |
...
To customize the styles of the MediaRecorder component within the MessageComposer Component, use the `.setMediaRecorderStyle()` method. For more details, please refer to [MediaRecorder](/docs/ui-kit/android/v4/media-recorder) styles.
...
Assigns the list of text formatters. If the provided list is not null, it sets the list. Otherwise, it assigns the default text formatters retrieved from the data source. To configure the existing Mentions look and feel check out [CometChatMentionsFormatter](/docs/ui-kit/android/v4/mentions-formatter-guide)
