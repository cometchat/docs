...
1. **Create new users** on the **[CometChat Dashboard](https://app.cometchat.com)**, **[CometChat SDK Method](/docs/ui-kit/android/methods#create-user)** or **[via the API](https://api-explorer.cometchat.com/reference/creates-user)**.
...
For secure authentication, use the [`Auth Token`](/docs/ui-kit/android/methods#login-using-auth-token) method instead.
...
* For **production environments**, it is strongly advised to use an **[Auth Token](/docs/ui-kit/android/methods#login-using-auth-token)** instead of an **Auth Key** to enhance security and prevent unauthorized access.
...
* **[Integrate Conversation List + Message](/docs/ui-kit/android/android-conversation)**
* **[Integrate One-to-One Chat](/docs/ui-kit/android/android-one-to-one-chat)**
* **[Integrate Tab-Based Chat](/docs/ui-kit/android/android-tab-based-chat)**
* **[Advanced Customizations](/docs/ui-kit/android/theme-introduction)**
