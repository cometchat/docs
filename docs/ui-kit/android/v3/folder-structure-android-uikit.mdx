...
**Documentation** [CometChatUI](/docs/ui-kit/android/v3/android-java-ui-components#cometchatui)

### Chats

`ui_components/chats` includes a file which is used to display chat list.

**Documentation** [CometChatConversationList](/docs/ui-kit/android/v3/android-java-ui-components#cometchatconversationlist)

### Users

`ui_components/users` includes a files which are used to display a user list **Documentation** [CometChatUserList](/docs/ui-kit/android/v3/android-java-ui-components#cometchatuserlist)
...
| `ui_components/groups/group_list`           | It includes files which is used to show "Group List". `Documentation`[CometChatGroupList](/docs/ui-kit/android/v3/android-java-ui-components#cometchatgrouplist)                            |
...
| -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ui_components/messages/message_list`        | It includes files which are used to load 1-1 & group chats. It also the operations such as "edit","delete","forward" and many others. `Documentation` [CometChatMessageList](/docs/ui-kit/android/v3/android-java-ui-components#cometchatmessagelist) |
...
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| ui\_componets/calls/call\_list     | It includes files which are used to display calls list `Documentation`[CometChatCallList](/docs/ui-kit/android/v3/android-java-ui-components#cometchatcalllist) |              |
...
`Documentation`[CometChatUserProfile](/docs/ui-kit/android/v3/android-java-ui-components#cometchatuserprofile)
...
`Documentation` [Shared](/docs/ui-kit/android/v3/android-java-ui-components#shared)
