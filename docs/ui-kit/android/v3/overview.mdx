...
Check out our Kotlin UI Kit [here](/docs/ui-kit/kotlin/customize-ui-kit).
...
* [UI Components](/docs/ui-kit/android/v3/android-java-ui-components)
* [Customize UI Kit](/docs/ui-kit/android/v3/android-customize-ui-kit)
...
✅ You have read [CometChat Key Concepts](/docs/ui-kit/android/v3/key-concepts).
...
**[📝 Add CometChat Dependency](/docs/sdk/android/setup)** `Documentation`
...
📝 Please refer to our **[SDK Documentation](/docs/sdk/android/overview)** for more information on how to configure the CometChat Pro SDK and implement various features using the same.
...
* Import `uikit` Module from Module Settings.(Click **[here](/docs/ui-kit/android/v3/how-to-add-uikit-module)** to know how to import `uikit` as Module)
