...
`MessageHeader` is a [Component](/docs/ui-kit/android/components-overview#components) that showcases the [User](/docs/sdk/android/users-overview) or [Group](/docs/sdk/android/groups-overview) details in the toolbar. Furthermore, it also presents a typing indicator and a back navigation button for ease of use.
