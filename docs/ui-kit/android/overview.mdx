...
* **Built on Core SDK** – Leverages the powerful [CometChat Android SDK](/docs/sdk/android/overview) for reliable performance.
...
* Review the [Key Concepts](/docs/fundamentals/key-concepts) to understand essential terminology and features.
* Follow the [Getting Started Guide](/docs/ui-kit/android/getting-started) for detailed steps on initial setup and integration.
...
Explore more about UI customization in the [Customization Guide](/docs/ui-kit/android/theme-introduction).
