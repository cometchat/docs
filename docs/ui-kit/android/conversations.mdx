...
The Conversations is a [Component](/docs/ui-kit/android/components-overview#components), That shows all conversations related to the currently logged-in user,
...
By utilizing this method, developers can enhance readability, usability, and compliance with content guidelines. [MentionsFormatter Guide](/docs/ui-kit/android/mentions-formatter-guide)
