...
A MessageTemplate provides you with the capability to define and customize both the structure and the behavior of the [MessageBubble](/docs/ui-kit/android/message-bubble-styling#message-bubbles). It acts as a schema or design blueprint for the creation of a variety of [MessageBubble](/docs/ui-kit/android/message-bubble-styling#message-bubbles) components, allowing you to manage the appearance and interactions of [MessageBubble](/docs/ui-kit/android/message-bubble-styling#message-bubbles) within your application effectively and consistently.
...
4. **Content View**
   ...
   The `.setContentView()` method allows you to assign a custom content view to the MessageBubble. By default, it displays the [Text Bubble](/docs/ui-kit/android/message-bubble-styling#text-bubble), [Image Bubble](/docs/ui-kit/android/message-bubble-styling#image-bubble), [File Bubble](/docs/ui-kit/android/message-bubble-styling#file-bubble), [Audio Bubble](/docs/ui-kit/android/message-bubble-styling#audio-bubble), or [Video Bubble](/docs/ui-kit/android/message-bubble-styling#video-bubble), depending on the message type.
...
Let's dive into how you can use the [properties](#properties) of MessageTemplate to customize an existing template or add a new one to the [MessageList](/docs/ui-kit/android/message-list) component.
...
You will be using [MessageList](/docs/ui-kit/android/message-list) Component for example here so to apply Template to MessageList you will need to use `setTemplates` method.
