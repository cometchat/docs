...
We have released recording feature in beta. Please install the latest beta version to enable recording feature in UI Kit. Please refer to [Recording (Beta)](/docs/sdk/javascript/2.0/calling-recording) documentation to know more. **npm install @cometchat-pro/chat@ v2.4.1-beta1 --save**
