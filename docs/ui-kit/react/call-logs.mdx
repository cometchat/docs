...
The following example demonstrates how to modify the **Call Initiated** timestamp format using a custom [`CalendarObject`](/docs/ui-kit/react/localize#calendarobject).
