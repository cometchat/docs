...
The UI Kit's core function is to extend the [Chat SDK](/docs/sdk/javascript/overview), essentially translating the raw data and functionality provided by the underlying methods into visually appealing and easy-to-use UI components.
...
The CometChat UI Kit has thoughtfully encapsulated the critical [Chat SDK](/docs/sdk/javascript/overview) methods within its wrapper to efficiently manage internal eventing. This layer of abstraction simplifies interaction with the underlying CometChat SDK, making it more user-friendly for developers.
...
This method initializes the settings required for [CometChat JavaScript SDK](/docs/sdk/javascript/overview). First, ensure UIKitSettings is set and then call the `init()` method on the app startup.
...
This method allows you to send [Form](/docs/web-shared/form-message)Messages which are the extension of Interactive Message
...
This method allows you to send [Card](/docs/web-shared/card-message)Messages which are the extension of Interactive Message
...
This method allows you to send [Custom Interactive Messages](/docs/web-shared/custom-interactive-message) which are the extension of Interactive Message
