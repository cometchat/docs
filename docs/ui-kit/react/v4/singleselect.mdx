...
| selectStyle    | [SingleSelectStyle](/docs/ui-kit/react/v4/singleselect#singleselectstyle) | An instance of the `SingleSelectStyle` class for customizing the Single Select component's style. |
