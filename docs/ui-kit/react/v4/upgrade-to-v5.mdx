...
* **Theming Documentation:** [Guide to Theming](/docs/ui-kit/react/theme)
* **Color Customization:** [Customizing Colors](/docs/ui-kit/react/theme/color-resources)
...
For a comprehensive overview of newly added, renamed, and removed properties, refer to the [Property Changes](/docs/ui-kit/react/v4/property-changes) Documentation.
