...
| avatarStyle          | [avatarStyle](/docs/ui-kit/react/v4/avatar#avatar-style)       | Styling properties and values of the avatar element                 |
| statusIndicatorStyle | [statusIndicatorStyle](/docs/ui-kit/react/v4/status-indicator) | Styling properties and values of the status indicator element       |
| listItemStyle        | [ListItemStyle](/docs/ui-kit/react/v4/list-item#listitemstyle) | Styling properties and values of the element                        |
