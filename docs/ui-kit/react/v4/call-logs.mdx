...
`CometChatCallLogs` is a [Component](/docs/ui-kit/react/v4/components-overview#components) that shows the list of Call Log available . By default, names are shown for all listed users, along with their avatar if available.
...
| [cometchat-backdrop](/docs/ui-kit/react/v4/backdrop) | This element represents the background against which other elements are presented.                                          |
...
| [cometchat-date](/docs/ui-kit/react/v4/date)         | This Component used to show the date and time. You can also customize the appearance of this widget by modifying its logic. |
...
The [CallLogRequestBuilder](/docs/sdk/javascript/call-logs) enables you to filter and customize the Call Log based on available parameters in [CallLogRequestBuilder](/docs/sdk/javascript/call-logs). This feature allows you to create more specific and targeted queries when fetching the call logs. The following are the parameters available in [CallLogRequestBuilder](/docs/sdk/javascript/call-logs)
...
If you want to apply customized styles to the `Avatar` component within the `Call Logs` Component, you can use the following code snippet. For more information you can refer [Avatar Styles](/docs/ui-kit/react/v4/avatar#avatar-style).
...
If you want to apply customized styles to the `ListItemStyle` component within the `Call Logs` Component, you can use the following code snippet. For more information, you can refer [ListItem Styles](/docs/ui-kit/react/v4/list-item#listitemstyle).
...
All exposed properties of `OutgoingCallConfiguration` can be found under [OutGoing Call](/docs/ui-kit/react/v4/outgoing-call#functionality). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
