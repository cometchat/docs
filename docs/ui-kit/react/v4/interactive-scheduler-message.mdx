...
The `SchedulerMessage` class is used to create an interactive scheduler message that can be sent via CometChat. It extends the [Interactive Messages](/docs/sdk/javascript/interactive-messages) class from CometChat.
...
| interactions           | [Interaction](/docs/sdk/javascript/interactive-messages#interaction) | Gives the list of elements you have interacted with                   |
...
How to create an instance of the [Scheduler Message](/docs/web-shared/scheduler-message) class:
