...
| auxiliaryButtonAlignment | [auxiliaryButtonAlignmentEnum](/docs/ui-kit/react/v4/message-input#auxiliarybuttonalignmentenum) | Group of constants representing the in-built alignment pattern          |
| messageInputStyle        | [MessageInputStyle](/docs/ui-kit/react/v4/message-input#messageinputstyle)                       | Styling properties and values of the element                            |
