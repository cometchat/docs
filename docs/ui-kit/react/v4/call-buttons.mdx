...
The `Call Button` is a [Component](/docs/ui-kit/react/v4/components-overview#components) provides users with the ability to make calls, access call-related functionalities, and control call settings. Clicking this button typically triggers the call to be placed to the desired recipient.
...
If you want to customize the properties of the [OngoingCall](/docs/ui-kit/react/v4/ongoing-call) Component inside Call Buttons Component, you need use the `CallScreenConfiguration` object.
...
If you want to customize the properties of the [OutGoingCall](/docs/ui-kit/react/v4/outgoing-call) Component inside Call Buttons Component, you need use the `OutGoingCallConfiguration` object.

The `OutGoingCallConfiguration` provides access to all the [Action](/docs/ui-kit/react/v4/outgoing-call#actions), [Filters](/docs/ui-kit/react/v4/outgoing-call#filters), [Styles](/docs/ui-kit/react/v4/outgoing-call#style), [Functionality](/docs/ui-kit/react/v4/outgoing-call#functionality), and [Advanced](/docs/ui-kit/react/v4/outgoing-call#functionality) properties of the [OutGoingCall](/docs/ui-kit/react/v4/outgoing-call) component.
...
In this example, we will be changing the background color of [OutGoingCall](/docs/ui-kit/react/v4/outgoing-call) component using `OutGoingCallConfiguration`.
