...
The ConversationsWithMessages is a [Composite Component](/docs/ui-kit/react/v4/components-overview#composite-components) encompassing components such as [Conversations](/docs/ui-kit/react/v4/conversations), [Messages](/docs/ui-kit/react/v4/messages), and [Contacts](/docs/ui-kit/react/v4/contacts). Each of these component contributes to the functionality and structure of the overall ConversationsWithMessages component.
...
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Conversations](/docs/ui-kit/react/v4/conversations) | The `Conversations` component is designed to display a list of either `User` or `Group`. This essentially represents your recent conversation history. |
| [Messages](/docs/ui-kit/react/v4/messages)           | The `Messages` component is designed to manage the messaging interaction for either individual `User` or `Group` conversations.                        |
| [Contacts](/docs/ui-kit/react/v4/contacts)           | The `CometChatContacts` component is specifically designed to facilitate the display and management of both `User` and `Groups`.                       |
...
While the ConversationsWithMessages component does not have its actions, its components - [Conversation](/docs/ui-kit/react/v4/components-overview#actions), [Messages](/docs/ui-kit/react/v4/messages), and [Contacts](/docs/ui-kit/react/v4/contacts) - each have their own set of actions.
...
* [OnItemClick](/docs/ui-kit/react/v4/conversations#1-onitemclick) : By overriding the `OnItemClick` of the Conversation Component, ConversationsWithMessages achieves navigation from [Conversation](/docs/ui-kit/react/v4/conversations) to [Messages](/docs/ui-kit/react/v4/messages) component.
...
While the ConversationsWithMessages component does not have filters, its components do, For more detail on individual filters of its component refer to [Conversations Filters](/docs/ui-kit/react/v4/conversations#filters) and [Messages Filters](/docs/ui-kit/react/v4/messages#filters).
...
The ConversationsWithMessages does not generate its events but its component does. For a full list of these events, you can refer to [Conversations events](/docs/ui-kit/react/v4/conversations#events) and [Messages events](/docs/ui-kit/react/v4/messages#events).
...
you can utilize the `user` method with a [User](/docs/sdk/javascript/user-management) object as input to the ConversationsWithMessages component. This will automatically direct you to the [Messages](/docs/ui-kit/react/v4/messages) component for the specified `User`.
...
you can utilize the `group` method with a [Group](/docs/sdk/javascript/groups-overview) object as input to the ConversationsWithMessages component. This will automatically direct you to the [Messages](/docs/ui-kit/react/v4/messages) component for the specified `Group`.
...
You can find the list of all Functionality customization of individual components in [Conversations](/docs/ui-kit/react/v4/conversations#functionality) , [Messages](/docs/ui-kit/react/v4/messages#functionality), and [Contacts](/docs/ui-kit/react/v4/contacts)
...
To find all the details on individual Component advance customization you can refer, [Conversations Advance](/docs/ui-kit/react/v4/conversations#advanced),[Messages Advance](/docs/ui-kit/react/v4/messages#advanced) and [Contacts Advance](/docs/ui-kit/react/v4/contacts)
...
1. ConversationsWithMessages utilizes the [menus](/docs/ui-kit/react/v4/conversations#menus) of the `Conversations` subcomponent to navigate the user from [Conversations](/docs/ui-kit/react/v4/conversations) to [Contacts](/docs/ui-kit/react/v4/contacts)

   <Frame>
     <img src="/images/5000533a-conversations_menu_web_screens-edee991db7eacc5b53cf810f8a6f92be.png" />
   </Frame>

2. ConversationsWithMessages utilizes the [menus](/docs/ui-kit/react/v4/messages#auxiliarymenu) of the `Messages` subcomponent to navigate from [Messages](/docs/ui-kit/react/v4/messages) to [Details](/docs/ui-kit/react/v4/group-details)
...
[Configurations](/docs/ui-kit/react/v4/components-overview#configurations) offer the ability to customize the properties of each component within a Composite Component.
...
All exposed properties of `ConversationsConfiguration` can be found under [Conversations](/docs/ui-kit/react/v4/conversations#customization). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
...
All exposed properties of `MessagesConfiguration` can be found under [Messages](/docs/ui-kit/react/v4/messages#configuration). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
...
All exposed properties of `ContactsConfiguration` can be found under [Contacts](/docs/ui-kit/react/v4/contacts). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
