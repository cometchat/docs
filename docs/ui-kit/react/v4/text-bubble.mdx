...
| textStyle | [TextBubbleStyle](/docs/ui-kit/react/v4/text-bubble#textbubblestyle) | Styling properties and values of the [Text bubble](/docs/ui-kit/react/v4/text-bubble) element |
