...
We’ll use the [CometChatConversationsWithMessages](/docs/ui-kit/react/v4/conversations-with-messages), [CometChatUsersWithMessages](/docs/ui-kit/react/v4/users-with-messages), and [CometChatGroupsWithMessages](/docs/ui-kit/react/v4/groups-with-messages) components and launch them as individual tab items within the tabbed layout.
...
Step 3: Pass [CometChatConversationsWithMessages](/docs/ui-kit/react/v4/conversations-with-messages), [CometChatUsersWithMessages](/docs/ui-kit/react/v4/users-with-messages), [CometChatGroupsWithMessages](/docs/ui-kit/react/v4/groups-with-messages) components to the Tabs components to launch them as individual tab item.
