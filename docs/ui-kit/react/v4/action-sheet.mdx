...
| actions           | [ActionItem](/docs/web-shared/actionitem)\[]                            | List of actions / options to be made available to the user |
...
| actionSheetStyle  | [ActionSheetStyle](/docs/ui-kit/react/v4/action-sheet#actionsheetstyle) | Styling properties and values of the element               |
