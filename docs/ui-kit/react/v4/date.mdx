...
| pattern          | [DatePatterns](/docs/web-shared/datepatterns)     | Group of constants representing the in-built date patterns                        |
| customDateString | string                                            | Override the in-built pattern with your custom representation of the timestamp    |
| dateStyle        | [dateStyle](/docs/ui-kit/react/v4/date#datestyle) | Styling properties and values of the [Date](/docs/ui-kit/react/v4/date) component |
