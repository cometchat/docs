...
If you want to customize the properties of the [Reaction Info](/docs/ui-kit/react/v4/reaction-info) Component inside Reactions Component, you need use the `reactionInfoConfiguration` object.
...
The `reactionInfoConfiguration` indeed provides access to all the [Action](/docs/ui-kit/react/v4/reaction-info#actions), [Filters](/docs/ui-kit/react/v4/reaction-info#filters), [Styles](/docs/ui-kit/react/v4/reaction-info#style), [Functionality](/docs/ui-kit/react/v4/reaction-info#functionality), and [Advanced](/docs/ui-kit/react/v4/reaction-info#functionality) properties of the [Reaction Info](/docs/ui-kit/react/v4/reaction-info) component.

In the above example, we are styling a few properties of the [Reaction Info](/docs/ui-kit/react/v4/reaction-info) component using `reactionInfoConfiguration`.

### Reaction List

If you want to customize the properties of the [Reaction List](/docs/ui-kit/react/v4/reaction-list) Component inside Reactions Component, you need use the `reactionListConfiguration` object.
...
The `reactionListConfiguration` indeed provides access to all the [Action](/docs/ui-kit/react/v4/reaction-list#actions), [Filters](/docs/ui-kit/react/v4/reaction-list#filters), [Styles](/docs/ui-kit/react/v4/reaction-list#style), [Functionality](/docs/ui-kit/react/v4/reaction-list#functionality), and [Advanced](/docs/ui-kit/react/v4/reaction-list#functionality) properties of the [Reaction List](/docs/ui-kit/react/v4/reaction-list) component.

In the above example, we are styling a few properties of the [Reaction List](/docs/ui-kit/react/v4/reaction-list) component using `reactionListConfiguration`.
