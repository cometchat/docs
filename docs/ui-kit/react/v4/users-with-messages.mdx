...
The UsersWithMessages is a [Composite Component](/docs/ui-kit/react/v4/components-overview#components) encompassing components such as [Users](/docs/ui-kit/react/v4/users) and [Messages](/docs/ui-kit/react/v4/messages). Both of these component contributes to the functionality and structure of the overall UsersWithMessages component.
...
| ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| [Users](/docs/ui-kit/react/v4/users)       | The `Users` component is designed to display a list of `User`. This essentially represents your recent conversation history. |
| [Messages](/docs/ui-kit/react/v4/messages) | The `Messages` component is designed to manage the messaging interaction for individual `User's` conversations.              |
...
The UsersWithMessages component does not have much actions, its components - [Users](/docs/ui-kit/react/v4/users) and [Messages](/docs/ui-kit/react/v4/messages) - both have their own set of actions.
...
* [OnItemClick](/docs/ui-kit/react/v4/users#2-onitemclick) : By overriding the `OnItemClick` of the Users Component, UsersWithMessages achieves navigation from [Users](/docs/ui-kit/react/v4/users) to [Messages](/docs/ui-kit/react/v4/messages) component.
...
While the UsersWithMessages component does not have filters, its components do, For more detail on individual filters of its component refer to [Users Filters](/docs/ui-kit/react/v4/users#filters) and [Messages Filters](/docs/ui-kit/react/v4/messages#filters).
...
You can also customize its component styles. For more details on individual component styles, you can refer [Users Styles](/docs/ui-kit/react/v4/users#style) and [Messages Styles](/docs/ui-kit/react/v4/messages#1-messages-style).
...
you can utilize the `user` method with a [User](/docs/sdk/javascript/user-management) object as input to the UsersWithMessages component. This will automatically direct you to the [Messages](/docs/ui-kit/react/v4/messages) component for the specified `User`.
...
You can find the list of all Functionality customization of individual components in [Users](/docs/ui-kit/react/v4/users#functionality) and [Messages](/docs/ui-kit/react/v4/messages#functionality).
...
To find all the details on individual Component advance customization you can refer, [Users Advance](/docs/ui-kit/react/v4/users#advance)and [Messages Advance](/docs/ui-kit/react/v4/messages#advanced).

UsersWithMessages uses advanced-level customization of both Users & Messages components to achieve its default behavior.

1. UsersWithMessages utilizes the [onItemClick](/docs/ui-kit/react/v4/users#2-onitemclick) property of the `Users` subcomponent to navigate the user from [Users](/docs/ui-kit/react/v4/users) to [Messages](/docs/ui-kit/react/v4/messages)

<Frame>
  <img src="/images/d0f6711c-users_with_messages_onitemclick_web_screens-a2bdda9009f1a50a6c1ad7fc332b81cd.png" />
</Frame>

2. UsersWithMessages utilizes the [menus](/docs/ui-kit/react/v4/messages#auxiliarymenu) of the `Messages` subcomponent to navigate from [Messages](/docs/ui-kit/react/v4/messages) to [Details](/docs/ui-kit/react/v4/group-details)
...
All exposed properties of `UsersConfiguration` can be found under [Users](/docs/ui-kit/react/v4/users#functionality). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
