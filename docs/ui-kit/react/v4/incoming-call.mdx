...
The `Incoming call` is a [Component](/docs/ui-kit/react/v4/components-overview#components) that serves as a visual representation when the user receives an incoming call, such as a voice call or video call, providing options to answer or decline the call.
...
| ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [cometchat-list-item](/docs/ui-kit/react/v4/list-item) | This component’s view consists of avatar, status indicator , title, and subtitle. The fields are then mapped with the SDK’s user, group class. |
| [cometchat-icon](/docs/ui-kit/react/v4/icon)           | This component displays an icon. It currently supports only svg icons                                                                          |
| [cometchat-label](/docs/ui-kit/react/v4/label)         | This component provides descriptive information about the associated UI element.                                                               |
| cometchat-button                                       | This component represents a button with optional icon and text.                                                                                |
| [cometchat-avatar](/docs/ui-kit/react/v4/avatar)       | This component component displays an image or user's avatar with fallback to the first two letters of the username                             |
...
If you want to apply customized styles to the `Avatar` component within the `Incoming Call` Component, you can use the following code snippet. For more information you can refer [Avatar Styles](/docs/ui-kit/react/v4/avatar#avatar-style).
...
If you want to apply customized styles to the `ListItemStyle` component within the `Incoming Call` Component, you can use the following code snippet. For more information, you can refer [ListItem Styles](/docs/ui-kit/react/v4/list-item#listitemstyle).
...
If you want to customize the properties of the [OngoingCall](/docs/ui-kit/react/v4/ongoing-call) Component inside Incoming Call Component, you need use the `CallScreenConfiguration` object.

The `OngoingCallConfiguration` provides access to all the [Action](/docs/ui-kit/react/v4/ongoing-call#actions), [Filters](/docs/ui-kit/react/v4/ongoing-call#filters), [Styles](/docs/ui-kit/react/v4/ongoing-call#style), [Functionality](/docs/ui-kit/react/v4/ongoing-call#functionality), and [Advanced](/docs/ui-kit/react/v4/ongoing-call#advanced) properties of the [OngoingCall](/docs/ui-kit/react/v4/ongoing-call) component.
...
In this example, we will show how you can display the call recording button in the [OngoingCall](/docs/ui-kit/react/v4/ongoing-call) component using `ongoingCallConfiguration`.
