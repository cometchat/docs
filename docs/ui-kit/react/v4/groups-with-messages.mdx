...
The GroupsWithMessages is a [Composite Component](/docs/ui-kit/react/v4/components-overview#composite-components) encompassing components such as [Groups](/docs/ui-kit/react/v4/groups) and [Messages](/docs/ui-kit/react/v4/messages). Both of these component contributes to the functionality and structure of the overall GroupsWithMessages component.
...
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ |
| [Groups](/docs/ui-kit/react/v4/groups)     | The `Groups` component is designed to display a list of `Groups`. This essentially represents the recent conversation history. |
| [Messages](/docs/ui-kit/react/v4/messages) | The `Messages` component is designed to manage the messaging interaction for `Group's` conversations.                          |
...
The child components - [Groups](/docs/ui-kit/react/v4/groups) and [Messages](/docs/ui-kit/react/v4/messages) - both have their own set of action events.
...
* [OnItemClick](/docs/ui-kit/react/v4/groups#2-onitemclick) : By overriding the `OnItemClick` of the Groups Component, GroupsWithMessages achieves navigation from [Groups](/docs/ui-kit/react/v4/groups) to [Messages](/docs/ui-kit/react/v4/messages) component.
...
While the GroupsWithMessages component does not have filters, its components do, For more detail on individual filters of its component refer to [Groups Filters](/docs/ui-kit/react/v4/groups#filters) and [Messages Filters](/docs/ui-kit/react/v4/messages#filters).
...
You can also customize its component styles. For more details on individual component styles, you can refer [Groups Styles](/docs/ui-kit/react/v4/groups#1-groups-style) and [Messages Styles](/docs/ui-kit/react/v4/messages#1-messages-style).
...
you can utilize the `group` method with a [Group](/docs/sdk/javascript/create-group) object as input to the GroupsWithMessages component. This will automatically direct you to the [Messages](/docs/ui-kit/react/v4/messages) component for the specified `Group`.
...
You can find the list of all Functionality customization of individual components in [Groups](/docs/ui-kit/react/v4/groups#functionality) and [Messages](/docs/ui-kit/react/v4/messages#functionality).
...
To find all the details on individual Component advance customization you can refer, [Groups Advance](/docs/ui-kit/react/v4/groups#customization) and [Messages Advance](/docs/ui-kit/react/v4/messages#advanced).

GroupsWithMessages uses advanced-level customization of both Groups & Messages components to achieve its default behavior.

1. GroupsWithMessages utilizes the [onItemClick](/docs/ui-kit/react/v4/groups#2-onitemclick) property of the `Groups` subcomponent to navigate the group from [Groups](/docs/ui-kit/react/v4/groups) to [Messages](/docs/ui-kit/react/v4/messages)

<Frame>
  <img src="/images/74a441ba-groups_with_messages_onitemclick_web_screens-1d1519011941cfe7498682d4a010cbe3.png" />
</Frame>

2. GroupsWithMessages utilizes the [menus](/docs/ui-kit/react/v4/messages#auxiliarymenu) of the `Messages` subcomponent to navigate from [Messages](/docs/ui-kit/react/v4/messages) to [Details](/docs/ui-kit/react/v4/group-details)
...
All exposed properties of `GroupsConfiguration` can be found under [Groups](/docs/ui-kit/react/v4/groups#functionality). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
...
All exposed properties of `MessagesConfiguration` can be found under [Messages](/docs/ui-kit/react/v4/messages#functionality). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
...
All exposed properties of `JoinGroupConfiguration` can be found under [Join Group](/docs/ui-kit/react/v4/join-protected-group#functionality). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
...
All exposed properties of `CreateGroupConfiguration` can be found under [Create Group](/docs/ui-kit/react/v4/create-group#functionality). Properties marked with the [report]() symbol are not accessible within the Configuration Object.
