...
This element is built on top of [Input](/docs/ui-kit/react/v4/input) element and enables users to enter a search string.
...
| searchInputStyle | [SearchInputStyle](/docs/ui-kit/react/v4/search-input#searchinputstyle) | Styling properties and values of the element                                 |
