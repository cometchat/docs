...
Configurations offer the ability to customize the properties of each component within a Composite Component. `CallButtons` component renders [CometChatOutgoingCall](/docs/ui-kit/react/outgoing-call) component.
...
You can refer to [CometChatOutgoingCall](/docs/ui-kit/react/outgoing-call) component to know more about each of the above properties.
