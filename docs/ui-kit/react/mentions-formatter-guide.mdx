...
Below is an example demonstrating how to use the `CometChatMentionsFormatter` class in components such as [CometChatConversations](/docs/ui-kit/react/conversations), [CometChatMessageList](/docs/ui-kit/react/message-list), [CometChatMessageComposer](/docs/ui-kit/react/message-composer).
