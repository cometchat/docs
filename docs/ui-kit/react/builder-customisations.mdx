---
title: "Customizing Your Visual Builder Integration"
...
1. **Refer to the UI Kit Documentation**\
   Browse the [**UI Kit components overview**](/docs/ui-kit/react/components-overview) to find the component you'd like to customize.\
   *Example*: [**Message List**](/docs/ui-kit/react/message-list)
...
2. **Locate Customization Options**\
   ...
   *Example*: [**Sticky DateTime Format**](/docs/ui-kit/react/message-list#sticky-datetime-format)
...
1. **Component to Customize**:\
   [Message List](/docs/ui-kit/react/message-list)

2. **Customization Option**:\
   [`stickyDateTimeFormat`](/docs/ui-kit/react/message-list#sticky-datetime-format)
