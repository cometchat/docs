...
[Customize UI Kit](/docs/ui-kit/react/v3/customize)
...
Please refer to this link for documentation: [Customize UI Kit](/docs/ui-kit/react/v3/customize)
...
*friendsOnly* prop is deprecated from version **v3.0.0-beta5-1**. Please use **userListMode** variable of UIKitSettings class for displaying only friends in the user list. Please refer to this link for documentation: [Customize UI Kit](/docs/ui-kit/react/v3/customize)
