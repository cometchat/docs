...
Don't forget to check out the [Key Concepts](/docs/ui-kit/react/v3/key-concepts) for your React Chat UI Kit before proceeding.
...
Please follow the steps provided in the [Key Concepts](/docs/ui-kit/react/v3/key-concepts) to create V3 apps before you proceed.
