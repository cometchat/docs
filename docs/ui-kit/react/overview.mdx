...
3. **Follow the Setup Guide** –
   ...
   * **Visual Builder** – [React.js](/docs/ui-kit/react/builder-integration) or [Next.js](/docs/ui-kit/react/builder-integration-nextjs)
   * **UI Components** – [React.js](/docs/ui-kit/react/react-js-integration) or [Next.js](/docs/ui-kit/react/next-js-integration)
