...
After adding this dependency, the React UI Kit will automatically detect it and activate the calling features. Now, your application supports both audio and video calling. You will see [CallButtons](/docs/ui-kit/react/v5/call-buttons) component rendered in [MessageHeader](/docs/ui-kit/react/v5/message-header) Component.
...
The [Incoming Call](/docs/ui-kit/react/v5/incoming-call) component of the CometChat UI Kit provides the functionality that lets users receive real-time audio and video calls in the app.
...
[Call Logs](/docs/ui-kit/react/v5/call-logs) component provides you with the records call events such as who called who, the time of the call, and the duration of the call. This information can be fetched from the CometChat server and displayed in a structured format for users to view their past call activities.
