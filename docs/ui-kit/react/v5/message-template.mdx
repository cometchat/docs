...
Let's dive into how you can use the [properties](#properties) of MessageTemplate to customize an existing template or add a new one to the [MessageList](/docs/ui-kit/react/v5/message-list) component.
...
You will be using [Message List](/docs/ui-kit/react/v5/message-list) component using the `templates` prop of `CometChatMessageList` component.
