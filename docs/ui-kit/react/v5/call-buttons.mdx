...
You can set `CallSettingsBuilder` in the Call Buttons Component to customise the calling experience. To know more about the filters available please refer to [CallSettingsBuilder](/docs/sdk/javascript/direct-call#settings).
...
Configurations offer the ability to customize the properties of each component within a Composite Component. `CallButtons` component renders [CometChatOutgoingCall](/docs/ui-kit/react/v5/outgoing-call) component.
...
You can refer to [CometChatOutgoingCall](/docs/ui-kit/react/v5/outgoing-call) component to know more about each of the above properties.
