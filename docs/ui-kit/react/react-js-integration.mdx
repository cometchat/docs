...
Before using any features of the **CometChat UI Kit** or **CometChat SDK**, you must **initialize** the required settings. This is done using the [`Init`](/docs/ui-kit/react/methods#init) method.
...
For secure authentication, use the [`Auth Token`](/docs/ui-kit/react/methods#login-using-auth-token) method instead.
...
* **[Integrate Conversation List + Message](/docs/ui-kit/react/react-conversation)**
* **[Integrate One-to-One Chat](/docs/ui-kit/react/react-one-to-one-chat)**
* **[Integrate Tab-Based Chat](/docs/ui-kit/react/react-tab-based-chat)**
* **[Advanced Customizations](/docs/ui-kit/react/theme)**
