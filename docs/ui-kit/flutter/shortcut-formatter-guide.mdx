...
The widgets [CometChatConversations](/docs/ui-kit/flutter/conversations), [CometChatMessageComposer](/docs/ui-kit/flutter/message-composer) and [CometChatMessageList](/docs/ui-kit/flutter/message-list) have a property called `textFormatters` which accepts a list of CometChatTextFormatter to format the text. The code shared below `textFormatters` consisting of the above created Shortcuts formatter being passed down to [CometChatMessageComposer](/docs/ui-kit/flutter/message-composer) from [CometChatConversationsWithMessages](/docs/ui-kit/flutter/conversations-with-messages) with help of configurations.
