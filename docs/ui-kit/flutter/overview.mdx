...
[**Go to Flutter UI Docs**](/docs/ui-kit/flutter/getting-started)

***

## **Before Getting Started**

Before you begin, it's essential to grasp the fundamental concepts and features offered by CometChat's APIs, SDK, and UI Kit. You can find detailed information in the [Key Concepts](/docs/fundamentals/key-concepts) documentation.
...
To begin, please follow the [Getting Started](/docs/ui-kit/flutter/getting-started) guide.
...
2. **Follow the Setup Guide** – [Flutter Integration Guide](/docs/ui-kit/flutter/getting-started)
