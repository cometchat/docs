...
If [CometChatMessages](/docs/ui-kit/flutter/v4/messages) has been launched for a `Group` only the video call button will be present in the [CometChatMessageHeader](/docs/ui-kit/flutter/v4/message-header), pressing on which shall navigate the user to the [CometChatOngoingCall](/docs/ui-kit/flutter/v4/ongoing-call) Widget and a [CustomMessage](/docs/sdk/flutter/send-message) will be sent in the background with details for other group members to join the call, this [CustomMessage](/docs/sdk/flutter/send-message#custom-message) will be displayed on the [CometChatMessageList](/docs/ui-kit/flutter/v4/message-list) using this `CometChatCallBubble`.
...
| **theme**           | [CometChatTheme](/docs/ui-kit/flutter/v4/theme) | used to set custom theme                                                                                |
