...
[Actions](/docs/ui-kit/flutter/v4/components-overview#actions) dictate how a widgets functions. They are divided into two types: Predefined and User-defined. You can override either type, allowing you to tailor the behavior of the widgets to fit your specific needs.
...
To apply customized styles to the `Avatar` widget in the `CometChatDetails` widget, you can use the following code snippet. For further insights on **Avatar** Styles [refer](/docs/ui-kit/flutter/v4/avatar)
...
To apply customized styles to the `StatusIndicator` widget in the `CometChatDetails` widget, You can use the following code snippet. For further insights on Status Indicator Styles [refer](/docs/ui-kit/flutter/v4/status-indicator)
...
To apply customized styles to the List Item widget in the `CometChatDetails` widget, You can use the following code snippet. For further insights on List Item Styles [refer](/docs/ui-kit/flutter/v4/list-item)
