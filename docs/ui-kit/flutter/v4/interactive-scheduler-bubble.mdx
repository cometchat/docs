...
| ------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **schedulerMessage**      | [SchedulerMessage](/docs/ui-kit/flutter/v4/interactive-scheduler-message) | An instance of the `SchedulerMessage` class which holds information about the event scheduling availability.                                                                                                              |
...
| **quickViewStyle**        | [QucikViewStyle](/docs/ui-kit/flutter/v4/quick-view)                      | An object of styles for customizing the UI of the bubble at goal completion level                                                                                                                                         |
