...
`CometChatCallLogs` is a [Widget](/docs/ui-kit/flutter/v4/components-overview#components) that shows the list of Call Logs available. By default, names are shown for all listed users, along with their avatars if available.
...
| Widgets                                                | Description                                                                                                                                                                             |
| ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [CometChatListBase](/docs/ui-kit/flutter/v4/list-base) | `CometChatListBase` is a container widget featuring a title, customizable background options, and a dedicated list widget for seamless integration within your application's interface. |
| [CometChatListItem](/docs/ui-kit/flutter/v4/list-item) | This widget displays data retrieved from a CallLog object on a card, presenting a title and subtitle.                                                                                   |
...
The [CallLogRequestBuilder](/docs/sdk/flutter/call-logs) enables you to filter and customize the call list based on available parameters in CallLogRequestBuilder. This feature allows you to create more specific and targeted queries during the call. The following are the parameters available in [CallLogRequestBuilder](/docs/sdk/flutter/call-logs)
...
To apply customized styles to the `Avatar` widget in the `CallLogs` Widget, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/docs/ui-kit/flutter/v4/avatar#avatarstyle)
...
To apply customized styles to the `ListItemStyle` widget in the `CallLogs` Widget, you can use the following code snippet. For further insights on `ListItemStyle` Styles [refer](/docs/ui-kit/flutter/v4/list-item)
...
All exposed properties of `OutgoingCallConfiguration` can be found under [OutGoing Call](/docs/ui-kit/flutter/v4/outgoing-call#functionality). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
