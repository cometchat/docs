...
| --------------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| message         | [CardMessage](/docs/ui-kit/flutter/v4/interactive-card-message) | An instance of the CardMessage class which holds information about the card such as image URL, text, and action buttons. |
