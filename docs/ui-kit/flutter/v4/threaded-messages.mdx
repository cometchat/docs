...
| Widget                                                      | Description                                                                                                     |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| [MessageList](/docs/ui-kit/flutter/v4/message-list)         | CometChatMessageList is a widget that displays a list of Messages                                               |
| [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) | CometChatMessageComposer is a widget that helps in writing and editing of messages and also sending attachments |
...
ThreadedMessages does not have its own actions. However, you can override the behavior of the ThreadedMessages widget by using the actions of its widgets, with the help of [Configurations](/docs/ui-kit/flutter/v4/components-overview#configurations).
...
If you want to customize the properties of the [MessageList](/docs/ui-kit/flutter/v4/message-list) Widget inside ThreadedMessages Widget, you need use the `MessageListConfiguration` object.
...
If you want to customize the properties of the [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) Widget inside ThreadedMessages Widget, you need use the `MessageComposerConfiguration` object.
