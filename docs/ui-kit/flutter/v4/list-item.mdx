...
| **style**                | [ListItemStyle](/docs/ui-kit/flutter/v4/list-item)               | used to customize the appearance of this widget                                   |
| **avatarStyle**          | [AvatarStyle](/docs/ui-kit/flutter/v4/avatar)                    | used to customise the Avatar shown in the leading view                            |
| **statusIndicatorStyle** | [StatusIndicatorStyle](/docs/ui-kit/flutter/v4/status-indicator) | used to customise the status indicator                                            |
