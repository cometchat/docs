...
The `CometChatConversations` is a [Widget](/docs/ui-kit/flutter/v4/components-overview#components), That shows all conversations related to the currently logged-in user,
...
You can set `ConversationsRequestBuilder` in the `CometChatConversations` widget to filter the conversation list. You can modify the builder as per your specific requirements with multiple options available to know more refer to [ConversationsRequestBuilder](/docs/sdk/flutter/retrieve-conversations).
...
To apply customized styles to the `Avatar` widget in the `CometChatConversations` Widget, you can use the following code snippet. For more information, visit [Avatar Styles](/docs/ui-kit/flutter/v4/avatar).
...
To apply customized styles to the `StatusIndicator` widget in the `CometChatConversations` Widget, you can use the following code snippet. For more information, visit [Indicator Styles](/docs/ui-kit/flutter/v4/status-indicator).
...
To apply customized styles to the `Date` widget in the `Conversations` Widget, you can use the following code snippet. For more information, visit [Date Styles](/docs/ui-kit/flutter/v4/date).
...
To apply customized styles to the `Badge` widget in the `Conversations` Widget, you can use the following code snippet. For more information, visit [Badge Styles](/docs/ui-kit/flutter/v4/badge)
...
To apply customized styles to the `List Item` widget in the `Conversations` Widget, you can use the following code snippet. For more information, visit [List Item Styles](/docs/ui-kit/flutter/v4/list-item).
...
Assigns the list of text formatters. If the provided list is not null, it sets the list. Otherwise, it assigns the default text formatters retrieved from the data source. To configure the existing Mentions look and feel check out [CometChatMentionsFormatter](/docs/ui-kit/flutter/v4/mentions-formatter-guide)
