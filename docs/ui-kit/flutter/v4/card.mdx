...
| **avatar**      | [CometChatAvatar](/docs/ui-kit/flutter/v4/avatar) | used to set avatar for card        |
| **cardStyle**   | [CardStyle](/docs/ui-kit/flutter/v4/card)         | used to set style for card         |
