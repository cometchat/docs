...
The `CometChatConversationsWithMessages` is a [Composite Widget](/docs/ui-kit/flutter/v4/components-overview#components) encompassing widgets such as [Conversations](/docs/ui-kit/flutter/v4/conversations), [Messages](/docs/ui-kit/flutter/v4/messages), and [Contacts](/docs/ui-kit/flutter/v4/contacts). Each of these widgets contributes to the functionality and structure of the overall `CometChatConversationsWithMessages` widget.
...
| Widgets                                                | Description                                                                                                                                         |
| ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Conversations](/docs/ui-kit/flutter/v4/conversations) | The `Conversations` widget is designed to display a list of either `User` or `Group`. This essentially represents your recent conversation history. |
| [Messages](/docs/ui-kit/flutter/v4/messages)           | The `Messages` widget is designed to manage the messaging interaction for either individual `User` or `Group` conversations.                        |
| [Contacts](/docs/ui-kit/flutter/v4/contacts)           | The `CometChatContacts` widget is specifically designed to facilitate the display and management of both `User` and `Groups`.                       |
...
While the `CometChatConversationsWithMessages` widget does not have its actions, its sub-widgets - [Conversation](/docs/ui-kit/flutter/v4/conversations#actions), [Messages](/docs/ui-kit/flutter/v4/messages), and [Contacts](/docs/ui-kit/flutter/v4/contacts) - each have their own set of actions.
...
While the `CometChatConversationsWithMessages` widget does not have filters, its widgets do, For more detail on individual filters of its widget refer to [Conversations](/docs/ui-kit/flutter/v4/conversations#filters)[Filters](/docs/ui-kit/flutter/v4/conversations#filters) and [Messages Filters](/docs/ui-kit/flutter/v4/messages).
...
The `CometChatConversationsWithMessages` does not produce any events but its subwidget does. For a full list of these events, you can refer to [Conversations events](/docs/ui-kit/flutter/v4/conversations#events) and [Messages events](/docs/ui-kit/flutter/v4/messages#events).
...
You can utilize the `user` function with a [User](/docs/sdk/flutter/user-management) object as input to `CometChatConversationsWithMessages`. This will automatically guide you to the [Messages](/docs/ui-kit/flutter/v4/messages) widget for the designated `User`.
...
You can utilize the `set(group: Group?)` function with a [Group](/docs/sdk/flutter/groups-overview) object as input to `CometChatConversationsWithMessages`. This will automatically guide you to the [Messages](/docs/ui-kit/flutter/v4/messages) widget for the designated `Group`.
...
You can find the list of all Functionality customization of individual widgets in [Conversations](/docs/ui-kit/flutter/v4/conversations#functionality) , [Messages](/docs/ui-kit/flutter/v4/messages#functionality), and [Contacts](/docs/ui-kit/flutter/v4/contacts)
...
To find all the details on individual Widget advance customization you can refer, [Conversations Advance](/docs/ui-kit/flutter/v4/conversations#advanced),[Messages Advance](/docs/ui-kit/flutter/v4/messages#advanced) and [Contacts Advance](/docs/ui-kit/flutter/v4/contacts)
...
1. ConversationsWithMessages utilizes the [SetMenu](/docs/ui-kit/flutter/v4/conversations#appbaroptions) function of the `Conversations` subwidget to navigate the user from [Conversations](/docs/ui-kit/flutter/v4/conversations) to [Contacts](/docs/ui-kit/flutter/v4/contacts)
...
2. ConversationsWithMessages utilizes the [SetMenu](/docs/ui-kit/flutter/v4/message-header#appbaroptions) function of the `Messages` subwidget to navigate the user from [Messages](/docs/ui-kit/flutter/v4/messages) to [Details](/docs/ui-kit/flutter/v4/group-details).
...
[Configurations](/docs/ui-kit/flutter/v4/components-overview#configurations) offer the ability to customize the properties of each widget within a Composite Widget.
