...
A MessageTemplate provides you with the capability to define and customize both the structure and the behavior of the [MessageBubble](/docs/ui-kit/flutter/v4/message-bubble). It acts as a schema or design blueprint for the creation of a variety of [MessageBubble](/docs/ui-kit/flutter/v4/message-bubble) widgets, allowing you to manage the appearance and interactions of [MessageBubble](/docs/ui-kit/flutter/v4/message-bubble) within your application effectively and consistently.
...
2. **Category**
   ...
   Please refer to our guide on [Message Categories](/docs/sdk/flutter/message-structure-and-hierarchy) for a deeper understanding of message categories.
...
4. **Content Widget**
   ...
   The `contentView` method allows you to assign a custom content widget to the MessageBubble. By default, it displays the [Text Bubble](/docs/ui-kit/flutter/v4/text-bubble), [Image Bubble](/docs/ui-kit/flutter/v4/image-bubble), [File Bubble](/docs/ui-kit/flutter/v4/file-bubble), [Audio Bubble](/docs/ui-kit/flutter/v4/audio-bubble), or [Video Bubble](/docs/ui-kit/flutter/v4/video-bubble), depending on the message type.
...
Let's dive into how you can use the [properties](#properties) of MessageTemplate to customize an existing template or add a new one to the [MessageList](/docs/ui-kit/flutter/v4/message-list) Widget.
