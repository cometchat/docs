...
`CometChatVideoBubble` is the content view for a [MediaMessage](/docs/sdk/flutter/send-message#media-message) if the media sent is a video.
...
| **style**                       | [VideoBubbleStyle](/docs/ui-kit/flutter/v4/video-bubble#videobubblestyle) | used to customize appearance of this widget                                         |
