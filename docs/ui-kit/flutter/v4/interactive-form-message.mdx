...
The `FormMessage` class is used to create an interactive form message that can be sent via CometChat. It extends the [Interactive Messages](/docs/sdk/flutter/interactive-messages) class from CometChat.
...
| formFields             | List\<[ElementEntity](/docs/ui-kit/flutter/v4/interactive-element-entity)> | The fields of the form                              |
...
| interactionGoal        | [InteractionGoal](/docs/sdk/flutter/interactive-messages#interactiongoal)  | The sets the interaction goal for the form to ma    |
| interactions           | [Interactions](/docs/sdk/flutter/interactive-messages#interaction)         | Gives the list of elements you have interacted with |
