...
You can adjust the `callSettingsBuilder` in the `OnGoing Call` Widget to customize the OnGoing Call. Numerous options are available to alter the builder to meet your specific needs. For additional details on `CallSettingsBuilder`, please visit [CallSettingsBuilder](/docs/sdk/android/direct-calling).
