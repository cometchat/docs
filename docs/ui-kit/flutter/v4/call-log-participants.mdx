...
To apply customized styles to the `Avatar` widget in the `CometChatCallLogParticipants` Widget, you can use the following code snippet. For more information, visit [Avatar Styles](/docs/ui-kit/flutter/v4/avatar).
...
To apply customized styles to the List Item widget in the `CometChatCallLogParticipants` widget, You can use the following code snippet. For further insights on List Item Styles [refer](/docs/ui-kit/flutter/v4/list-item)
