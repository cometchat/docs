...
`CometChatAudioBubble` is the content view for a [MediaMessage](/docs/sdk/flutter/send-message#media-message) if the media sent is an audio.
...
| **style**                       | [AudioBubbleStyle](/docs/ui-kit/flutter/v4/audio-bubble#audiobubblestyle) | used to customize appearance of this widget                                         |
