...
`CometChatFileBubble` is the content view for a [MediaMessage](/docs/sdk/flutter/send-message#media-message) if the media sent is a file.
...
| **style**        | [FileBubbleStyle](/docs/ui-kit/flutter/v4/file-bubble#filebubblestyle) | used to customize appearance of this widget        |
