...
`CometChatTextBubble` is the content view shown for [TextMessage](/docs/sdk/flutter/send-message#text-message).

| Properties    | Type                                                                   | Description                                 |
| ------------- | ---------------------------------------------------------------------- | ------------------------------------------- |
| **text**      | String                                                                 | the text to display                         |
| **style**     | [TextBubbleStyle](/docs/ui-kit/flutter/v4/text-bubble#textbubblestyle) | used to customize appearance of this widget |
| **theme**     | [Theme](/docs/ui-kit/flutter/v4/theme)                                 | used to set custom theme                    |
