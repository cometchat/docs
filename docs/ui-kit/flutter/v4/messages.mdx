...
The Messages is a [Composite Widget](/docs/ui-kit/flutter/v4/components-overview#composite-components) that manages messages for users and groups.
...
The Messages widget is composed of three individual widgets, [MessageHeader](/docs/ui-kit/flutter/v4/message-header), [MessageList](/docs/ui-kit/flutter/v4/message-list), and [MessageComposer](/docs/ui-kit/flutter/v4/message-composer). In addition, the Messages widget also navigates to the [Details](/docs/ui-kit/flutter/v4/group-details) and [ThreadedMessages](/docs/ui-kit/flutter/v4/threaded-messages) widgets.

| Widgets                                                       | Description                                                                                                                                                                                              |
| ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MessageHeader](/docs/ui-kit/flutter/v4/message-header)       | `CometChatMessageHeader` displays the `User` or `Group` information using CometChat SDK's `User` or `Group object.` It also shows the typing indicator when the user starts typing in `MessageComposer`. |
| [MessageList](/docs/ui-kit/flutter/v4/message-list)           | `CometChatMessageList` is one of the core UI widgets. It displays a list of messages and handles real-time operations.                                                                                   |
| [MessageComposer](/docs/ui-kit/flutter/v4/message-composer)   | `CometChatMessageComposer` is an independent and critical widget that allows users to compose and send various types of messages includes text, image, video and custom messages.                        |
| [Details](/docs/ui-kit/flutter/v4/group-details)              | `CometChatDetails` is a widget that displays all the available options available for `Users` & `Groups`                                                                                                  |
| [ThreadedMessages](/docs/ui-kit/flutter/v4/threaded-messages) | `CometChatThreadedMessages` is a widget that displays all replies made to a particular message in a conversation.                                                                                        |
...
[Actions](/docs/ui-kit/flutter/v4/components-overview#actions) dictate how a widget functions. They are divided into two types: Predefined and User-defined. You can override either type, allowing you to tailor the behavior of the widget to fit your specific needs.

The Messages widget does not have its actions. However, since it's a [Composite Widget](/docs/ui-kit/flutter/v4/components-overview#composite-components), you can use the actions of its widgets by utilizing the [Configurations](#configuration) object of each component.

**Example**

In this example, we are employing the [ThreadRepliesClick](/docs/ui-kit/flutter/v4/message-list#1-onthreadrepliesclick) action from the MessageList Widget through the MessageListConfiguration object.
...
> The Messages Widget overrides the [ThreadRepliesClick](/docs/ui-kit/flutter/v4/message-list#1-onthreadrepliesclick) action to navigate to the [ThreadedMessages](/docs/ui-kit/flutter/v4/threaded-messages) component. If you override `ThreadRepliesClick`, it will also override the default behavior of the Messages Widget.
...
The Messages widget does not have its filters. But as it is a [Composite Widget](/docs/ui-kit/flutter/v4/components-overview#composite-components), you can use the filters of its widgets by using the [Configurations](#configuration) object of each component. For more details on the filters of its widgets, please refer to [MessageList Filters](/docs/ui-kit/flutter/v4/message-list#filters).
...
[Events](/docs/ui-kit/flutter/v4/components-overview#events) are emitted by a `Widget`. By using event you can extend existing functionality. Being global events, they can be applied in Multiple Locations and are capable of being Added or Removed.
...
Being a [Composite component](/docs/ui-kit/flutter/v4/components-overview#composite-components), the Messages Widget allows you to customize the styles of its widgets using their respective Configuration objects.

For a list of all available properties, refer to each component's styling documentation: [MesssageHeader Styles](/docs/ui-kit/flutter/v4/message-header#style), [MessageList Styles](/docs/ui-kit/flutter/v4/message-list#style), [MessageComposer Styles](/docs/ui-kit/flutter/v4/message-composer#style), [Details Styles](/docs/ui-kit/flutter/v4/group-details), [ThreadMessages Styles](/docs/ui-kit/flutter/v4/threaded-messages).
...
If you want to customize the properties of the [MessageHeader](/docs/ui-kit/flutter/v4/message-header) Widget inside Messages Widget, you need use the `MessageHeaderConfiguration` object.
...
The `MessageHeaderConfiguration` provides access to all the [Action](/docs/ui-kit/flutter/v4/message-header#style), [Filters](/docs/ui-kit/flutter/v4/message-header#filters), [Styles](/docs/ui-kit/flutter/v4/message-header#style), [Functionality](/docs/ui-kit/flutter/v4/message-header#functionality), and [Advanced](/docs/ui-kit/flutter/v4/message-header#advanced) properties of the [MessageHeader](/docs/ui-kit/flutter/v4/message-header) component.

> Please note that the properties marked with the 🛑 symbol are not accessible within the Configuration Object.

**Example**

In this example, we will be adding a custom back button and styling a few properties of the Avatar widget of the [MessageHeader](/docs/ui-kit/flutter/v4/message-header) widget using `MessageHeaderConfiguration`.
...
If you want to customize the properties of the [MessageList](/docs/ui-kit/flutter/v4/message-list) Widget inside Messages Widget, you need use the `MessageListConfiguration` object.
...
The `MessageListConfiguration` provides access to all the [Action](/docs/ui-kit/flutter/v4/message-list#style), [Filters](/docs/ui-kit/flutter/v4/message-list#filters), [Styles](/docs/ui-kit/flutter/v4/message-list#style), [Functionality](/docs/ui-kit/flutter/v4/message-list#functionality), and [Advanced](//android-chat-ui-kit/message-list#advanced) properties of the [MessageList](/docs/ui-kit/flutter/v4/message-list) component.

> Please note that the properties marked with the 🛑 symbol are not accessible within the Configuration Object.

**Example**

In this example, we will be changing the list alignment and modifying the message bubble styles in the [MessageList](/docs/ui-kit/flutter/v4/message-list) widget using `MessageListConfiguration`.
...
If you want to customize the properties of the [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) Widget inside Messages Widget, you need use the `MessageComposerConfiguration` object.
...
The `MessageComposerConfiguration` provides access to all the [Action](/docs/ui-kit/flutter/v4/message-composer#style), [Filters](/docs/ui-kit/flutter/v4/message-composer#filters), [Styles](/docs/ui-kit/flutter/v4/message-composer#style), [Functionality](/docs/ui-kit/flutter/v4/message-composer#functionality), and [Advanced](/docs/ui-kit/flutter/v4/message-composer#advanced) properties of the [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) component.

> Please note that the properties marked with the 🛑 symbol are not accessible within the Configuration Object.

**Example**

In this example, we'll be adding a custom header widget and customizing some properties of the [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) widget using `MessageComposerConfiguration`.
...
If you want to customize the properties of the [ThreadedMessages](/docs/ui-kit/flutter/v4/threaded-messages) Widget inside Messages Widget, you need use the `ThreadedMessagesConfiguration` object.
...
The `ThreadedMessagesConfiguration` provides access to all the [Action](/docs/ui-kit/flutter/v4/threaded-messages#style), [Filters](/docs/ui-kit/flutter/v4/threaded-messages#filters), [Styles](/docs/ui-kit/flutter/v4/threaded-messages#style), [Functionality](/docs/ui-kit/flutter/v4/threaded-messages#functionality), and [Advanced](/docs/ui-kit/flutter/v4/threaded-messages#advanced) properties of the [ThreadedMessages](/docs/ui-kit/flutter/v4/threaded-messages) component.

> Please note that the properties marked with the 🛑 symbol are not accessible within the Configuration Object.

**Example**

In this example, we are adding a custom title to the Threaded Message widget and also adding custom properties to the [MessageList](#messagelist) using `MessageListConfiguration`. We then apply these changes to the [ThreadedMessages](/docs/ui-kit/flutter/v4/threaded-messages) widget using `ThreadedMessagesConfiguration`.
...
The `DetailsConfiguration` provides access to all the [Action](/docs/ui-kit/flutter/v4/message-composer#style), [Filters](/docs/ui-kit/flutter/v4/message-composer#filters), [Styles](/docs/ui-kit/flutter/v4/message-composer#style), [Functionality](/docs/ui-kit/flutter/v4/message-composer#functionality), and [Advanced](/docs/ui-kit/flutter/v4/message-composer#advanced) properties of the [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) component.

> Please note that the properties marked with the 🛑 symbol are not accessible within the Configuration Object.

**Example**

In this example, we'll be customizing some properties of the [MessageComposer](/docs/ui-kit/flutter/v4/message-composer) widget using `DetailsConfiguration`.
