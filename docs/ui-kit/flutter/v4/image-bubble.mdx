...
`CometChatImageBubble` is the content view for a [MediaMessage](/docs/sdk/flutter/send-message#media-message) if the media sent is an image.
...
| **style**                       | [ImageBubbleStyle](/docs/ui-kit/flutter/v4/image-bubble#imagebubblestyle) | used to customize appearance of this widget                                         |
