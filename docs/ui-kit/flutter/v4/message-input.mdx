...
`CometChatMessageInput` is a component that provides a skeleton layout for contents of [CometChatMessageComposer](/docs/ui-kit/flutter/v4/message-composer) like `TextField`, auxiliary options, primary button view and attachment options.
