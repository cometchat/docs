...
Once you have successfully activated the [Conversation Starter](/docs/fundamentals/ai-user-copilot/conversation-starter) from your CometChat Dashboard, the feature will automatically be incorporated into the [MessageList](/docs/ui-kit/flutter/message-list) Widget of UI Kits.
...
Once you have successfully activated the [Smart Replies](/docs/fundamentals/ai-user-copilot/smart-replies) from your CometChat Dashboard, the feature will automatically be incorporated into the Action sheet of [MessageComposer](/docs/ui-kit/flutter/message-composer) Widget of UI Kits.
