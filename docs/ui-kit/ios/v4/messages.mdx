...
The Messages component is composed of three individual components, [MessageHeader](/docs/ui-kit/ios/v4/message-header), [MessageList](/docs/ui-kit/ios/v4/message-list), and [MessageComposer](/docs/ui-kit/ios/v4/message-composer). In addition, the Messages component also navigates to the [Details](/docs/ui-kit/ios/v4/group-details) and [ThreadedMessages](/docs/ui-kit/ios/v4/threaded-messages) components.
...
| --------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [MessageHeader](/docs/ui-kit/ios/v4/message-header)       | `CometChatMessageHeader` displays the `User` or `Group` information using CometChat SDK's `User` or `Group object.` It also shows the typing indicator when the user starts typing in `MessageComposer`. |
| [MessageList](/docs/ui-kit/ios/v4/message-list)           | `CometChatMessageList` is one of the core UI components. It displays a list of messages and handles real-time operations.                                                                                |
| [MessageComposer](/docs/ui-kit/ios/v4/message-composer)   | `CometChatMessageComposer` is an independent and critical component that allows users to compose and send various types of messages includes text, image, video and custom messages.                     |
| [Details](/docs/ui-kit/ios/v4/group-details)              | `CometChatDetails` is a component that displays all the available options available for `Users` & `Groups`                                                                                               |
| [ThreadedMessages](/docs/ui-kit/ios/v4/threaded-messages) | `CometChatThreadedMessages` is a component that displays all replies made to a particular message in a conversation.                                                                                     |
...
[Actions](/docs/ui-kit/ios/v4/components-overview#actions) dictate how a component functions. They are divided into two types: Predefined and User-defined. You can override either type, allowing you to tailor the behavior of the component to fit your specific needs.

The Messages component does not have its actions. However, since it's a [Composite Component](/docs/ui-kit/ios/v4/components-overview#components), you can use the actions of its components by utilizing the [Configurations](#configuration) object of each component.

**Example**

In this example, we are employing the [ThreadRepliesClick](/docs/ui-kit/ios/v4/message-list#1-onthreadrepliesclick) action from the MessageList Component through the MessageListConfiguration object.
...
> The Messages Component overrides the [ThreadRepliesClick](/docs/ui-kit/ios/v4/message-list#1-onthreadrepliesclick) action to navigate to the [ThreadedMessages](/docs/ui-kit/ios/v4/threaded-messages) component. If you override `ThreadRepliesClick`, it will also override the default behavior of the Messages Component.

### Filters

**Filters** allow you to customize the data displayed in a list within a Component. You can filter the list based on your specific criteria, allowing for a more customized. Filters can be applied using RequestBuilders of Chat SDK.

The Messages component does not have its filters. But as it is a [Composite Component](/docs/ui-kit/ios/v4/components-overview#components), you can use the filters of its components by using the [Configurations](#configuration) object of each component. For more details on the filters of its components, please refer to [MessageList Filters](/docs/ui-kit/ios/v4/message-list#filters).
...
[Events](/docs/ui-kit/ios/v4/components-overview#events) are emitted by a `Component`. By using event you can extend existing functionality. Being global events, they can be applied in Multiple Locations and are capable of being Added or Removed.
...
Being a [Composite component](/docs/ui-kit/ios/v4/components-overview#composite-components), the Messages Component allows you to customize the styles of its components using their respective Configuration objects.

For a list of all available properties, refer to each component's styling documentation: [MesssageHeader Styles](/docs/ui-kit/ios/v4/message-header#style), [MessageList Styles](/docs/ui-kit/ios/v4/message-list#style), [MessageComposer Styles](/docs/ui-kit/ios/v4/message-composer#style), [Details Styles](/docs/ui-kit/ios/v4/group-details), [ThreadMessages Styles](/docs/ui-kit/ios/v4/threaded-messages).
...
The Messages Component uses the `setAuxiliaryMenu()` method to establish its default functionality. By setting an Auxiliary Menu, the Messages Component gains the capability to navigate to the [Details](/docs/ui-kit/ios/v4/group-details) section.
...
If you want to customize the properties of the [MessageHeader](/docs/ui-kit/ios/v4/message-header) Component inside Messages Component, you need use the `MessageHeaderConfiguration` object.
...
The `MessageHeaderConfiguration` provides access to all the [Action](/docs/ui-kit/ios/v4/message-header#style), [Filters](/docs/ui-kit/ios/v4/message-header#filters), [Styles](/docs/ui-kit/ios/v4/message-header#style), [Functionality](/docs/ui-kit/ios/v4/message-header#functionality), and [Advanced](/docs/ui-kit/ios/v4/message-header#advanced) properties of the [MessageHeader](/docs/ui-kit/ios/v4/message-header) component.
...
In this example, we will be adding a custom back button and styling a few properties of the Avatar component of the [MessageHeader](/docs/ui-kit/ios/v4/message-header) component using `MessageHeaderConfiguration`.
...
If you want to customize the properties of the [MessageList](/docs/ui-kit/ios/v4/message-list) Component inside Messages Component, you need use the `MessageListConfiguration` object.
...
The `MessageListConfiguration` provides access to all the [Action](/docs/ui-kit/ios/v4/message-list#style), [Filters](/docs/ui-kit/ios/v4/message-list#filters), [Styles](/docs/ui-kit/ios/v4/message-list#style), [Functionality](/docs/ui-kit/ios/v4/message-list#functionality), and [Advanced](//ios-chat-ui-kit/message-list#advanced) properties of the [MessageList](/docs/ui-kit/ios/v4/message-list) component.
...
In this example, we will be changing the list alignment and modifying the message bubble styles in the [MessageList](/docs/ui-kit/ios/v4/message-list) component using `MessageListConfiguration`.
...
If you want to customize the properties of the [MessageComposer](/docs/ui-kit/ios/v4/message-composer) Component inside Messages Component, you need use the `MessageComposerConfiguration` object.
...
The `MessageComposerConfiguration` provides access to all the [Action](/docs/ui-kit/ios/v4/message-composer#style), [Filters](/docs/ui-kit/ios/v4/message-composer#filters), [Styles](/docs/ui-kit/ios/v4/message-composer#style), [Functionality](/docs/ui-kit/ios/v4/message-composer#functionality), and [Advanced](/docs/ui-kit/ios/v4/message-composer#advanced) properties of the [MessageComposer](/docs/ui-kit/ios/v4/message-composer) component.
...
In this example, we'll customizing some properties of the [MessageComposer](/docs/ui-kit/ios/v4/message-composer) component using `MessageComposerConfiguration`.
...
If you want to customize the properties of the [ThreadedMessages](/docs/ui-kit/ios/v4/threaded-messages) Component inside Messages Component, you need use the `ThreadedMessagesConfiguration` object.
...
The `ThreadedMessagesConfiguration` provides access to all the [Action](/docs/ui-kit/ios/v4/threaded-messages#style), [Filters](/docs/ui-kit/ios/v4/threaded-messages#filters), [Styles](/docs/ui-kit/ios/v4/threaded-messages), [Functionality](/docs/ui-kit/ios/v4/threaded-messages), and [Advanced](/docs/ui-kit/ios/v4/threaded-messages#advanced) properties of the [ThreadedMessages](/docs/ui-kit/ios/v4/threaded-messages) component.
