...
The `ConversationsWithMessages` is a [Composite Component](/docs/ui-kit/ios/v4/components-overview#components) encompassing components such as [Conversations](/docs/ui-kit/ios/v4/conversations), [Messages](/docs/ui-kit/ios/v4/messages), and [Contacts](/docs/ui-kit/ios/v4/contacts) . Each of these component contributes to the functionality and structure of the overall ConversationsWithMessages component.
...
| -------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Conversations](/docs/ui-kit/ios/v4/conversations) | The `Conversations` component is designed to display a list of either `User` or `Group`. This essentially represents your recent conversation history. |
| [Messages](/docs/ui-kit/ios/v4/messages)           | The `Messages` component is designed to manage the messaging interaction for either individual `User` or `Group` conversations.                        |
| [Contacts](/docs/ui-kit/ios/v4/contacts)           | The `CometChatContacts` component is specifically designed to facilitate the display and management of both `User` and `Groups`.                       |
...
While the ConversationsWithMessages component does not have its actions, its components - [Conversation](/docs/ui-kit/ios/v4/conversations#actions), [Messages](/docs/ui-kit/ios/v4/messages), and [Contacts](/docs/ui-kit/ios/v4/contacts) - each have their own set of actions.
...
* [setOnItemClick](/docs/ui-kit/ios/v4/conversations#setonitemclick) : This `setOnItemClick` method proves beneficial when a user intends to customize the on-click behavior in CometChatConversations.
...
While the ConversationsWithMessages component does not have filters, its components do, For more detail on individual filters of its component refer to [Conversations](/docs/ui-kit/ios/v4/conversations#filters)[Filters](/docs/ui-kit/ios/v4/conversations#filters) and [Messages Filters](/docs/ui-kit/ios/v4/messages).
...
The ConversationsWithMessages does not generate its events but its component does. For a full list of these events, you can refer to [Conversations events](/docs/ui-kit/ios/v4/conversations#events) and [Messages events](/docs/ui-kit/ios/v4/messages#events).
...
You can utilize the `set(user: User?)` function with a [User](/docs/sdk/ios/user-management) object as input to ConversationsWithMessages. This will automatically guide you to the [Messages](/docs/ui-kit/ios/v4/messages) component for the designated `User`.
...
You can utilize the `set(group: Group?)` function with a [Group](/docs/sdk/ios/groups-overview) object as input to ConversationsWithMessages. This will automatically guide you to the [Messages](/docs/ui-kit/ios/v4/messages) component for the designated `Group`.
...
You can find the list of all Functionality customization of individual components in [Conversations](/docs/ui-kit/ios/v4/conversations#functionality) , [Messages](/docs/ui-kit/ios/v4/messages#functionality), and [Contacts](/docs/ui-kit/ios/v4/Contacts)
...
To find all the details on individual Component advance customization you can refer, [Conversations Advance](/docs/ui-kit/ios/v4/conversations#advanced),[Messages Advance](/docs/ui-kit/ios/v4/messages#advanced) and [Contacts Advance](/docs/ui-kit/ios/v4/contacts)
...
1. ConversationsWithMessages utilizes the [SetMenu](/docs/ui-kit/ios/v4/conversations#setmenu) function of the `Conversations` subcomponent to navigate the user from [Conversations](/docs/ui-kit/ios/v4/conversations) to [Contacts](/docs/ui-kit/ios/v4/contacts)

<Frame>
  <img src="/images/19bfa4a5-advanced_1_screens-0c1ebaf3ef9bb5681337a49b23b927f6.png" />
</Frame>

2. ConversationsWithMessages utilizes the [SetMenu](/docs/ui-kit/ios/v4/message-header#setmenu) function of the `Messages` subcomponent to navigate the user from [Messages](/docs/ui-kit/ios/v4/messages) to [Details](/docs/ui-kit/ios/v4/user-details).
...
[Configurations](/docs/ui-kit/ios/v4/components-overview#configurations) offer the ability to customize the properties of each component within a Composite Component.
...
All exposed properties of `ConversationsConfiguration` can be found under [Conversations](/docs/ui-kit/ios/v4/conversations). Properties marked with the <Tooltip tip="Not available">🛑</Tooltip> symbol are not accessible within the Configuration Object.
