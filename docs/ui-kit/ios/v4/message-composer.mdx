...
MessageComposer is a [Component](/docs/ui-kit/ios/v4/components-overview#components) that enables users to write and send a variety of messages, including text, image, video, and custom messages.
...
MessageComposer is comprised of the following [Base Components](/docs/ui-kit/ios/v4/components-overview#base-components):

| Base Components                                   | Description                                                                                                            |
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [MessageInput](/docs/ui-kit/ios/v4/message-input) | This provides a basic layout for the contents of this component, such as the TextField and buttons                     |
| [ActionSheet](/docs/ui-kit/ios/v4/action-sheet)   | The ActionSheet component presents a list of options in either a list or grid mode, depending on the user's preference |
...
To customize the styles of the MediaRecorder component within the MessageComposer Component, use the `.set(mediaRecorderStyle:)` method. For more details, please refer to [MediaRecorder](/docs/ui-kit/ios/v4/media-recorder) styles.
...
To customize the styles of the MediaRecorder component within the MessageComposer Component, use the `.set(aiOptionsStyle:)` method. For more details, please refer to [MediaRecorder](/docs/ui-kit/ios/v4/media-recorder) styles.
