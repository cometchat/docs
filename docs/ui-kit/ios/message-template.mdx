...
A MessageTemplate provides you with the capability to define and customize both the structure and the behavior of the [MessageBubble](/docs/ui-kit/ios/message-bubble-styling). It acts as a schema or design blueprint for the creation of a variety of [MessageBubble](/docs/ui-kit/ios/message-bubble-styling) components, allowing you to manage the appearance and interactions of [MessageBubble](/docs/ui-kit/ios/message-bubble-styling) within your application effectively and consistently.
...
4. **Content View**
   ...
   The `template.contentView` method allows you to assign a custom content view to the MessageBubble. By default, it displays the [Text Bubble](/docs/ui-kit/ios/message-bubble-styling#text-bubble), [Image Bubble](/docs/ui-kit/ios/message-bubble-styling-styling#image-bubble), [File Bubble](/docs/ui-kit/ios/message-bubble-styling-styling), [Audio Bubble](/docs/ui-kit/ios/message-bubble-styling-styling#audio-bubble), or [Video Bubble](/docs/ui-kit/ios/message-bubble-styling#video-bubble), depending on the message type.
...
Let's dive into how you can use the [properties](#properties) of MessageTemplate to customize an existing template or add a new one to the [MessageList](/docs/ui-kit/ios/message-list) component.
...
You will be using `CometChatMessageBubble` Component for example here so to apply Template to Messages you will have to use [MessageList](/docs/ui-kit/ios/message-list) component.
