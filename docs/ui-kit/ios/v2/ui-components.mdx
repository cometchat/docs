...
To retrieve the `User` or `Group` object you can call [`CometChat.getUser()`](/docs/sdk/ios/retrieve-users#retrieve-particular-user-details) or [`CometChat.getGroup()`](/docs/sdk/ios/retrieve-groups#retrieve-particular-group-details).
