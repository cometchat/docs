...
`MessageHeader` is a [Component](/docs/ui-kit/ios/components-overview#components) that showcases the [User](/docs/sdk/ios/users-overview) or [Group](/docs/sdk/ios/groups-overview) details in the toolbar. Furthermore, it also presents a typing indicator and a back navigation button for ease of use.
...
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| [ListItem Component](/docs/ui-kit/ios/list-item) | This component’s view consists of avatar, status indicator , title, and subtitle. The fields are then mapped with the SDK’s user, group class. |
...
If you want to apply customized styles to the `Avatar` component within the `MessageHeader` Component, you can use the following code snippet. For more information you can refer [Avatar Styles](/docs/ui-kit/ios/component-styling#avatar#methods).
...
The **CometChatMessageHeader** component supports full customization of how date and time are displayed using the [CometChatDateTimeFormatter](/docs/ui-kit/ios/localize#datetimeformatter).
