...
* **Built on Core SDK** – Leverages the powerful [CometChat iOS SDK](/docs/sdk/ios/overview) for reliable performance.
...
* Follow the [Getting Started Guide](/docs/ui-kit/ios/getting-started) for detailed steps on initial setup and integration.
...
Explore more about UI customization in the [Customization Guide](/docs/ui-kit/ios/theme-introduction).
