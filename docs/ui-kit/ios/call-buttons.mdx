...
The `Call Button` is a [Component](/docs/ui-kit/ios/components-overview#components) provides users with the ability to make calls, access call-related functionalities, and control call settings. Clicking this button typically triggers the call to be placed to the desired recipient.
...
[Configurations](/docs/ui-kit/ios/components-overview#configurations) offer the ability to customize the properties of each individual component within a Composite Component.
...
All exposed properties of `OutgoingCallConfiguration` can be found under [Outgoing Call](/docs/ui-kit/ios/outgoing-call). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
