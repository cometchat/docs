...
The UsersWithMessages is a [Composite Component](/docs/ui-kit/angular/components-overview#components) encompassing components such as [Users](/docs/ui-kit/angular/users) and [Messages](/docs/ui-kit/angular/messages). Both of these component contributes to the functionality and structure of the overall UsersWithMessages component.
...
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [Users](/docs/ui-kit/angular/users)       | The `Users` component is designed to display a list of `User`. This essentially represents your recent conversation history. |
| [Messages](/docs/ui-kit/angular/messages) | The `Messages` component is designed to manage the messaging interaction for individual `User's` conversations.              |
...
The UsersWithMessages component does not have much actions, its components - [Users](/docs/ui-kit/angular/users) and [Messages](/docs/ui-kit/angular/messages) - both have their own set of actions.
...
* [OnItemClick](/docs/ui-kit/angular/users#2-onitemclick) : By overriding the `OnItemClick` of the Users Component, UsersWithMessages achieves navigation from [Users](/docs/ui-kit/angular/users) to [Messages](/docs/ui-kit/angular/messages) component.
...
While the UsersWithMessages component does not have filters, its components do, For more detail on individual filters of its component refer to [Users Filters](/docs/ui-kit/angular/users#filters) and [Messages Filters](/docs/ui-kit/angular/messages).
...
You can also customize its component styles. For more details on individual component styles, you can refer [Users Styles](/docs/ui-kit/angular/users#style) and [Messages Styles](/docs/ui-kit/angular/messages#1-messages-style).
...
you can utilize the `user` method with a [User](/docs/sdk/javascript/user-management) object as input to the UsersWithMessages component. This will automatically direct you to the [Messages](/docs/ui-kit/angular/messages) component for the specified `User`.
...
You can find the list of all Functionality customization of individual components in [Users](/docs/ui-kit/angular/users#functionality) and [Messages](/docs/ui-kit/angular/messages#functionality).
...
To find all the details on individual Component advance customization you can refer, [Users Advance](/docs/ui-kit/angular/users#advance)and [Messages Advance](/docs/ui-kit/angular/messages#advanced).

UsersWithMessages uses advanced-level customization of both Users & Messages components to achieve its default behavior.

1. UsersWithMessages utilizes the [onItemClick](/docs/ui-kit/angular/users#2-onitemclick) property of the `Users` subcomponent to navigate the user from [Users](/docs/ui-kit/angular/users) to [Messages](/docs/ui-kit/angular/messages)

<Frame>
  <img src="/images/d0f6711c-users_with_messages_onitemclick_web_screens-a2bdda9009f1a50a6c1ad7fc332b81cd.png" />
</Frame>

2. UsersWithMessages utilizes the [menus](/docs/ui-kit/angular/messages#auxiliarymenu) of the `Messages` subcomponent to navigate from [Messages](/docs/ui-kit/angular/messages) to [Details](/docs/ui-kit/angular/group-details)
...
All exposed properties of `UsersConfiguration` can be found under [Users](/docs/ui-kit/angular/users#functionality). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
