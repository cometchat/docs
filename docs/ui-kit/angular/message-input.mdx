...
| auxiliaryButtonAlignment | [auxiliaryButtonAlignmentEnum](/docs/ui-kit/angular/message-input#auxiliarybuttonalignmentenum) | Group of constants representing the in-built alignment pattern          |
| messageInputStyle        | [MessageInputStyle](/docs/ui-kit/angular/message-input#messageinputstyle)                       | Styling properties and values of the element                            |
