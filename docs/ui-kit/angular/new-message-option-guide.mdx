...
The message options are then passed to the [ConversationsWithMessages](/docs/ui-kit/angular/conversations-with-messages) component as a prop using [MessagesConfiguration](/docs/web-shared/messages-configuration).
