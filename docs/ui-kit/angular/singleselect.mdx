...
| selectStyle    | [SingleSelectStyle](/docs/ui-kit/angular/singleselect#singleselectstyle) | An instance of the `SingleSelectStyle` class for customizing the Single Select component's style. |
