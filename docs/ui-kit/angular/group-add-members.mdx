...
| [CometChatUsers](/docs/ui-kit/angular/users) | This component the list of users                                |
...
To apply customized styles to the `Avatar` component in the Add Members Component, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/docs/ui-kit/angular/avatar#avatar-style)
...
To apply customized styles to the `List Item` component in the `Add Members` Component, you can use the following code snippet. For further insights on `List Item` Styles [refer](/docs/ui-kit/angular/list-item)
...
To apply customized styles to the Status Indicator component in the Add Members Component, You can use the following code snippet. For further insights on Status Indicator Styles [refer](/docs/ui-kit/angular/status-indicator)
