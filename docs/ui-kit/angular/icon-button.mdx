...
This element uses [Icon element](/docs/ui-kit/angular/icon) and [Label element](/docs/ui-kit/angular/label) to show text and icon(with background) and along with an alignment property to align the icon around the text. The purpose of this element is to initiate an action.
