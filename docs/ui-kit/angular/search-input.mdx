...
This element is built on top of [Input](/docs/ui-kit/angular/input) element and enables users to enter a search string.
...
| searchInputStyle | [SearchInputStyle](/docs/ui-kit/angular/search-input#searchinputstyle) | Styling properties and values of the element                                 |
