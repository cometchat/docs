...
| **schedulerMessage**     | [Scheduler Message](/docs/web-shared/scheduler-message) | An instance of the `SchedulerMessage` class which holds information about the event scheduling availability .                                                                                                             |
