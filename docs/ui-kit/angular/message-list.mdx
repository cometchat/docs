...
`MessageList` is a [Composite Component](/docs/ui-kit/angular/components-overview#composite-components) that displays a list of messages and effectively manages real-time operations. It includes various types of messages such as Text Messages, Media Messages, Stickers, and more.

`MessageList` is primarily a list of the base component [MessageBubble](/docs/ui-kit/angular/message-bubble). The MessageBubble Component is utilized to create different types of chat bubbles depending on the message type.
...
To apply customized styles to the `Avatar` component in the `Message List` Component, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/docs/ui-kit/angular/avatar#avatar-style)
...
[CometChatMessageTemplate](/docs/ui-kit/angular/message-template) is a pre-defined structure for creating message views that can be used as a starting point or blueprint for creating message views often known as message bubbles. For more information, you can refer to [CometChatMessageTemplate](/docs/ui-kit/angular/message-template).
...
Assigns the list of text formatters. If the provided list is not null, it sets the list. Otherwise, it assigns the default text formatters retrieved from the data source. To configure the existing Mentions look and feel check out [CometChatMentionsFormatter](/docs/ui-kit/angular/mentions-formatter-guide)
...
From the MessageList, you can navigate to the [MesssageInformation](/docs/ui-kit/angular/message-information) component as shown in the image.

<Frame>
  <img src="/images/e56d245b-message_list_message_information_option_web_screens-9da12131fd0f5fc7b7a07ec647c9c63b.png" />
</Frame>

If you wish to modify the properties of the [MesssageInformation](/docs/ui-kit/angular/message-information) Component, you can use the `MessageInformationConfiguration` object.
...
The `MessageInformationConfiguration` indeed provides access to all the [Action](/docs/ui-kit/angular/message-information#actions), [Filters](/docs/ui-kit/angular/message-information#filters), [Styles](/docs/ui-kit/angular/message-information#style), [Functionality](/docs/ui-kit/angular/message-information#functionality), and [Advanced](/docs/ui-kit/angular/message-information#functionality) properties of the [MesssageInformation](/docs/ui-kit/angular/message-information) component.
...
In the above example, we are styling a few properties of the [MesssageInformation](/docs/ui-kit/angular/message-information) component using `MessageInformationConfiguration`.

### Reaction

If you wish to modify the properties of the [Reaction](/docs/ui-kit/angular/reaction) Component, you can use the `reactionsConfiguration` object.
