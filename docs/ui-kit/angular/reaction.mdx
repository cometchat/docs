...
If you want to customize the properties of the [Reaction Info](/docs/ui-kit/angular/reaction-info) Component inside Reactions Component, you need use the `reactionInfoConfiguration` object.
...
The `reactionInfoConfiguration` indeed provides access to all the [Action](/docs/ui-kit/angular/reaction-info#actions), [Filters](/docs/ui-kit/angular/reaction-info#filters), [Styles](/docs/ui-kit/angular/reaction-info#style), [Functionality](/docs/ui-kit/angular/reaction-info#functionality), and [Advanced](/docs/ui-kit/angular/reaction-info#functionality) properties of the [Reaction Info](/docs/ui-kit/angular/reaction-info) component.

In the above example, we are styling a few properties of the [Reaction Info](/docs/ui-kit/angular/reaction-info) component using `reactionInfoConfiguration`.

### Reaction List

If you want to customize the properties of the [Reaction List](/docs/ui-kit/angular/reaction-list) Component inside Reactions Component, you need use the `reactionListConfiguration` object.
...
The `reactionListConfiguration` indeed provides access to all the [Action](/docs/ui-kit/angular/reaction-list#actions), [Filters](/docs/ui-kit/angular/reaction-list#filters), [Styles](/docs/ui-kit/angular/reaction-list#style), [Functionality](/docs/ui-kit/angular/reaction-list#functionality), and [Advanced](/docs/ui-kit/angular/reaction-list#functionality) properties of the [Reaction List](/docs/ui-kit/angular/reaction-list) component.

In the above example, we are styling a few properties of the [Reaction List](/docs/ui-kit/angular/reaction-list) component using `reactionListConfiguration`.
