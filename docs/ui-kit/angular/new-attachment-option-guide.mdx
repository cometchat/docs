...
The attachment options are then passed to the [ConversationsWithMessages](/docs/ui-kit/angular/conversations-with-messages) component as a prop using [MessageComposerConfguration](/docs/web-shared/message-composer-configuration).
