...
The `CometChatCallLogRecordings` is a [Component](/docs/ui-kit/angular/components-overview#components) that shows a paginated list of recordings of a particular call. This allows the user to see all the recordings along with the duration as well as a download link using which one can download the recording.
...
If you want to apply customized styles to the `List Item` component within the `Call Log Recordings` Component, you can use the following code snippet. For more information, you can refer [ListItem Styles](/docs/ui-kit/angular/list-item#listitemstyle).
