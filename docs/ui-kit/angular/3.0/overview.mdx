...
V4 UI kits offer modular design, extended functionality & customization for a tailored chat experience. Check out our new UIKits [here](/docs/ui-kit/angular/overview).
...
Please follow the steps provided in the [Key Concepts](/docs/ui-kit/angular/3.0/key-concepts) to create V3 apps before you proceed.
