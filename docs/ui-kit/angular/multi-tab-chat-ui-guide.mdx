...
We’ll use the [CometChatConversationsWithMessages](/docs/ui-kit/angular/conversations-with-messages), [CometChatUsersWithMessages](/docs/ui-kit/angular/users-with-messages), and [CometChatGroupsWithMessages](/docs/ui-kit/angular/groups-with-messages) components and launch them as individual tab items within the tabbed layout.
