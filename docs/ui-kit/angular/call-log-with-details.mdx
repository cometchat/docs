...
The `CometChatCallLogsWithDetails` is a [Composite Component](/docs/ui-kit/angular/components-overview#composite-components) encompassing components such as [Call Logs](/docs/ui-kit/angular/call-logs) and [Call Log Details](/docs/ui-kit/angular/call-log-details). Both of these component contributes to the functionality and structure of the overall `CallLogsWithDetails` component.
...
| --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Call Logs](/docs/ui-kit/angular/call-logs)               | The `Call Logs` component is designed to show the list of Call Log available . By default, names are shown for all listed users, along with their avatar if available.                                                                                                |
| [Call Log Details](/docs/ui-kit/angular/call-log-details) | The `Call Log Details` component is designed to displays all the information related to a call. This component displays information like user/group information, participants of the call, recordings of the call (if available) & history of all the previous calls. |
...
* [onInfoClick](/docs/ui-kit/angular/call-logs#2-oninfoclick) : By overriding the `onInfoClick` of the Call Logs Component, CallLogsWithDetails achieves navigation from [Call Logs](/docs/ui-kit/angular/call-logs) to [Call Log Details](/docs/ui-kit/angular/call-log-details) component.
...
While the CallLogsWithDetails component does not have filters, its components do, For more detail on individual filters of its component refer to [Call Logs](/docs/ui-kit/angular/call-logs) and [Call Log Details](/docs/ui-kit/angular/call-log-details).
...
You can also customize its component styles. For more details on individual component styles, you can refer [Call Logs Styles](/docs/ui-kit/angular/call-logs#1-calllogs-style) and [Call Log Details Styles](/docs/ui-kit/angular/call-log-details#1-calllogdetails-style).
...
You can find the list of all Functionality customization of individual components in [Call Logs](/docs/ui-kit/angular/call-logs#functionality)and [Call Log Details Styles](/docs/ui-kit/angular/call-log-details#functionality).
...
To find all the details on individual Component advance customization you can refer, [Call Logs Advance](/docs/ui-kit/angular/call-logs#advanced) and [Call Log Details Advance](/docs/ui-kit/angular/call-log-details#advanced).
...
1. CallLogsWithDetails utilizes the [onInfoClick](/docs/ui-kit/angular/call-logs#2-oninfoclick) property of the `Call Logs` subcomponent to navigate the Call Log Details from [Call Logs](/docs/ui-kit/angular/call-logs) to [Call Log Details](/docs/ui-kit/angular/call-log-details).

<Frame>
  <img src="/images/5fa17400-call_logs_with_details_advance_onInfoClick_web_screens-eb538dc72e4cab0343d776638698f87d.png" />
</Frame>

2. CallLogsWithDetails utilizes the [onBack](/docs/ui-kit/angular/call-log-details#1-onbackclick) action of the `Call Log Details` subcomponent to close the [Call Log Details](/docs/ui-kit/angular/call-log-details) Component
...
All exposed properties of `CallLogsConfiguration` can be found under [Call Logs](/docs/ui-kit/angular/call-logs). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
...
All exposed properties of `CallLogDetailsConfiguration` can be found under [Call Log Details](/docs/ui-kit/angular/call-log-details#functionality). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
