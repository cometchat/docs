...
MessageComposer is a [Component](/docs/ui-kit/angular/components-overview#components) that enables users to write and send a variety of messages, including text, image, video, and custom messages.
...
MessageComposer is comprised of the following [Base Components](/docs/ui-kit/angular/components-overview#base-components):

| Base Components                                    | Description                                                                                                            |
| -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| [MessageInput](/docs/ui-kit/angular/message-input) | This provides a basic layout for the contents of this component, such as the TextField and buttons                     |
| [ActionSheet](/docs/ui-kit/angular/action-sheet)   | The ActionSheet component presents a list of options in either a list or grid mode, depending on the user's preference |
...
To customize the styles of the MediaRecorder component within the MessageComposer Component, use the `mediaRecorderStyle` property. For more details, please refer to [MediaRecorder](/docs/ui-kit/angular/media-recorder) styles.
...
From the MessageComposer, you can navigate to the [UserMemberWrapper](/docs/ui-kit/angular/user-member-wrapper) component as shown in the image.

<Frame>
  <img src="/images/edb6d7e4-user_member_wrapper_overview_web_screens-b909422509fa288a52a46a2712a45763.png" />
</Frame>

If you wish to modify the properties of the [UserMemberWrapper](/docs/ui-kit/angular/user-member-wrapper) Component, you can use the `UserMemberWrapperConfiguration` object.
...
The `UserMemberWrapperConfiguration` indeed provides access to all the [Action](/docs/ui-kit/angular/user-member-wrapper#actions), [Filters](/docs/ui-kit/angular/message-information#filters), [Styles](/docs/ui-kit/angular/user-member-wrapper#style), [Functionality](/docs/ui-kit/angular/user-member-wrapper#functionality), and [Advanced](/docs/ui-kit/angular/user-member-wrapper#advanced) properties of the [UserMemberWrapper](/docs/ui-kit/angular/user-member-wrapper) component.
...
In the above example, we are styling a few properties of the [UserMemberWrapper](/docs/ui-kit/angular/user-member-wrapper) component using `UserMemberWrapperConfiguration`.
