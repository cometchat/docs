...
`CometChatCallLogs` is a [Component](/docs/ui-kit/angular/components-overview#components) that shows the list of Call Log available . By default, names are shown for all listed users, along with their avatar if available.
...
| [cometchat-backdrop](/docs/ui-kit/angular/backdrop) | This element represents the background against which other elements are presented.                                          |
...
| [cometchat-date](/docs/ui-kit/angular/date)         | This Component used to show the date and time. You can also customize the appearance of this widget by modifying its logic. |
...
If you want to apply customized styles to the `Avatar` component within the `Call Logs` Component, you can use the following code snippet. For more information you can refer [Avatar Styles](/docs/ui-kit/angular/avatar#avatar-style).
...
If you want to apply customized styles to the `List Item` component within the `Call Logs` Component, you can use the following code snippet. For more information, you can refer [ListItem Styles](/docs/ui-kit/angular/list-item#listitemstyle).
...
All exposed properties of `OutgoingCallConfiguration` can be found under [OutGoing Call](/docs/ui-kit/angular/outgoing-call#functionality). Properties marked with the 🛑 symbol are not accessible within the Configuration Object.
