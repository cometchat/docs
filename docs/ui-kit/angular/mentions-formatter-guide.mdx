...
Below is an example demonstrating how to use the `CometChatMentionsFormatter` class in components such as [CometChatConversations](/docs/ui-kit/angular/conversations), [CometChatMessageList](/docs/ui-kit/angular/message-list), [CometChatMessageComposer](/docs/ui-kit/angular/message-composer).
