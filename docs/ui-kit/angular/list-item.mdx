...
| avatarStyle          | [avatarStyle](/docs/ui-kit/angular/avatar#avatar-style)       | Styling properties and values of the avatar element                 |
| statusIndicatorStyle | [statusIndicatorStyle](/docs/ui-kit/angular/status-indicator) | Styling properties and values of the status indicator element       |
| listItemStyle        | [ListItemStyle](/docs/ui-kit/angular/list-item#listitemstyle) | Styling properties and values of the element                        |
