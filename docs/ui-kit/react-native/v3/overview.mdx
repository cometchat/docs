...
V4 UI kits offer modular design, extended functionality & customization for a tailored chat experience. Check out our new UIKits [here](/docs/ui-kit/react-native/overview).
...
[React Native Chat UI Kit](https://github.com/cometchat-pro/ui-kit/react-native/archive/v3.zip)

[View on Github](https://github.com/cometchat-pro/ui-kit/react-native/tree/v3)
...
[React Native Sample App](https://github.com/cometchat-pro/react-native-chat-app/archive/v3.zip)

[View on Github](https://github.com/cometchat-pro/react-native-chat-app/tree/v3)
...
Please follow the steps provided in the [Key Concepts](/docs/ui-kit/react-native/v3/key-concepts) to create V3 apps before you proceed.
