...
| chatListMode = "USERS\_AND\_ GROUPS" | Show user, group, or both chats Values could be "USERS", "GROUPS", "USERS\_AND\_GROUPS" |
...
| callNotifications = true   | Show action message for calls Value can be *true* or *false* |
...
| hideDeletedMessages = false     | Enable hiding deleted messages Value could be *true* or *false*                                            |
