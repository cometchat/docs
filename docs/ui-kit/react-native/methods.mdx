...
`CometChatUIKit` is a class that contains all necessary methods to help initialize the [CometChat SDK](/docs/sdk/react-native/overview) with valid credentials for the ui kit to utilize.
