...
The Auth Key is an optional property of the `UIKitSettings` Class. It is intended for use primarily during proof-of-concept (POC) development or in the early stages of application development. You can use the [Auth Token](/docs/ui-kit/react-native/v4/methods#how-to-login-a-user-with-auth-token) method to log in securely.
...
This straightforward authentication method is ideal for proof-of-concept (POC) development or during the early stages of application development. For production environments, however, we strongly recommend using an [Auth Token](/docs/ui-kit/react-native/v4/methods#how-to-login-a-user-with-auth-token) instead of an Auth Key to ensure enhanced security.
...
Make sure you add a [Privacy Manifest File](/docs/ui-kit/react-native/v4/apple-privacy-manifest-guide) to your app before going live
