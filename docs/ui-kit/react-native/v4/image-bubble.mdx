...
`CometChatImageBubble` is the content view for a [MediaMessage](/docs/sdk/react-native/send-message#media-message) if the media sent is an image.
...
| **style**            | [ImageBubbleStyle](/docs/ui-kit/react-native/v4/image-bubble#imagebubblestyle) | used to customize appearance of this widget                                         |
