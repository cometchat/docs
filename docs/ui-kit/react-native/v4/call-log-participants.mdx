...
| [cometchat-date](/docs/ui-kit/react-native/v4/date)         | This Component used to show the date and time. You can also customize the appearance of this widget by modifying its logic. |
...
If you want to apply customized styles to the `ListItemStyle` component within the `CallParticipants` Component, you can use the following code snippet. For more information, you can refer [ListItem Styles](/docs/ui-kit/react-native/v4/list-item#listitemstyle).
...
If you want to apply customized styles to the `Avatar` component within the `CallParticipants` Component, you can use the following code snippet. For more information you can refer [Avatar Styles](/docs/ui-kit/react-native/v4/avatar#avatarstyleinterface).
