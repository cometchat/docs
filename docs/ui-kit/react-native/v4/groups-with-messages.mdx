...
The GroupsWithMessages is a [Composite Component](/docs/ui-kit/react-native/v4/components-overview#composite-components) encompassing components such as [Groups](/docs/ui-kit/react-native/v4/groups) and [Messages](/docs/ui-kit/react-native/v4/messages). Both of these component contributes to the functionality and structure of the overall GroupsWithMessages component.
...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [Groups](/docs/ui-kit/react-native/v4/groups)     | The `Groups` component is designed to display a list of `Groups`. This essentially represents the recent conversation history.  |
...
The child components - [Groups](/docs/ui-kit/react-native/v4/groups) and [Messages](/docs/ui-kit/react-native/v4/messages) - both have their own set of actions. The Actions of these components can be overridden through the use of the [Configurations](/docs/ui-kit/react-native/v4/groups-with-messages#configurations) object. Here is an example code snippet.
...
* [onItemPress](/docs/ui-kit/react-native/v4/groups#2-onitempress) : By overriding the OnItemClick of the [Groups](/docs/ui-kit/react-native/v4/groups) Component, GroupsWithMessages achieves navigation from [Groups](/docs/ui-kit/react-native/v4/groups) to [Messages](/docs/ui-kit/react-native/v4/messages) component.
...
While the GroupsWithMessages component does not have filters, its components do, For more detail on individual filters of its component refer to [Groups Filters](/docs/ui-kit/react-native/v4/groups#filters) and [Messages Filters](/docs/ui-kit/react-native/v4/messages#filters).

By utilizing the [Configurations](/docs/ui-kit/react-native/v4/groups-with-messages#configurations) object of its components, you can apply filters.
...
GroupsWithMessages does not have a style property but you can customize its sub-component styles. For more details on individual component styles, you can refer [Groups Styles](/docs/ui-kit/react-native/v4/groups#style) and [Messages Styles](/docs/ui-kit/react-native/v4/messages#style).
...
you can utilize the group method with a [Group](/docs/ui-kit/react-native/v4/groups) object as input to the GroupsWithMessages component. This will automatically direct you to the [Messages](/docs/ui-kit/react-native/v4/messages) component for the specified Group.
...
You can find the list of all Functionality customization of individual components in [Groups](/docs/ui-kit/react-native/v4/groups#functionality) and [Messages](/docs/ui-kit/react-native/v4/messages#functionality).
...
To find all the details on individual Component advance customization you can refer, [Groups Advance](/docs/ui-kit/react-native/v4/groups#advanced) and [Messages Advance](/docs/ui-kit/react-native/v4/messages#advanced).

GroupsWithMessages uses advanced-level customization of both Groups & Messages components to achieve its default behavior.

1. GroupsWithMessages utilizes the [onItemPress](/docs/ui-kit/react-native/v4/groups#2-onitempress) property of the `Groups` subcomponent to navigate the group from [Groups](/docs/ui-kit/react-native/v4/groups) to [Messages](/docs/ui-kit/react-native/v4/messages)
...
2. GroupsWithMessages utilizes the [AppBarOptions](/docs/ui-kit/react-native/v4/messages#auxilaryappbaroptions) of the `Messages` subcomponent to navigate from [Messages](/docs/ui-kit/react-native/v4/messages) to [Details](/docs/ui-kit/react-native/v4/group-details)
...
All exposed properties of `GroupsConfiguration` can be found under [Groups](/docs/ui-kit/react-native/v4/groups#functionality). 🛑 symbol are not accessible within the Configuration Object.
...
All exposed properties of `MessagesConfiguration` can be found under [Messages](/docs/ui-kit/react-native/v4/messages#functionality). 🛑 symbol are not accessible within the Configuration Object.
...
All exposed properties of `CreateGroupConfiguration` can be found under [Create Group](/docs/ui-kit/react-native/v4/create-group#functionality). 🛑 symbol are not accessible within the Configuration Object.
