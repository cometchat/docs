...
Below is an example demonstrating how to use the `CometChatMentionsFormatter` class in components such as [CometChatConversations](/docs/ui-kit/react-native/v4/conversations), [CometChatMessageList](/docs/ui-kit/react-native/v4/message-list), [CometChatMessageComposer](/docs/ui-kit/react-native/v4/message-composer).
