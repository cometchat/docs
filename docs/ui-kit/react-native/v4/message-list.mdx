...
`MessageList` is a [Composite Component](/docs/ui-kit/react-native/v4/components-overview#composite-components) that displays a list of messages and effectively manages real-time operations. It includes various types of messages such as Text Messages, Media Messages, Stickers, and more.

`MessageList` is primarily a list of the base component [MessageBubble](/docs/ui-kit/react-native/v4/message-bubble). The MessageBubble Component is utilized to create different types of chat bubbles depending on the message type.
...
To apply customized styles to the `Avatar` component in the `Conversations` Component, you can use the following code snippet. For further insights on `Avatar` Styles [refer](/docs/ui-kit/react-native/v4/avatar)
...
[CometChatMessageTemplate](/docs/ui-kit/react-native/v4/message-template) is a pre-defined structure for creating message views that can be used as a starting point or blueprint for creating message views often known as message bubbles. For more information, you can refer to [CometChatMessageTemplate](/docs/ui-kit/react-native/v4/message-template).
...
From the MessageList, you can navigate to the [MesssageInformation](/docs/ui-kit/react-native/v4/message-information) component as shown in the image.
...
If you wish to modify the properties of the [MesssageInformation](/docs/ui-kit/react-native/v4/message-information) Component, you can use the `MessageInformationConfiguration` object.
...
The `MessageInformationConfiguration` indeed provides access to all the [Action](/docs/ui-kit/react-native/v4/message-information#style), [Filters](/docs/ui-kit/react-native/v4/message-information#filters), [Styles](#style), [Functionality](/docs/ui-kit/react-native/v4/message-information#functionality), and [Advanced](/docs/ui-kit/react-native/v4/message-information#advanced) properties of the [MesssageInformation](/docs/ui-kit/react-native/v4/message-information) component.
...
In the above example, we are styling a few properties of the [MesssageInformation](/docs/ui-kit/react-native/v4/message-information) component using `MessageInformationConfiguration`.

### QuickReactions

From the MessageList, you can navigate to the [QuickReactions](/docs/ui-kit/react-native/v4/quick-reactions) component as shown in the image.

If you wish to modify the properties of the [QuickReactions](/docs/ui-kit/react-native/v4/quick-reactions) Component, you can use the [QuickReactionConfiguration](/docs/ui-kit/react-native/v4/quick-reactions#functionality) object.
