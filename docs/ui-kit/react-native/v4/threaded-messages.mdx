...
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [MessageList](/docs/ui-kit/react-native/v4/message-list)         | CometChatMessageList is a component that displays a list of Messages                                               |
| [MessageComposer](/docs/ui-kit/react-native/v4/message-composer) | CometChatMessageComposer is a component that helps in writing and editing of messages and also sending attachments |
...
ThreadedMessages does not have its own actions. However, you can override the behavior of the ThreadedMessages component by using the actions of its Components, with the help of [Configurations](/docs/ui-kit/react-native/v4/components-overview#configurations).
...
If you want to customize the properties of the [MessageList](/docs/ui-kit/react-native/v4/message-list) Component inside ThreadedMessages Component, you need use the `MessageListConfiguration` object.
...
The `MessageListConfiguration` provides access to all the [Action](/docs/ui-kit/react-native/v4/message-list#actions), [Filters](/docs/ui-kit/react-native/v4/message-list#filters), [Styles](/docs/ui-kit/react-native/v4/message-list#style), [Functionality](/docs/ui-kit/react-native/v4/message-list#functionality), and [Advanced](/docs/ui-kit/react-native/v4/message-list#advanced) properties of the [MessageList](/docs/ui-kit/react-native/v4/message-list) component.
...
In this example, we will be changing the list alignment and modifying the message list styles in the [MessageList](/docs/ui-kit/react-native/v4/message-list) component using `MessageListConfiguration`.
...
If you want to customize the properties of the [MessageComposer](/docs/ui-kit/react-native/v4/message-composer) Component inside ThreadedMessages Component, you need use the `MessageComposerConfiguration` object.
...
In this example, we'll be adding a custom header view and customizing some properties of the [MessageComposer](/docs/ui-kit/react-native/v4/message-composer) component using `MessageComposerConfiguration`.
