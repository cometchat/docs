...
MessageComposer is a [Component](/docs/ui-kit/react-native/v4/components-overview#components) that enables users to write and send a variety of messages, including text, image, video, and custom messages.
...
MessageComposer is comprised of the following [Base Components](/docs/ui-kit/react-native/v4/components-overview#base-components):
...
To customize the styles of the MediaRecorder component within the MessageComposer Component, use the `mediaRecorderStyle` property. For more details, please refer to [MediaRecorder](/docs/ui-kit/react-native/v4/media-recorder) styles.
