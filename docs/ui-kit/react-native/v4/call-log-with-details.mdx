...
The `CometChatCallLogsWithDetails` is a [Composite Component](/docs/ui-kit/react-native/v4/components-overview#composite-components) encompassing components such as [Call Logs](/docs/ui-kit/react-native/v4/call-logs) and [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details). Both of these component contributes to the functionality and structure of the overall `CallLogsWithDetails` component.
...
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Call Logs](/docs/ui-kit/react-native/v4/call-logs)               | The `Call Logs` component is designed to show the list of Call Log available . By default, names are shown for all listed users, along with their avatar if available.                                                                                                |
| [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details) | The `Call Log Details` component is designed to displays all the information related to a call. This component displays information like user/group information, participants of the call, recordings of the call (if available) & history of all the previous calls. |
...
* [onInfoIconPress](/docs/ui-kit/react-native/v4/call-logs#2-oninfoiconpress) : By overriding the `onInfoIconPress` of the Call Logs Component, CallLogsWithDetails achieves navigation from [Call Logs](/docs/ui-kit/react-native/v4/call-logs) to [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details) component.
...
While the CallLogsWithDetails component does not have filters, its components do, For more detail on individual filters of its component refer to [Call Logs](/docs/ui-kit/react-native/v4/call-logs) and [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details).
...
You can customize its sub-component styles. For more details on individual component styles, you can refer [Call Logs Styles](/docs/ui-kit/react-native/v4/call-logs#1-calllogs-style) and [Call Log Details Styles](/docs/ui-kit/react-native/v4/call-log-details#1-calllogdetails-style).
...
You can find the list of all Functionality customization of individual components in [Call Logs](/docs/ui-kit/react-native/v4/call-logs#functionality)and [Call Log Details Styles](/docs/ui-kit/react-native/v4/call-log-details#functionality).
...
To find all the details on individual Component advance customization you can refer, [Call Logs Advance](/docs/ui-kit/react-native/v4/call-logs#advanced) and [Call Log Details Advance](/docs/ui-kit/react-native/v4/call-log-details#advanced).
...
1. CallLogsWithDetails utilizes the [onInfoIconPress](/docs/ui-kit/react-native/v4/call-logs#2-oninfoiconpress) property of the `Call Logs` subcomponent to navigate the Call Log Details from [Call Logs](/docs/ui-kit/react-native/v4/call-logs) to [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details).
...
2. CallLogsWithDetails utilizes the [onBack](/docs/ui-kit/react-native/v4/call-log-details#1-onback) action of the `Call Log Details` subcomponent to close the [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details) Component
...
All exposed properties of `CallLogsConfiguration` can be found under [Call Logs](/docs/ui-kit/react-native/v4/call-logs). 🛑 symbol are not accessible within the Configuration Object.
...
All exposed properties of `CallLogDetailsConfiguration` can be found under [Call Log Details](/docs/ui-kit/react-native/v4/call-log-details#functionality). 🛑 symbol are not accessible within the Configuration Object.
