...
`CometChatAudioBubble` is the content view for a [MediaMessage](/docs/sdk/react-native/send-message#media-message) if the media sent is an audio.
...
| **style**     | [AudioBubbleStyle](/docs/ui-kit/react-native/v4/audio-bubble#audiobubblestyle) | used to customize appearance of this widget        |
