...
`CometChatTextBubble` is the content view shown for [TextMessage](/docs/sdk/react-native/send-message#text-message).
...
| **style**  | [TextBubbleStyle](/docs/ui-kit/react-native/v4/text-bubble#textbubblestyle) | used to customize appearance of this widget |
