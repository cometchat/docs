...
MessageComposer is a [Component](/docs/ui-kit/react-native/01-components-overview.md#components) that enables users to write and send a variety of messages, including text, image, video, and custom messages.
