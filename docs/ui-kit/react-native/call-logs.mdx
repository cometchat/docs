...
`CometChatCallLogs` is a [Component](/docs/ui-kit/react-native/01-components-overview.md#components) that shows the list of Call Logs available. By default, names are shown for all listed users, along with their avatars if available.
