...
`CometChatThreadHeader` is a [Component](/docs/ui-kit/react-native/01-components-overview.md#components) that displays the parent message & number of replies of thread.
