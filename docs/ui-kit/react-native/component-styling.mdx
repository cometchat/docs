...
The `CometChatActionSheet` component is a customizable action sheet designed to display a list of actionable options. Often integrated with the [CometChatBottomSheet](/docs/ui-kit/react-native/component-styling#bottom-sheet), it provides a structured and interactive menu for user actions.
