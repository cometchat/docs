...
Below is an example demonstrating how to use the `CometChatMentionsFormatter` class in components such as [CometChatConversations](/docs/ui-kit/react-native/conversations), [CometChatMessageList](/docs/ui-kit/react-native/message-list), [CometChatMessageComposer](/docs/ui-kit/react-native/message-composer).
