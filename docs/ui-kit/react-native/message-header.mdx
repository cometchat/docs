...
`MessageHeader` is a [Component](/docs/ui-kit/react-native/components-overview#components) that showcases the [User](/docs/sdk/react-native/users-overview) or [Group](/docs/sdk/react-native/groups-overview) details in the toolbar. Furthermore, it also presents a typing indicator and a back navigation button for ease of use.
