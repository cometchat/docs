...
Go through the [overview](/docs/widget/overview) to set up Chat Widget from the CometChat Dashboard

### Installation

1. [Download the CometChat Pro](https://kernl.us/api/v1/archive/67d80a538f0fe21642f4fedf) plugin
