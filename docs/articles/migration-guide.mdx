...
2. [Make any required platform-specific code changes](/docs/articles/migration-guide#migrating-your-platform)
3. [Make the API changes](/docs/articles/migration-guide#rest-api-changes-) (Applicable if you are using CometChat Rest APIs)
...
JavaScript: [Upgrading from v2](/docs/sdk/javascript/3.0/resources-upgrading-from-v2)

iOS: [Upgrading from v2](/docs/sdk/ios/upgrading-from-v2)

Android: [Upgrading from v3](/docs/sdk/android/upgrading-from-v3-guide)

React Native: [Upgrading from v2](/docs/sdk/react-native/3.0/resources-upgrading-from-v2)

Ionic Cordova Capacitor: [Upgrading from v2](/docs/sdk/ionic/3.0/resources-upgrading-from-v2)
...
2. What exactly do I need to do, what are the steps?
   ...
   * Please refer the [Migration Guide](/docs/articles/migration-guide)
