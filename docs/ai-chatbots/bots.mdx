...
AI Bots in CometChat are designed to facilitate conversations with users. Each AI Bot is associated with a specific [AI Instruction](/docs/ai/instructions).
...
1. Configure the AI settings through the CometChat dashboard as detailed in the [Overview section](/docs/ai-chatbots/overview).
