...
| contentView    | view                                                                                                                                                        | Custom component to customize the content section for each message bubble. By default, it displays the [Text bubble](/docs/web-elements/text-bubble), [Image bubble](/docs/web-elements/image-bubble), [File bubble](/docs/web-elements/file-bubble), [Audio bubble](/docs/web-elements/audio-bubble), and [Video bubble](/docs/web-elements/video-bubble) based on the type of the message. |
