...
CometChatDetailsOption is a pre-defined structure for creating option within a [DetailsTemplate](/docs/web-shared/detailstemplate) in the `CometChatDetails` component.
