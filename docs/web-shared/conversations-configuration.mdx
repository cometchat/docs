...
| statusIndicatorStyle          | Styling properties and values of the [StatusIndicator](/docs/web-elements/status-indicator) component                    |
| badgeStyle                    | Styling properties and values of the [Badge](/docs/web-elements/badge) component                                         |
| receiptStyle                  | Styling properties and values of the [Receipt](/docs/web-elements/receipt) component                                     |
| listItemStyle                 | Styling properties and values of the [ListItem](/docs/web-elements/list-item) component                                  |
| deleteConversationDialogStyle | Styling properties and values of the [ConfirmDialog](/docs/web-elements/confirm-dialog) component                        |
| backdropStyle                 | Styling properties and values of the [Backdrop](/docs/web-elements/backdrop) component                                   |
