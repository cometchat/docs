...
While this extension gives you all the details required for generating a preview, our [Rich Media Preview](/docs/fundamentals/rich-media-preview) gives you a decorated iframe with the styling.
