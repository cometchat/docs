...
1. Configure the AI settings through the CometChat dashboard as detailed in the [Overview section](/docs/fundamentals/ai-user-copilot/overview).
...
3. Implement the chat functionality in your applications using [CometChat's **v4** Chat SDKs](/docs/sdk/javascript/overview).
