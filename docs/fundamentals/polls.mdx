...
Polls are custom messages. So, you have to implement our `onCustomMessageReceived` listener in order to receive the Poll-related message. Please refer to our [Receive Messages](/docs/sdk/javascript/receive-message) documentation under the SDK of your choice.
