...
For showing a list of users in a group, you can refer to our [Retrieve Group Members](/docs/sdk/javascript/retrieve-group-members) documentation under the SDK of your choice.
