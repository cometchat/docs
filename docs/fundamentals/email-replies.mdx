...
To start using Email Notifications with Replies, you need to first enable and save the settings for Email Notifications extension. [Learn more](/docs/fundamentals/email-notifications).
