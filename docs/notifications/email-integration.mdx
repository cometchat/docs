...
Have a look at the available [preferences](/docs/notifications/preferences-templates-sounds#email-notification-preferences) and [templates](/docs/notifications/preferences-templates-sounds#email-notification-templates) for email notifications.
