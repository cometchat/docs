...
If you want to use the System's native call service to handle calls, please refer to our guide on [Android - Connection Service](/docs/notifications/android-connection-service)
