...
* If you want to use the callkit and connection service in foreground then you might consider turning the callNotifications settings in UI kit settings. For more information in UI kit settings check the [documentation](/docs/ui-kit/react-native/getting-started#initialise-cometchatuikit).
...
Kindly follow the instruction for setting Firebase Cloud Messaging explained [here](/docs/notifications/react-native-push-notifications)
