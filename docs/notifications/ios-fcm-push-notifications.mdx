...
You can refer to [our setup](/docs/notifications/ios-apns-push-notifications) using the Apple Push Notifications service (APNs).
...
1. [Increment App Icon Badge Count](/docs/sdk/ios/increment-app-icon-badge-count)
2. [Launch chat window on tap of push notification](/docs/sdk/ios/launch-chat-window-on-tap-of-push-notification)
