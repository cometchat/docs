...
Have a look at the available [preferences](/docs/notifications/preferences-templates-sounds#sms-notification-preferences) and [templates](/docs/notifications/preferences-templates-sounds#sms-notification-templates) for SMS notifications.
