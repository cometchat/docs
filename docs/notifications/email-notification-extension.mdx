...
1. Integration using [Webhook](/docs/notifications/email-notifications#integration-using-webhook)
2. Integration using [SendGrid](/docs/notifications/email-integration#sendgrid)
