...
{/* <div style={{
  ...
  <div style={{
    ...
    height: '2rem',
    borderRadius: '50%',
    background: 'linear-gradient(135deg, #6851D6 60%, #A18FFF 100%)',
    color: 'white',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    fontWeight: 700,
    fontSize: '1.05rem',
    boxShadow: '0 2px 8px 0 rgba(104,81,214,0.10), 0 1.5px 4px 0 rgba(0,0,0,0.04)'
  }}>1</div>
  <span style={{
    fontSize: '1rem',
    color: '#222',
    ...
    boxShadow: '0 1px 4px 0 rgba(104,81,214,0.04)'
  }}>
    Create Account on <a href="https://app.cometchat.com/" target="_blank" style={{
      color: '#6851D6',
      textDecoration: 'underline',
      transition: 'color 0.2s'
    }}>CometChat Dashboard</a>
  </span>
  <div style={{
    height: '2px',
    width: '1.7rem',
    background: 'linear-gradient(90deg, #A18FFF 0%, #6851D6 100%)',
    borderRadius: '1px'
  }}></div>
  <div style={{
    width: '2rem',
  ...
  <span style={{
    ...
    Create app &amp; note App ID, Region, Auth Key
  </span>
</div> */}

<Columns cols={2}>
  <Card title="Create Account" href="https://app.cometchat.com/">
    Create Account on CometChat Dashboard
  </Card>
  <Card title="Get Credentials" href="https://app.cometchat.com/">
    Create app &amp; note App ID, Region, Auth Key
  </Card>
</Columns>
...
<Columns cols={2}>
  <Card title="1:1 Messaging">
    - Send and receive messages between two test users.  
    - Confirm delivery & read states render correctly.
  </Card>
  ...
  <Card title="Live Signals">
    - Typing indicators appear when the other user is composing.  
    - Read receipts update after the message is viewed.  
    - Presence shows **Online / Offline** transitions.
  </Card>

  <Card title="Resilience & Reconnect">
    - Refresh the browser; session should recover gracefully.  
    - Briefly toggle network offline/online; messages should sync.  
    - Validate error toasts/logging for failed sends.
  </Card>
</Columns>

<Callout type="success" emoji="✅" className="mt-6">
  All checks green? You’re ready to move to staging or production.
</Callout>
