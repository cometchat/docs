...
{/* Quick Integration Steps (replaces the old 2-card block) */}
<div className="mb-10">
  <div className="mb-4">
  ...
  <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-2 mb-2">
        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 text-white text-sm font-semibold">1</span>
        <div className="font-semibold text-gray-800 dark:text-gray-100">Create Account</div>
      </div>
      <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Sign up and access the CometChat Dashboard.</p>
      <a href="https://app.cometchat.com/" className="text-blue-600 dark:text-blue-400 text-sm underline">Open Dashboard</a>
    </div>

    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-2 mb-2">
        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 text-white text-sm font-semibold">2</span>
        <div className="font-semibold text-gray-800 dark:text-gray-100">Create App</div>
      </div>
      <p className="text-sm text-gray-600 dark:text-gray-300">Create an app and note App ID, Region, and Auth Key.</p>
    </div>

    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-2 mb-2">
        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 text-white text-sm font-semibold">3</span>
        <div className="font-semibold text-gray-800 dark:text-gray-100">Choose Integration</div>
      </div>
      <p className="text-sm text-gray-600 dark:text-gray-300">Pick Chat Builder, UI Kits, SDKs, or Widgets.</p>
    </div>

    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-2 mb-2">
        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 text-white text-sm font-semibold">4</span>
        <div className="font-semibold text-gray-800 dark:text-gray-100">Sync Users</div>
      </div>
      <p className="text-sm text-gray-600 dark:text-gray-300">Add users via Dashboard, SDK, or REST API.</p>
    </div>

    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-2 mb-2">
        <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-600 text-white text-sm font-semibold">5</span>
        <div className="font-semibold text-gray-800 dark:text-gray-100">Verify & Launch</div>
      </div>
      <p className="text-sm text-gray-600 dark:text-gray-300">Test 1:1, group, typing, presence, and reconnection.</p>
    </div>
  </div>
</div>
