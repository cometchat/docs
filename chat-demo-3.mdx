...
<div className="mb-12">
  ...
  <Columns cols={2} className="mt-8">
      <div>
        <h3 className="text-lg font-medium mb-1 text-gray-900/90 dark:text-white/90">
  <span className="text-[#6851D6]">How It Works</span>
</h3>
<div className="h-px w-14 bg-[#6851D6] rounded-full mb-3 opacity-60"></div>
        <Steps>
      ...
      <div>
        <h3 className="text-lg font-medium mb-1 text-gray-900/90 dark:text-white/90">
  <span className="text-[#6851D6]">Why It's Great</span>
</h3>
<div className="h-px w-14 bg-[#6851D6] rounded-full mb-3 opacity-60"></div>
        <Steps>
