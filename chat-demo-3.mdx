...
<Cards>
  <Card title="Dashboard (No Code)" href="https://app.cometchat.com/">
...
<Callout type="info" emoji="💡">
  Use the same **UID** in CometChat as in your app to keep authentication simple.
</Callout>
...
<Callout type="success" emoji="✅">
  Log in as two test users and confirm:
</Callout>

- 1:1 messages send, receive, and display correctly.  
- Group chat messages are visible to all members.  
- Typing indicators, read receipts, and presence update as expected.  
- Users reconnect seamlessly after refresh or network loss.  
