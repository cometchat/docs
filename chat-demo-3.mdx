...
<div className="mb-12">
  ...
  <span className="bg-gradient-to-r from-[#6851D6] to-[#A18FFF] bg-clip-text text-transparent">How It Works</span>
</h3>
<div className="h-0.5 w-16 bg-gradient-to-r from-[#A18FFF] to-[#6851D6] rounded-full mb-4"></div>
        <Steps>
  ...
  <span className="bg-gradient-to-r from-[#6851D6] to-[#A18FFF] bg-clip-text text-transparent">Why It's Great</span>
</h3>
<div className="h-0.5 w-16 bg-gradient-to-r from-[#A18FFF] to-[#6851D6] rounded-full mb-4"></div>
        <Steps>
