...
<div className="mb-12">
    ...
    <CardGroup cols={3}>
      <Card title="Push Overview" href="/notifications/push-overview" horizontal />
      <Card title="Preferences" href="/notifications/preferences" horizontal />
      <Card title="Templates & Sounds" href="/notifications/templates-and-sounds" horizontal />
    </CardGroup>
