...
<div className="mb-12">
  ...
  <CardGroup cols={4}>
    ...
    />
    <Card
      title="Push Notification Sample App (iOS)"
      href="https://github.com/cometchat/cometchat-uikit-ios/tree/v5/SampleAppPushNotificationAPNs"
      cta="View on GitHub"
      horizontal
    />

    <Card
      title="Push Notification Sample App (Flutter)"
