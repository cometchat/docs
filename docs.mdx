...
<div className="flex flex-col w-full " style={{ marginTop: '2rem', marginBottom: '0.5rem' }}>
  ...
  >
  Synchronize users, generate tokens, and manage access seamlessly.
  </h3>
  ...
  >
  Use our APIs to connect CometChat with your app and programmatically manage users, groups, and conversations.
</p>
...
<Card
  ...
  icon="globe"
  iconType="solid" 
  href="/reference/management-apis" 
  cta="Learn more">
...
<Card
  ...
  arrow="false"
  cta="Book your slot">
  Explore comprehensive documentation for all our SDKs, UI Kits, APIs, and integration guides, everything you need to build with CometChat.
</Card>
