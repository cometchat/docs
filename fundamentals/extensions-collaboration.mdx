...
{/* <CardGroup cols={2}>
  <Card title="Collaborative Document" icon="file-lines" href="#collaborative-document">
    Co-edit documents in real-time
  </Card>
  <Card title="Collaborative Whiteboard" icon="chalkboard" href="#collaborative-whiteboard">
...
<Note>
**Available via:** [UI Kit Builder](/chat-builder/react/overview) ✅ | [Widget Builder](/widget/html/overview) ✅ | [UI Kits](/ui-kit/react/extensions#collaborative-document) ✅ | [SDK](/sdk/javascript/overview) ✅
</Note>

<Note>
**SDK Implementation:** [JavaScript](/sdk/javascript/extensions/collaboration#collaborative-document) ✅ | [Android](/sdk/android/extensions/collaboration#collaborative-document) ✅ | [iOS](/sdk/ios/extensions/collaboration#collaborative-document) ✅ | [Flutter](/sdk/flutter/extensions/collaboration) ❌
</Note>
...
<Note>
**Available via:** [UI Kit Builder](/chat-builder/react/overview) ✅ | [Widget Builder](/widget/html/overview) ✅ | [UI Kits](/ui-kit/react/extensions#collaborative-whiteboard) ✅ | [SDK](/sdk/javascript/overview) ✅
</Note>
