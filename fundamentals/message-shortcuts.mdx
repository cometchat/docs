...
<Steps>
  ...
  <Step title="Enable Message Shortcuts">
    Go to **Extensions** and enable the **Message Shortcuts** extension.
  </Step>
...
<CardGroup cols={3}>
  <Card title="Fetch shortcuts">
    Retrieve all shortcuts on the user's device.
  </Card>
  <Card title="Manage shortcuts">
    Allow users to add, edit, or delete shortcuts.
  </Card>
  <Card title="Send faster">
    Expand shortcuts into full messages as users type.
  </Card>
</CardGroup>
