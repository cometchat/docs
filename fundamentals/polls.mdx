...
<Steps>
  ...
  <Step title="Enable Polls">
    Go to **Extensions** and enable the **Polls** extension.
  </Step>
</Steps>
...
<CardGroup cols={3}>
  <Card title="Create a poll">
    Submit a question and options to start a poll.
  </Card>
  <Card title="Vote">
    Let users cast votes on the poll options.
  </Card>
  <Card title="Fetch results">
...
<CardGroup cols={2}>
  <Card title="Question">
    The poll question users will vote on.
  </Card>
  <Card title="Options">
    An array of options to choose from.
  </Card>
  <Card title="Receiver">
    UID or GUID of the target user or group.
  </Card>
  <Card title="Receiver type">
