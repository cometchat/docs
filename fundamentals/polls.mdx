---
title: "Polls"
description: "Create CometChat polls in conversations, collect votes from users, fetch poll results, and manage poll options."
---
...
<Tab title="JavaScript">
```js
CometChat.callExtension('polls', 'GET', 'v2/results?id='+POLL_ID)
.then(results => {
	// Poll results
})
.catch(error => {
