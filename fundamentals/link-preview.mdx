...
### UI Kit Builder
- Enable it in both Dashboard and UI Kit Builder settings, then you can use the Link Preview extension in your custom chat experience.

### Widget Builder
- Enable it in both Dashboard and Widget Builder settings, then you can use the Link Preview extension in your custom chat widget.
