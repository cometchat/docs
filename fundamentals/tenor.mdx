---
title: "Tenor"
description: "Add Tenor GIFs to CometChat conversations with trending GIFs, search results, API keys, and extension calls."
---
...
CometChat.callExtension("gifs-tenor", "GET", URL)
  .then((response) => {
