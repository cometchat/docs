...
<Steps>
  ...
  <Step title="Enable Collaborative Whiteboard">
    Go to **Extensions** and enable the **Collaborative Whiteboard** extension.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Create a collaboration link">
    Generate a whiteboard link for the session.
  </Card>
  <Card title="Invite collaborators">
    Send the link as an invitation to receivers.
  </Card>
</CardGroup>
