...
<Steps>
  ...
  <Step title="Enable Save Message">
    Go to **Extensions** and enable the **Save Message** extension.
  </Step>
</Steps>
...
<CardGroup cols={3}>
  <Card title="Save messages">
    Allow users to save messages for later.
  </Card>
  <Card title="Unsave messages">
    Remove saved messages when no longer needed.
  </Card>
  <Card title="Fetch saved messages">
    Retrieve all saved messages for a user.
  </Card>
</CardGroup>
