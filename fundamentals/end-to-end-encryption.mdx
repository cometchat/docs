...
description: "Configure CometChat end-to-end encryption with Virgil Security keys, local message encryption, and sample app setup."
---
...
```js
CometChat.callExtension('e2ee', 'GET', '/v1/virgil-jwt')
  .then(response => {
