...
<Steps>
  ...
  <Step title="Enable Stickers">
    Go to **Extensions** and enable the **Stickers** extension.
  </Step>
...
<CardGroup cols={3}>
  <Card title="Load stickers">
    Fetch enabled sticker sets for your UI.
  </Card>
  <Card title="Send stickers">
    Send stickers as media messages.
  </Card>
  <Card title="Receive stickers">
    Render sticker messages received in chat.
  </Card>
</CardGroup>
