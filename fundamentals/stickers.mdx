---
title: "Stickers"
description: "Manage CometChat sticker sets from the dashboard, load enabled stickers, and send stickers in chat conversations."
---
...
```js
CometChat.callExtension('stickers', 'GET', 'v1/fetch')
.then(stickers => {
 	// Stickers received
})
.catch(error => {
