...
<Steps>
  ...
  <Step title="Enable Pin Message">
    Go to **Extensions** and enable the **Pin Message** extension.
  </Step>
</Steps>
...
<CardGroup cols={3}>
  <Card title="Pin messages">
    Keep important messages visible in a conversation.
  </Card>
  <Card title="Unpin messages">
    Remove pinned messages when they are no longer relevant.
  </Card>
  <Card title="Fetch pinned messages">
    Retrieve all pinned messages for a conversation.
  </Card>
</CardGroup>
