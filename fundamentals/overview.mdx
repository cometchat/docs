...
<CardGroup cols={3}>
  <Card title="No-code widget" icon="bolt" href="/widget/html/overview">
    Copy and paste a few lines of code to add text, voice, and video to your website in minutes — no frontend framework required.
  </Card>
  <Card title="UI Kits" icon="puzzle-piece" href="/ui-kit/react/overview">
  ...
  <Card title="SDKs & APIs" icon="code" href="/sdk/javascript/overview">
...
<CardGroup cols={2}>
  <Card title="Implementation Checklist" icon="list-check" href="/fundamentals/implementation-checklist">
  ...
  <Card title="Extensions" icon="puzzle-piece" href="/fundamentals/extensions-overview">
    Add polls, reactions, translation, and more to your chat.
  </Card>
  <Card title="CometChat AI" icon="robot" href="/fundamentals/ai-user-copilot/overview">
