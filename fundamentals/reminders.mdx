...
<Steps>
  ...
  <Step title="Enable Reminders">
    Go to **Extensions** and enable the **Reminders** extension.
  </Step>
...
<CardGroup cols={3}>
  <Card title="Message reminders">
    Set a reminder for a specific message.
  </Card>
  <Card title="Personal reminders">
    Set a custom reminder with your own text.
  </Card>
  <Card title="Manage reminders">
    List, edit, or delete existing reminders.
  </Card>
</CardGroup>
