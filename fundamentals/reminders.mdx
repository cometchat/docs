---
title: "Reminders"
description: "Create, list, edit, and delete CometChat reminders for messages or custom notes using the reminders bot."
---
...
<Tab title="JavaScript">
```js
CometChat.callExtension('reminders', 'GET', 'v1/fetch').then(response => {
  // reminders array
}).catch(error => {
  // Some error occured
});
