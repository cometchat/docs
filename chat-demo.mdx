...
<div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mb-8">
  ...
  <div className="space-y-2">
    <div className="flex items-center">
      ...
      <span className="text-blue-800 dark:text-blue-100">Want a ready-to-use chat interface? → <strong>UI Kits - Chat Builder</strong></span>
    </div>
    <div className="flex items-center">
      ...
      <span className="text-blue-800 dark:text-blue-100">Need custom components? → <strong>UI Kits - Components</strong></span>
    </div>
    <div className="flex items-center">
      ...
      <span className="text-blue-800 dark:text-blue-100">Building from scratch? → <strong>SDKs</strong></span>
    </div>
    <div className="flex items-center">
      ...
      <span className="text-blue-800 dark:text-blue-100">Just need a simple widget? → <strong>Chat Widget</strong></span>
    </div>
  </div>
</div>
...
<CardGroup>
<Card title="UI Kits - Chat Builder ⭐ Recommended" icon="cubes" href="#chat-builder">
  <div className="space-y-2">
    <p className="text-sm text-gray-600">Ready-to-use chat interface with built-in logic</p>
    <div className="bg-green-100 dark:bg-green-900/30 p-2 rounded text-xs">
      <strong>Perfect for:</strong> Quick launches, minimal coding, rapid prototyping
    </div>
  </div>
</Card>

<Card title="UI Kits - Components" icon="puzzle-piece" href="#ui-kits">
  <div className="space-y-2">
    <p className="text-sm text-gray-600">Individual components with built-in chat logic</p>
    <div className="bg-blue-100 dark:bg-blue-900/30 p-2 rounded text-xs">
      <strong>Perfect for:</strong> Custom designs, existing UI integration, full control
    </div>
  </div>
</Card>
...
<Card title="Chat Widget" icon="paper-plane" href="#widgets">
  <div className="space-y-2">
    <p className="text-sm text-gray-600">Simple floating widget for websites</p>
    <div className="bg-purple-100 dark:bg-purple-900/30 p-2 rounded text-xs">
      <strong>Perfect for:</strong> Customer support, community chat, no-code solutions
    </div>
  </div>
</Card>
...
<Card title="SDKs" icon="code" href="#sdks">
  <div className="space-y-2">
    <p className="text-sm text-gray-600">Complete feature set with no pre-built UI</p>
    <div className="bg-orange-100 dark:bg-orange-900/30 p-2 rounded text-xs">
      <strong>Perfect for:</strong> Complex requirements, custom UI libraries, maximum flexibility
    </div>
  </div>
</Card>
</CardGroup>
