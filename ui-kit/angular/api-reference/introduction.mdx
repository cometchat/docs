---
title: "Services API reference for the Angular UI Kit"
sidebarTitle: "Services"
description: "Reference for injectable services in the CometChat Angular UI Kit, covering SDK access, theme, localization, event bus, and framework-level services."
---
