---
title: "RichTextEditorService API Reference"
description: "Angular service providing rich text editing in the CometChat Angular UIKit — bold, italic, underline, strikethrough, and code formatting via native browser APIs with no external dependencies."
---
