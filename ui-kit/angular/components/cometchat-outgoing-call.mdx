...
- [CometChatCallButtons](/ui-kit/angular/components/cometchat-call-buttons) — Parent component that triggers the outgoing call overlay
- [CometChatOngoingCall](/ui-kit/angular/components/cometchat-outgoing-call) — Displayed after the call is accepted
- [CometChatIncomingCall](/ui-kit/angular/components/cometchat-incoming-call) — Handles incoming call notifications
