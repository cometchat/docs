...
| Selector | `<cometchat-reaction-info>` — the class name is NOT a valid tag |
| Standalone | Standalone — add `CometChatReactionInfoComponent` to the consuming component's `imports: []` or it renders **nothing**, silently |
| Key inputs | `message` · `reaction` |
| Key outputs | — |
| View slots | — |
