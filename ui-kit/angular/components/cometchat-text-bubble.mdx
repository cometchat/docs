...
| Selector | `<cometchat-text-bubble>` — the class name is NOT a valid tag |
...
| Key inputs | `message` · `alignment` · `textFormatters` · `translatedTextOverride` |
| Key outputs | `linkClick` · `mentionClick` |
| View slots | — |
