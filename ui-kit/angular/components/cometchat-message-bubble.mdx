...
| Message type | Bubble |
| --- | --- |
| `image` | [`CometChatImagesBubble`](/ui-kit/angular/components/cometchat-images-bubble) |
| `video` | [`CometChatVideosBubble`](/ui-kit/angular/components/cometchat-videos-bubble) |
| `file` | [`CometChatFilesBubble`](/ui-kit/angular/components/cometchat-files-bubble) |
| `audio` tagged as a voice note | [`CometChatVoiceNoteBubble`](/ui-kit/angular/components/cometchat-voice-note-bubble) |
| `audio` (attached file) | [`CometChatAudiosBubble`](/ui-kit/angular/components/cometchat-audios-bubble) |
...
- [CometChatImagesBubble](/ui-kit/angular/components/cometchat-images-bubble) - Renders `image` messages
- [CometChatVideosBubble](/ui-kit/angular/components/cometchat-videos-bubble) - Renders `video` messages
- [CometChatAudiosBubble](/ui-kit/angular/components/cometchat-audios-bubble) - Renders `audio` messages that are attached files
- [CometChatFilesBubble](/ui-kit/angular/components/cometchat-files-bubble) - Renders `file` messages
- [CometChatVoiceNoteBubble](/ui-kit/angular/components/cometchat-voice-note-bubble) - Renders `audio` messages tagged as voice notes
