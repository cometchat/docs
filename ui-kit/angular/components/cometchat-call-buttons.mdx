...
- [CometChatOutgoingCall](/ui-kit/angular/components/cometchat-outgoing-call) — Displayed automatically when a call is initiated
- [CometChatOngoingCall](/ui-kit/angular/components/cometchat-outgoing-call) — Displayed automatically when a call is accepted
- [CometChatMessageHeader](/ui-kit/angular/components/cometchat-message-header) — Typically hosts the call buttons
