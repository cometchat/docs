...
Routing is automatic and unconditional — see [Media Message Rendering](/ui-kit/angular/components/cometchat-message-bubble#media-message-rendering). Absence of the tag is never treated as a voice note.
</Note>
