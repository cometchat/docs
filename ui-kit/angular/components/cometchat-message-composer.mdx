...
| `hideRichTextToolbar` | `boolean` | `true` | Hide the rich text formatting toolbar. |
...
Because the toolbar is hidden by default (`hideRichTextToolbar` defaults to
`true`), set `[hideRichTextToolbar]="false"` to keep it visible:
