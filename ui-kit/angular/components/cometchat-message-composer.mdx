...
- **Grouped rendering** — the message list renders each batched message with the
  matching multi-attachment bubble — [Images](/ui-kit/angular/components/cometchat-images-bubble),
  [Videos](/ui-kit/angular/components/cometchat-videos-bubble),
  [Audios](/ui-kit/angular/components/cometchat-audios-bubble), or
  [Files](/ui-kit/angular/components/cometchat-files-bubble) — and groups messages that
...
[Voice Note Bubble](/ui-kit/angular/components/cometchat-voice-note-bubble), separately
