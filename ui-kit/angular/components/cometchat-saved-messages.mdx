...
<iframe
  src="https://storybook.cometchat.io/angular/iframe.html?id=components-messages-cometchat-saved-messages--default&viewMode=story&shortcuts=false&singleStory=true"
...
| `textFormatters` | `CometChatTextFormatter[]` | `undefined` | Formatters applied to each row's preview text. Falls back to the global config's set when unset. See [Text Formatters](/ui-kit/angular/guides/custom-text-formatter) |
