...
- [CometChatGroupMembers](/ui-kit/angular/components/cometchat-group-members) — Parent list component that renders multiple group member items
...
- [CometChatUserItem](/ui-kit/angular/components/cometchat-user-item) — Similar component for rendering user items
- [CometChatGroupItem](/ui-kit/angular/components/cometchat-group-item) — Similar component for rendering group items
