---
title: "Card Bubble component in the Angular UI Kit"
description: "Angular component that renders a developer Card Message inside a message bubble using the CometChat Cards renderer, with pure-forwarded card action events."
---
