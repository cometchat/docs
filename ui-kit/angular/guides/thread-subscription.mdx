...
Both surfaces read the same two labels, so there is no separate key for the action-sheet option. Override any of these through [Localization](/ui-kit/angular/customization/localization).
