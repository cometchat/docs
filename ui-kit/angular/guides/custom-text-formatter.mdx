---
title: "Custom text formatter in the Angular UI Kit"
sidebarTitle: "Custom Text Formatter"
description: "Extend the CometChatTextFormatter base class to implement custom inline text patterns with regex, styled tokens, and click callbacks in the Angular UI Kit."
---
