---
title: "Rich text formatting in the Angular UI Kit v5"
sidebarTitle: "Rich Text Formatting"
description: "Use rich text formatting in the CometChat Angular v5 UI Kit including bold, italic, underline, @mentions, links, keyboard shortcuts, and undo and redo history."
---
...
- [MessageComposer Component](../components/cometchat-message-composer.mdx)
