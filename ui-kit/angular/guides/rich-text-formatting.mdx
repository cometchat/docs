---
title: "Rich Text Formatting Guide"
description: "Use rich text formatting in the CometChat Angular v5 UIKit — text styling, mentions, and links via a lightweight rich text editor built on native browser APIs."
---
...
- [RichTextEditorService API Reference](/ui-kit/angular/api-reference/rich-text-editor-service)
