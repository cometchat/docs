---
title: "Render Card Messages in the Angular UI Kit"
description: "Render developer, persisted agent, and streaming agent Card Messages in the CometChat Angular UI Kit and handle card actions with the ccCardActionClicked event."
---
