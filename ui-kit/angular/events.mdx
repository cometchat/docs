---
title: "Events in the CometChat Angular UI Kit"
description: "Reference for CometChat Angular UI Kit events covering conversations, users, groups, messages, calls, and card actions, subscribed via RxJS observables."
---
