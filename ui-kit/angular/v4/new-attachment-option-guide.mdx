...
description: "New Attachment Option — CometChat integration guide."
---
...
The attachment options are then passed to the [ConversationsWithMessages](/ui-kit/angular/v4/conversations-with-messages) component as a prop using [MessageComposerConfguration](/web-shared/message-composer-configuration).
