...
If you want to customize the properties of the [MessageComposer](/ui-kit/angular/v4/message-composer) Component inside ThreadedMessages Component, you need use the `MessageComposerConfiguration` object.
