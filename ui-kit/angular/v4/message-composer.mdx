...
From the MessageComposer, you can navigate to the [UserMemberWrapper](/ui-kit/angular/v4/user-member-wrapper) component as shown in the image.
...
The `UserMemberWrapperConfiguration` indeed provides access to all the [Action](/ui-kit/angular/v4/user-member-wrapper#actions), [Filters](/ui-kit/angular/v4/message-information#filters), [Styles](/ui-kit/angular/v4/user-member-wrapper#style), [Functionality](/ui-kit/angular/v4/user-member-wrapper#functionality), and [Advanced](/ui-kit/angular/v4/user-member-wrapper#advanced) properties of the [UserMemberWrapper](/ui-kit/angular/v4/user-member-wrapper) component.
