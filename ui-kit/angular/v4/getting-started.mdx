...
[ConversationsWithMessages](/ui-kit/angular/v4/conversations-with-messages) is a wrapper component that offers functionality to render both the [Conversations](/ui-kit/angular/v4/conversations) and [Messages](/ui-kit/angular/v4/messages) components. It also enables opening the [Messages](/ui-kit/angular/v4/messages) by tapping on any conversation rendered in the list of conversations.
