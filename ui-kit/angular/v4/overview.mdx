...
The same skill adds **voice & video calling** too — run `/cometchat add voice and video calls to my app` and pick **Ringing** (incoming/outgoing call screens with system push) or **Session** (a shared meeting link) mode.
