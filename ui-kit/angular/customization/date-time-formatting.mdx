...
<CardGroup cols={2}>
  ...
  <Card title="Custom Message Types" href="/ui-kit/angular/guides/custom-message-types">
    Add custom message types with templates.
  </Card>
  <Card title="Global Config" href="/ui-kit/angular/customization/global-config">
