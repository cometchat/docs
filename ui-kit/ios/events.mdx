---
title: "Events in the CometChat iOS UI Kit"
description: "Listen to CometChat iOS UI Kit events for users, groups, messages, conversations, calls, and card action taps to respond to user actions and state changes."
---
