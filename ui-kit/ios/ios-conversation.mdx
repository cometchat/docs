...
### **Key Components**
<Columns cols={3}>
  <Card title="Chat Header" icon="circle-user">
    Displays user or group name, avatar, and back button.
  </Card>
  <Card title="Message List" icon="list-ul">
    Displays chat messages and real-time updates.
  </Card>
  <Card title="Message Composer" icon="paper-plane">
...
<Info>Ensure UIKit is initialized and the user is logged in before presenting the conversation view.</Info>
...
<Card title="Advanced Customizations" icon="palette" href="/ui-kit/ios/theme-introduction">
