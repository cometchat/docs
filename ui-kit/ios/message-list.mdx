...
<Frame>
  <img src="/ui-kit/ios/multimediaAttachments/imagesbubble.png" alt="Message list rendering a multi-attachment media message as a media grid of images with a +N overflow badge, shown for both incoming and outgoing messages" />
</Frame>
