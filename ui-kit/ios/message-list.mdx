...
ANDed with the feature gate: to remove thread subscription from your app entirely rather than from one screen, call `CometChatThreadSubscriptionConfig.setEnabled(false)` instead — see [Turning the Feature Off](/ui-kit/ios/guide-thread-subscription#turning-the-feature-off).
...
See the [Thread Subscription guide](/ui-kit/ios/guide-thread-subscription) for the full feature, including keeping your own subscription control in sync.
