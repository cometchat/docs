---
title: "Extensions"
description: "Enable CometChat iOS UI Kit extensions for stickers, polls, collaboration tools, moderation, and link previews."
---
...
<Note>
Smart Replies is not an extension in the v5 UI Kit, and turning it on under **Extensions** in the dashboard has no effect on the default kit. It is an AI feature: enable it under **AI** in the dashboard, then turn it on in code with `enableSmartReplies`. See [Smart Replies](/ui-kit/ios/ai-features#smart-replies).
</Note>
...
<Note>
Reactions is not an extension in the v5 UI Kit. It is a core feature of the message list and is on by default, with no extension to enable. To turn it off, set [`hideReactionOption`](/ui-kit/ios/message-list#hidereactionoption). See [Reactions](/ui-kit/ios/core-features#reactions).
</Note>
