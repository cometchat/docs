...
`CometChatSingleLineComposer` is a compact message composer component with built-in rich text formatting support. It provides a streamlined, single-line input experience with an expandable text area and a formatting toolbar.

<Frame>
  <img src="/ios-single-line-composer.png" />
</Frame>
...
<Tab title="Swift">
```swift
let singleLineComposer = CometChatSingleLineComposer()
singleLineComposer.set(user: user)
singleLineComposer.set(controller: self)
```
</Tab>
</Tabs>
...
```swift
let singleLineComposer = CometChatSingleLineComposer()
singleLineComposer.showRichTextFormattingOptions = true  // Shows the formatting toolbar
singleLineComposer.enableRichTextFormatting = true       // Enables markdown conversion
singleLineComposer.set(user: user)
singleLineComposer.set(controller: self)
```
</Tab>
...
class ChatViewController: UIViewController {
    ...
    private func setupComposer() {
        ...
        singleLineComposer.showRichTextFormattingOptions = true
        singleLineComposer.enableRichTextFormatting = true
        
        // Customize appearance
        singleLineComposer.set(placeholder: "Type a message...")
        
        // Add to view hierarchy
        singleLineComposer.translatesAutoresizingMaskIntoConstraints = false
        view.addSubview(singleLineComposer)
        
        NSLayoutConstraint.activate([
            singleLineComposer.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            singleLineComposer.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            singleLineComposer.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor)
        ])
    }
}
```
...
<Tab title="Swift">
```swift
CometChatSingleLineComposer.style.activeSendButtonBackgroundColor = UIColor(hex: "#F76808")
CometChatSingleLineComposer.style.attachmentImageTint = UIColor(hex: "#F76808")
CometChatSingleLineComposer.style.voiceRecordingImageTint = UIColor(hex: "#F76808")
```
</Tab>
</Tabs>
...
The following properties are exposed by SingleLineComposerStyle:
...
These properties allow you to customize the behavior of the SingleLineComposer.
...
// singleLineComposer.set(group: group)

// For thread replies
singleLineComposer.set(parentMessageId: 12345)

// Customize placeholder
singleLineComposer.set(placeholder: "Type your message...")

// Disable features
singleLineComposer.disable(soundForMessages: true)
singleLineComposer.disable(typingEvents: true)
singleLineComposer.disable(mentions: true)

// Hide UI elements
singleLineComposer.hideAttachmentButton = true
singleLineComposer.hideVoiceRecordingButton = true
singleLineComposer.hideStickersButton = true
...
| Underline | Underlines text | `__text__` |
...
<Tab title="Swift">
```swift
CometChatSingleLineComposer.style.richTextToolbarStyle.backgroundColor = UIColor(hex: "#F5F5F5")
CometChatSingleLineComposer.style.richTextToolbarStyle.iconTintColor = UIColor(hex: "#666666")
CometChatSingleLineComposer.style.richTextToolbarStyle.activeIconTintColor = UIColor(hex: "#F76808")
CometChatSingleLineComposer.style.richTextToolbarStyle.activeButtonBackgroundColor = UIColor(hex: "#FFF0E6")
```
</Tab>
</Tabs>
