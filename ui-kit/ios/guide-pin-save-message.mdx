...
2. CometChat UI Kit for iOS v5.1.22 or later installed
...
<Frame>
  <img
    src="/images/ios-pin.png"
    alt="The Pinned Messages screen: a titled screen with a back chevron, listing one conversation's pinned messages as full bubbles grouped by sender and date. Each bubble carries a pin glyph beside its timestamp, and a pinned image message shows the photo with the timestamp beneath."
  />
</Frame>
...
<Frame>
  <img
    src="/images/ios-save.png"
    alt="The Saved Messages screen: a titled screen with a back chevron, listing the logged-in user's saved messages as rows. Each row shows the source chat's avatar and name, the time of the save, and a preview line — media rows carrying a type icon and label such as Video, Sticker, Collaborative Document or Live Location."
  />
</Frame>
