...
<Columns cols={3}>
  ...
  <Card title="Message View" icon="message">
    Shows real-time chat history.
  </Card>
  <Card title="Message Input Box" icon="pen-to-square">
...
<Info>Ensure UI Kit is initialized and the user is logged in before presenting the message view.</Info>
