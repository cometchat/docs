...
| your own chat screen | Entry point for rendering or pushing the private chat interface |
...
| `UIViewController` (Navigation) | Pushes or presents your own private chat screen |
...
| 6 | Pushes your own chat screen onto the navigation stack |
