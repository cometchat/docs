...
The header renders a subscribe/unsubscribe bell as a trailing action on its reply-count bar. It appears only on a **sent parent message**, in one-on-one threads as well as groups.
