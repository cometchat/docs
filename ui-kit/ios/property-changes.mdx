...
description: "Comprehensive reference of newly added, renamed, and removed properties across all CometChat iOS UI Kit v5 components compared to v4."
sidebar_label: "Property Changes"
---
...
- **Related:** [Upgrading From V4](/ui-kit/ios/upgrading-from-v4) · [Components Overview](/ui-kit/ios/components-overview) · [Getting Started](/ui-kit/ios/getting-started)
</Info>
...
<CardGroup cols={2}>
  <Card title="Upgrading From V4" icon="arrow-up" href="/ui-kit/ios/upgrading-from-v4">
