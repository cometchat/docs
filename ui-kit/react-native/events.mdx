---
title: "Events in the CometChat React Native UI Kit"
description: "Listen to CometChat React Native UI Kit events for conversations, users, groups, messages, and call lifecycle updates to react to actions across components."
---
