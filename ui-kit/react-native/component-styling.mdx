...
| Field | Value |
| --- | --- |
| Components | `CometChatAIAssistantChatHistory`, `CometChatActionSheet`, `CometChatAvatar`, `CometChatBadge`, `CometChatBottomSheet`, `CometChatCallButtons`, `CometChatCallLogs`, `CometChatConversations`, `CometChatDate`, `CometChatGroupMembers`, `CometChatGroups`, `CometChatIncomingCall`, `CometChatMediaRecorder`, `CometChatMessageComposer`, `CometChatMessageHeader`, `CometChatMessageInformation`, `CometChatMessageList`, `CometChatReactionList`, `CometChatStatusIndicator`, `CometChatThreadHeader`, `CometChatUsers` |
...
return (
  ...
  >
    ...
    >
      {loggedIn && <CometChatConversations />}
    </CometChatThemeProvider>
  </SafeAreaView>
);
```
