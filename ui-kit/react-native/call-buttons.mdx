...
The `CometChatCallButtons` is a [Component](/ui-kit/react-native/01-components-overview.md#components) provides users with the ability to make calls, access call-related functionalities, and control call settings. Clicking this button typically triggers the call to be placed to the desired recipient.
