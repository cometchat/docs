...
<Note>
This guide colors text with the built-in rich-text format. To build your own inline pattern — hashtags, keywords, custom tokens — see the [Custom Text Formatter](/ui-kit/react-native/custom-text-formatter-guide) guide instead.
</Note>
...
Now: the user selects "world", taps **A**, picks red, and the word turns red in the composer. On send, the message text becomes `Hello <color=#e11d48>world</color>`.
...
- [Custom Text Formatter](/ui-kit/react-native/custom-text-formatter-guide) — build your own inline patterns with `CometChatTextFormatter`
