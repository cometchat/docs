...
| `EmptyStateView` | `() => JSX.Element` | The empty state, when no one has received the message yet |
...
| --- | --- |
| Type | `string` |
| Default | Localized "Message Information" |
...
Message shown in the default error state.
...
| --- | --- |
| Type | `() => JSX.Element` |
| Default | Built-in empty view |

---

### emptyStateText

Message shown in the default empty state.
