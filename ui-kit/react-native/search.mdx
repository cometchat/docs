...
| **Text Formatters**       | Text formatters applied to the message and conversation previews in the results. Pass the same array you give `CometChatMessageList`. | `textFormatters={[myFormatter]}` |
