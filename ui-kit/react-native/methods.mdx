---
title: "Methods"
description: "Use CometChat React Native UI Kit methods for initialization, login, logout, users, groups, messages, calls, and session handling."
---
...
| Field | Value |
| --- | --- |
| Components | `CometChatUiKitConstants` |
