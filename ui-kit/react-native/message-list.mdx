...
| **hideReplyOption**            | used to toggle visibility of reply option for a message in MessageList                                                                             | `hideReplyOption={true}`                                  |
...
| **goToMessageId**              | Message ID to navigate to and highlight in the message list. When provided, the message list will fetch messages around this ID and scroll to it | `goToMessageId="12345"`                                   |
| **searchKeyword**              | Search keyword to highlight in message text. When provided, matching text in messages will be highlighted                                         | `searchKeyword="hello"`                                   |
