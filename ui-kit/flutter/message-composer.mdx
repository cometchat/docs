...
description: "Enable users to compose and send text, media, and custom messages with attachments and live reactions in Flutter"
---
...
<Note>
**Available via:** [UI Kits](/ui-kit/flutter/overview) | [SDK](/sdk/flutter/send-message)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Mentions Formatter" icon="at" href="/ui-kit/flutter/mentions-formatter-guide">
    Enable user mentions in messages
  </Card>
</CardGroup>
