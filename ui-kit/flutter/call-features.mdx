...
sidebarTitle: "Call"
description: "Integrate calling in the CometChat Flutter UI Kit with one-on-one and group audio and video calls, including setup, initialization, and call lifecycle events."
---
