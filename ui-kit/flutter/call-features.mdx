...
<Step title="Modify UIKitSettings">
...
<CardGroup cols={3}>
<Card title="Incoming Audio/Video Calls" icon="phone" href="#incoming-call">
  Receive high-quality audio and video calls with real-time notifications.
</Card>
<Card title="Outgoing Video/Audio Calls" icon="video" href="#outgoing-call">
  Make crystal-clear video or audio calls with ease and reliability.
</Card>
