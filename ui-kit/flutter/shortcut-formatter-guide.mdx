...
| Purpose | Implement shortcut formatting in CometChat Flutter UI Kit with CometChatTextFormatter, trigger characters, and message shortcuts. |
| Key classes | `CometChatUIEvents` · `CometChatMessageComposer` · `CometChatTextFormatter` · `CometChatTheme` |
| Key methods | `callExtension()` |
| Related | [Text Formatters](/ui-kit/flutter/customization-text-formatters) · [Custom Text Formatter Guide](/ui-kit/flutter/custom-text-formatter-guide) |
