...
8. `onFormMessageReceived`: Triggered when a [form message](/sdk/flutter/interactive-messages) is received.
9. `onSchedulerMessageReceived`: Triggered when a [scheduler message](/sdk/flutter/interactive-messages) is received.
