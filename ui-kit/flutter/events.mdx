---
title: "Events in the CometChat Flutter UI Kit"
description: "Handle CometChat Flutter UI Kit events for users, groups, messages, conversations, calls, and UI-level interactions with a decoupled event architecture."
---
