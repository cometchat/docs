...
| Purpose | Replace specific regions of a component's UI using builder callbacks without rebuilding the entire component. |
| Key classes | `CometChatConversations` · `CometChatMessageList` |
| Related | [State Views](/ui-kit/flutter/customization-state-views) · [Message Template](/ui-kit/flutter/message-template) |
