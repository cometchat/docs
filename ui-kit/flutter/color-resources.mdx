...
| Purpose | Customize the CometChat Flutter UI Kit theme with palettes for light mode, dark mode, backgrounds, text, borders, icons, and buttons. |
| Key classes | `CometChatColorPalette` |
| Related | [Theming In CometChat Flutter UI Kit V6](/ui-kit/flutter/theme-introduction) · [Component Styling](/ui-kit/flutter/component-styling) |
