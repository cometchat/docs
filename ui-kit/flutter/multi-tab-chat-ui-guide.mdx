...
| Purpose | Build a multi-tab CometChat Flutter UI Kit chat interface with Conversations, Users, Groups, headers, message lists, and composers. |
| Key widgets | `CometChatConversations` · `CometChatGroups` · `CometChatMessageComposer` · `CometChatMessageHeader` · `CometChatMessageList` · `CometChatUsers` |
