---
title: "Call Logs"
description: "Display and manage call history with call details, timestamps, and call actions in Flutter"
---
...
CometChatCallLogs(
  onItemTap: (callLog) {
    // Handle call log selection
  },
  callLogsRequestBuilder: CallLogsRequestBuilder()
    ..limit = 30
    ..callType = "audio",
)
```
...
<Note>
**Available via:** [UI Kits](/ui-kit/flutter/overview) | [SDK](/sdk/flutter/call-logs) | [REST API](/rest-api/calls)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Call Log Details Guide" icon="book" href="/ui-kit/flutter/guide-call-log-details">
    Learn how to display call log details
  </Card>
</CardGroup>
