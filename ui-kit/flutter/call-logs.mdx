...
Using Navigator to Launch `CometChatCallLogs`
...
Embedding `CometChatCallLogs` as a Widget in the build Method
...
<Accordion title="onCallLogIconClicked">
...
## List of customizations along with corresponding code snippets
