...
| Purpose | Implement CometChat Flutter UI Kit agentic message flows with AI-powered message handling and custom AI message rendering. |
| Key widgets | `CometChatAIAssistantChatHistory` · `CometChatAIAssistantChatHistoryStyle` · `CometChatMessageList` · `CometChatMessageTemplate` |
