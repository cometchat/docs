...
| --- | --- | --- | --- |
| `usersStyle` | `CometChatUsersStyle` | `const CometChatUsersStyle()` | — |
...
| `onSelection` | `Function(List<User>?, BuildContext)?` | `null` | — |
...
| `appBarOptions` | `List<Widget> Function(BuildContext context)?` | `null` | — |
...
| `onItemTap` | `Function(BuildContext context, User)?` | `null` | — |
| `onItemLongPress` | `Function(BuildContext context, User)?` | `null` | — |
...
| `onLoad` | `OnLoad<User>?` | `null` | — |
| `onEmpty` | `OnEmpty?` | `null` | — |
| `subtitleView` | `Widget? Function(BuildContext, User)?` | `null` | — |
| `listItemView` | `Widget Function(User)?` | `null` | — |
| `titleView` | `Widget? Function(BuildContext context, User user)?` | `null` | — |
| `leadingView` | `Widget? Function(BuildContext context, User user)?` | `null` | — |
| `trailingView` | `Widget? Function(BuildContext context, User user)?` | `null` | — |
| `usersBloc` | `UsersBloc?` | `null` | — |
