---
title: "Users"
description: "CometChatUsers widget: discover, search, and interact with users in your Flutter app. Learn integration, customization, and advanced usage."
---

<Info>
The `CometChatUsers` widget provides a searchable, customizable list of users with avatars, names, and online/offline status indicators.
</Info>

<Frame caption="CometChatUsers Widget Preview" alt="Preview of the CometChatUsers widget UI">
...
Using Navigator to Launch `CometChatUsers`
...
Embedding `CometChatUsers` as a Widget in the build Method
