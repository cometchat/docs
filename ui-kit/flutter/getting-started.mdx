...
description: "Set up the CometChat Flutter UI Kit V6 with app credentials, package installation, initialization, and prebuilt users, groups, messages, and calls components."
---
