...
| Purpose | Show CometChat Flutter UI Kit call log details with participants, duration, timestamps, recordings, and call metadata. |
| Key widgets | `CometChatCallLogs` |
| Prerequisites | `CometChatUIKit` initialised and a user logged in. |
| Related | [Call Logs](/ui-kit/flutter/call-logs) · [Call](/ui-kit/flutter/call-features) |
