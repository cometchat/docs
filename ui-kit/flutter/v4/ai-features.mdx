...
Once you have successfully activated the [AI Assist Bot](https://assets.cometchat.io/legacy-docs/ai-chatbots/ai-bots/bots.html) from your CometChat Dashboard, the feature will automatically be incorporated into the Action sheet of [MessageComposer](/ui-kit/flutter/v4/message-composer) Widget of UI Kits.
