...
<Step title="Render the Messages Component">
  ...
  <CardGroup cols={3}>
  <Card title="Message Header" icon="message" href="/ui-kit/flutter/05-Components/06-message-header.md">
  ...
  <Card title="Message Composer" icon="square-pen" href="/ui-kit/flutter/05-Components/08-message-composer.md">
