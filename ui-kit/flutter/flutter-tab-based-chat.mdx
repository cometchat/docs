...
| Purpose | Build a tab-based CometChat Flutter UI Kit chat UI with conversations, users, groups, sidebar navigation, and message view. |
| Key widgets | `CometChatUIKit` · `CometChatConversations` · `CometChatGroups` · `CometChatMessageComposer` · `CometChatMessageHeader` · `CometChatMessageList` · `CometChatSubscriptionType` |
| Key methods | `init()` · `login()` |
| Prerequisites | `CometChatUIKit` initialised and a user logged in. |
| Related | [Conversations](/ui-kit/flutter/conversations) · [Users](/ui-kit/flutter/users) · [Groups](/ui-kit/flutter/groups) |
