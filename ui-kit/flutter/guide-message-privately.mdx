...
4. [Integration Steps](#integration-steps)  
   - [Add User Info/Action in Group Chat](#add-user-infoaction-in-group-chat)  
   - [Handle Private Message Navigation](#handle-private-message-navigation)  
...
| `messages.dart`                      | Main chat screen logic                                         |
| `user_info/cometchat_user_info.dart` | User info and action UI                                        |

## Integration Steps

### Add User Info/Action in Group Chat

**Goal:** Allow users to view group member info and provide a "Message" action.  
```dart
IconButton(
...
**Goal:** Start a private chat with the selected user.  
```dart
ElevatedButton(
  onPressed: () {
...
- **Filtering:** Exclude users who are blocked or not allowed to be messaged  
- **Existing Conversation:** Navigate to the existing private chat if one exists  
...
|:------------------------|:---------------------------------:-----------------------------------------------------------------------|
| Show user info          | `CometChatUserInfo`              | [`cometchat_group_info.dart`](https://github.com/cometchat/cometchat-uikit-flutter/blob/v5/sample_app/lib/group_info/cometchat_group_info.dart) |
| Message user            | `PageManager.navigateToMessages` | [`cometchat_user_info.dart`](https://github.com/cometchat/cometchat-uikit-flutter/blob/v5/sample_app/lib/user_info/cometchat_user_info.dart) |
| Access from group       | Avatar/IconButton                | [`messages.dart`](https://github.com/cometchat/cometchat-uikit-flutter/blob/v5/sample_app/lib/messages/messages.dart) |
