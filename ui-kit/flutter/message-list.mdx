---
title: "Message List"
description: "Display and manage messages with real-time updates, reactions, replies, and various message types in Flutter"
---
...
<Note>
**Available via:** [UI Kits](/ui-kit/flutter/overview) | [SDK](/sdk/flutter/receive-messages)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Message Template" icon="file-lines" href="/ui-kit/flutter/message-template">
