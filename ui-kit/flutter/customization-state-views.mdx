...
| Purpose | Replace CometChat Flutter UI Kit empty, error, loading, and chat greeting state views with custom Flutter widgets. |
| Key classes | `CometChatMessageList` · `CometChatConversations` |
| Related | [View Slots](/ui-kit/flutter/customization-view-slots) |
