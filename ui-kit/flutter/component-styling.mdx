...
<AccordionGroup>
<Accordion title="Unlock the Power of Customization" icon="wand-2">
...
<Accordion title="Transform Your Chat with Component Styling" icon="sparkles">
...
<Accordion title="Components" icon="layers">
...
<Frame caption="Conversation Styling" alt="Styled conversation component">
...
<Frame caption="Message List Styling" alt="Styled message list">
...
<Frame caption="Message Composer Styling" alt="Styled message composer">
...
<Frame caption="Message Header Styling" alt="Styled message header">
...
<Frame caption="Users Styling" alt="Styled user list">
...
<Frame caption="Groups Styling" alt="Styled group chat">
...
<Frame caption="Group Members Styling" alt="Styled group members list">
...
<Accordion title="Base Components" icon="box">
...
<Frame caption="Avatar Styling" alt="Styled avatar">
...
<Frame caption="Status Indicator Styling" alt="Styled status indicator">
...
<Frame caption="Badge Styling" alt="Styled badge">
...
<Frame caption="Receipts Styling" alt="Styled message receipts">
...
<Frame caption="Media Recorder Styling" alt="Styled media recorder">
...
<Frame caption="Reactions Styling" alt="Styled reactions">
...
<Frame caption="Reaction List Styling" alt="Styled reaction list">
...
<Frame caption="Conversation Starter Styling" alt="Styled conversation starter">
...
<Frame caption="Conversation Summary Styling" alt="Styled conversation summary">
...
<Frame caption="Smart Replies Styling" alt="Styled smart replies">
...
<Frame caption="Message Information Styling" alt="Styled message information">
...
<Frame caption="Message Option Sheet Styling" alt="Styled message option sheet">
...
<Frame caption="Attachment Option Sheet Styling" alt="Styled attachment option sheet">
...
<Frame caption="AI Option Sheet Styling" alt="Styled AI option sheet">
...
<Frame caption="Mentions Styling" alt="Styled mentions">
