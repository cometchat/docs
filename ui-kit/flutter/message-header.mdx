...
description: "Display conversation header with user/group info, typing indicators, and navigation controls in Flutter"
---
...
<Note>
**Available via:** [UI Kits](/ui-kit/flutter/overview) | [SDK](/sdk/flutter/messaging-overview)
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Threaded Messages" icon="comments" href="/ui-kit/flutter/threaded-messages-header">
    Enable threaded conversations and replies
  </Card>
