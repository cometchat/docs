...
| --- | --- | --- | --- |
| `groupMembersProtocol` | `GroupMembersBuilderProtocol?` | `null` | — |
| `subtitleView` | `Widget? Function(BuildContext context, GroupMember groupMember)?` | `null` | — |
| `hideSeparator` | `bool?` | `null` | — |
| `listItemView` | `Widget Function(GroupMember groupMember)?` | `null` | — |
| `style` | `CometChatGroupMembersStyle?` | `null` | — |
| `controller` | `ScrollController?` | `null` | — |
| `searchPlaceholder` | `String?` | `null` | — |
| `backButton` | `Widget?` | `null` | — |
| `showBackButton` | `bool` | `true` | Toggle back button |
| `searchBoxIcon` | `Widget?` | `null` | — |
| `hideSearch` | `bool` | `false` | Toggle search bar |
| `selectionMode` | `SelectionMode?` | `null` | Enable selection mode |
| `onSelection` | `Function(List<GroupMember>?)?` | `null` | — |
...
| `trailingView` | `Function(BuildContext context, GroupMember groupMember)?` | `null` | — |
| `selectIcon` | `Widget?` | `null` | — |
| `submitIcon` | `Widget?` | `null` | — |
| `onError` | `OnError?` | `null` | — |
| `onBack` | `VoidCallback?` | `null` | — |
| `onItemTap` | `Function(GroupMember groupMember)?` | `null` | — |
| `onItemLongPress` | `Function(GroupMember groupMember)?` | `null` | — |
| `activateSelection` | `ActivateSelection?` | `null` | — |
| `height` | `double?` | `null` | — |
| `width` | `double?` | `null` | — |
| `controllerTag` | `String?` | `null` | — |
| `hideAppbar` | `bool?` | `null` | Toggle app bar visibility |
| `searchKeyword` | `String?` | `null` | — |
| `onLoad` | `OnLoad<GroupMember>?` | `null` | — |
| `onEmpty` | `OnEmpty?` | `null` | — |
| `setOptions` | `List<CometChatOption>? Function( Group group, GroupMember groupMember, CometChatGroupMembersController controller, BuildContext context, )?` | `null` | — |
| `addOptions` | `List<CometChatOption>? Function( Group group, GroupMember groupMember, CometChatGroupMembersController controller, BuildContext context, )?` | `null` | — |
| `leadingView` | `Widget? Function(BuildContext context, GroupMember groupMember)?` | `null` | — |
| `titleView` | `Widget? Function(BuildContext context, GroupMember groupMember)?` | `null` | — |
