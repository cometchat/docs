...
// Minimal usage (requires parent message and logged in user)
...
CometChatThreadedHeader(
  ...
  style: CometChatThreadedHeaderStyle(
    bubbleContainerBackGroundColor: Colors.grey[100],
  ),
)
```
</Info>
...
<Note>
**Available via:** [UI Kits](/ui-kit/flutter/overview) | [SDK](/sdk/flutter/threaded-messages)
</Note>
