...
| `onConversationClicked` | `Function(Conversation conversation)?` | `null` | — |
| `onMessageClicked` | `Function(BaseMessage message)?` | `null` | — |
| `onEmpty` | `OnEmpty?` | `null` | — |
| `onError` | `OnError?` | `null` | — |
| `onMessagesLoad` | `OnLoad<BaseMessage>?` | `null` | — |
| `onConversationsLoad` | `OnLoad<Conversation>?` | `null` | — |
| `searchFilters` | `List<SearchFilter>?` | `null` | — |
| `searchIn` | `List<SearchScope>?` | `null` | — |
| `user` | `User?` | `null` | — |
| `group` | `Group?` | `null` | — |
| `searchStyle` | `CometChatSearchStyle?` | `null` | — |
| `searchBackIcon` | `Widget?` | `null` | — |
| `searchClearIcon` | `Widget?` | `null` | — |
| `loadingStateView` | `WidgetBuilder?` | `null` | — |
| `emptyStateView` | `WidgetBuilder?` | `null` | — |
| `errorStateView` | `WidgetBuilder?` | `null` | — |
| `initialStateView` | `WidgetBuilder?` | `null` | — |
| `conversationItemView` | `Widget? Function(BuildContext, Conversation)?` | `null` | — |
| `conversationTitleView` | `Widget? Function(BuildContext, Conversation)?` | `null` | — |
| `conversationLeadingView` | `Widget? Function(BuildContext, Conversation)?` | `null` | — |
| `conversationSubtitleView` | `Widget? Function(BuildContext, Conversation)?` | `null` | — |
| `conversationTailView` | `Widget? Function(BuildContext, Conversation)?` | `null` | — |
| `usersStatusVisibility` | `bool?` | `null` | — |
| `receiptsVisibility` | `bool?` | `null` | — |
| `groupTypeVisibility` | `bool?` | `null` | — |
| `dateSeparatorFormatterCallback` | `DateTimeFormatterCallback?` | `null` | — |
| `timeSeparatorFormatterCallback` | `DateTimeFormatterCallback?` | `null` | — |
| `searchTextMessageView` | `Widget? Function(BuildContext, TextMessage)?` | `null` | — |
| `searchImageMessageView` | `Widget? Function(BuildContext, MediaMessage)?` | `null` | — |
| `searchVideoMessageView` | `Widget? Function(BuildContext, MediaMessage)?` | `null` | — |
| `searchFileMessageView` | `Widget? Function(BuildContext, MediaMessage)?` | `null` | — |
| `searchAudioMessageView` | `Widget? Function(BuildContext, MediaMessage)?` | `null` | — |
| `conversationsRequestBuilder` | `ConversationsRequestBuilder?` | `null` | — |
