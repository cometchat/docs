...
| Purpose | Block and unblock users in CometChat Flutter UI Kit with blockUser and unblockUser methods for privacy and moderation. |
| Key methods | `blockUser()` · `unblockUser()` |
| Prerequisites | `CometChatUIKit` initialised and a user logged in. |
| Related | [Users](/ui-kit/flutter/users) |
