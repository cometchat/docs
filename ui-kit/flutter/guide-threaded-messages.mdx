...
| Purpose | Add threaded messages in CometChat Flutter UI Kit with parent message context, reply lists, and composers for focused conversations. |
| Key widgets | `CometChatMessageComposer` · `CometChatMessageList` · `CometChatMessageTemplate` · `CometChatThreadedHeader` · `CometChatUIKit` |
| Prerequisites | `CometChatUIKit` initialised and a user logged in. |
| Related | [Threaded Messages Header](/ui-kit/flutter/threaded-messages-header) · [Message List](/ui-kit/flutter/message-list) |
...
| Thread header | `CometChatThreadedHeader(parentMessage: ..., loggedInUser: ...)` |
