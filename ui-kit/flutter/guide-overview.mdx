...
| Purpose | Browse Flutter UI Kit feature guides for blocking users, group chat, private messages, new chat flows, and threaded conversations. |
| Prerequisites | `CometChatUIKit` initialised and a user logged in. |
| Related | [New Chat](/ui-kit/flutter/guide-new-chat) · [Group Chat](/ui-kit/flutter/guide-group-chat) · [Threaded Messages](/ui-kit/flutter/guide-threaded-messages) |
