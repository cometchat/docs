...
| Purpose | Build a two-panel CometChat Flutter UI Kit layout with a conversation list, active message view, headers, lists, and composer. |
| Key widgets | `CometChatUIKit` · `CometChatConversations` · `CometChatMessageComposer` · `CometChatMessageHeader` · `CometChatMessageList` · `CometChatSubscriptionType` |
| Key methods | `init()` · `login()` |
| Prerequisites | `CometChatUIKit` initialised and a user logged in. |
| Related | [Conversations](/ui-kit/flutter/conversations) · [Message List](/ui-kit/flutter/message-list) · [Message Composer](/ui-kit/flutter/message-composer) |
