...
<CardGroup cols={2}>
  <Card title="Call Buttons" icon="phone" href="/ui-kit/flutter/v5/call-buttons">
    Add audio and video call buttons to your chat interface
  </Card>
  <Card title="Incoming Call" icon="phone-arrow-down-left" href="/ui-kit/flutter/v5/incoming-call">
    Handle and display incoming call screens
  </Card>
  <Card title="Outgoing Call" icon="phone-arrow-up-right" href="/ui-kit/flutter/v5/outgoing-call">
    Manage outgoing call screens and transitions
  </Card>
  <Card title="Call Logs" icon="clock-rotate-left" href="/ui-kit/flutter/v5/call-logs">
