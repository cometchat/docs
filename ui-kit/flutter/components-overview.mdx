...
| Purpose | Explore CometChat Flutter UI Kit V6 widgets, base widgets, component architecture, actions, filters, styles, and customization. |
| Key classes | `CometChatMessageComposer` · `CometChatMessageHeader` · `CometChatMessageList` |
| Related | [Core Features](/ui-kit/flutter/core-features) · [Conversations](/ui-kit/flutter/conversations) |
