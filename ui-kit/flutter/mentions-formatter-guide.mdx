...
| Purpose | Format @mentions in CometChat Flutter UI Kit message lists, composers, and conversations with custom styles and tap handling. |
| Key classes | `CometChatMentionsFormatter` · `CometChatMessageList` · `CometChatConversations` · `CometChatMessageComposer` |
