...
CometChatConversations(
    style = CometChatConversationsStyle.default().copy(
        ...
        itemStyle = CometChatConversationListItemStyle.default().copy(
            ...
            badgeStyle = BadgeCountStyle.default().copy(
...
- [Theme Introduction](/ui-kit/android/theme-introduction) — Global theming reference.
- [Component Styling](/ui-kit/android/component-styling) — Detailed per-component style examples with screenshots.
- [Color Resources](/ui-kit/android/color-resources) — Default color palette reference.
- [Customization Overview](/ui-kit/android/customization-overview) — All customization categories.
