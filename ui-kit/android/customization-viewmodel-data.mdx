...
- [Customization Overview](/ui-kit/android/customization-overview) — Architecture overview with repository and ListOperations details.
- [Events & Callbacks](/ui-kit/android/customization-events) — Handle click events and global UI Kit events.
