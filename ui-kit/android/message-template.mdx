...
- Change how a specific message type (text, image, etc.) renders in the [MessageList](/ui-kit/android/message-list)
...
<CardGroup cols={2}>
  ...
  <Card title="Component Styling" icon="palette" href="/ui-kit/android/component-styling">
