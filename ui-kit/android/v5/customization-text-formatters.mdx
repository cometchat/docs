...
See the [Mentions Formatter Guide](/ui-kit/android/v5/mentions-formatter-guide) for details.
...
- [DataSource & ChatConfigurator](/ui-kit/android/v5/customization-datasource) — Learn the full DataSource decorator framework.
- [Mentions Formatter Guide](/ui-kit/android/v5/mentions-formatter-guide) — Built-in mentions formatter reference.
- [Customization Overview](/ui-kit/android/v5/customization-overview) — See all customization categories.
