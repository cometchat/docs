...
- [View Slots](/ui-kit/android/v5/customization-view-slots) — Learn the ViewHolderListener pattern used by adapter view slots.
- [ViewModel & Data](/ui-kit/android/v5/customization-viewmodel-data) — Manage data at the ViewModel level instead of the adapter.
