...
description: "Show CometChat Android UI Kit call log details with call history, participants, recordings, tabbed views, and Calls SDK integration."
---
...
| Related | [Call Logs](/ui-kit/android/v5/call-logs), [Call Buttons](/ui-kit/android/v5/call-buttons), [All Guides](/ui-kit/android/v5/guide-overview) |
