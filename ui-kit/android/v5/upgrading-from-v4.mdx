...
Learn how to build a complete messaging UI using the **v5 UI Kit** by following the step-by-step guide [here](/ui-kit/android/v5/getting-started#1%EF%B8%8F⃣-conversation-list-%2B-message-view).
...
* **Theming Documentation:** [Guide to Theming](/ui-kit/android/v5/theme-introduction)
* **Color Customization:** [Customizing Colors](/ui-kit/android/v5/color-resources)
...
<CardGroup cols={2}>
  <Card title="Getting Started" href="/ui-kit/android/v5/getting-started">
    Fresh v5 setup guide for Android.
  </Card>
  <Card title="Components Overview" href="/ui-kit/android/v5/components-overview">
    Explore all v5 prebuilt UI components.
  </Card>
  <Card title="Theming" href="/ui-kit/android/v5/theme-introduction">
    New XML-based theming system.
  </Card>
  <Card title="Methods" href="/ui-kit/android/v5/methods">
