---
title: "Conversations"
description: "Display CometChat Android UI Kit conversations with last messages, unread counts, typing indicators, presence, filters, and item callbacks."
---
...
> On phones, you'd typically use separate Activities instead of a side-by-side layout — see the [Conversation List + Message View](/ui-kit/android/v5/android-conversation) getting started guide.
...
Custom text formatters for the conversation subtitle. See the [MentionsFormatter Guide](/ui-kit/android/v5/mentions-formatter-guide) for details.
...
<CardGroup cols={2}>
  <Card title="Users" icon="user" href="/ui-kit/android/v5/users">
    Browse and search available users
  </Card>
  <Card title="Groups" icon="users" href="/ui-kit/android/v5/groups">
