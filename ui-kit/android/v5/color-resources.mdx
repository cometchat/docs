...
description: "Customize CometChat Android UI Kit color resources with brand colors, backgrounds, text, alerts, dark mode, and theme values."
---
...
| Related | [Theme Introduction](/ui-kit/android/v5/theme-introduction) \| [Component Styling](/ui-kit/android/v5/component-styling) |
