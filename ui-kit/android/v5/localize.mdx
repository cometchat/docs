---
title: "Localize"
description: "Localize CometChat Android UI Kit with supported languages, string resources, locale changes, and app-specific translations."
---
...
| Related | [Theme Introduction](/ui-kit/android/v5/theme-introduction) \| [Sound Manager](/ui-kit/android/v5/sound-manager) |
...
## Prerequisites
- CometChat UI Kit for Android is installed and initialized. Use [Getting Started](/ui-kit/android/v5/getting-started) if needed.
...
For the full callback reference, see [CometChatUIKit methods: DateFormatter](/ui-kit/android/v5/methods#dateformatter).
