...
- [Menu & Options](/ui-kit/android/v5/customization-menu-options) — Component-level option customization.
- [Text Formatters](/ui-kit/android/v5/customization-text-formatters) — Custom text processing via DataSource.
