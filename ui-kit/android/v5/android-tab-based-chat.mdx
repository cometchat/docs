...
description: "Build CometChat Android UI Kit tab-based chat with Chats, Calls, Users, and Groups tabs, message views, and navigation setup."
---
...
| Prerequisite | Complete [Integration](/ui-kit/android/v5/getting-started) Steps 1–4 first |
...
This assumes you've already completed [Integration](/ui-kit/android/v5/getting-started) (project created, dependencies installed, init + login working, theme set up).
...
<CardGroup cols={2}>
  ...
  <Card title="Integration" icon="rocket" href="/ui-kit/android/v5/getting-started">
    Back to the main setup guide
  </Card>
  <Card title="Feature Guides" icon="book" href="/ui-kit/android/v5/guide-overview">
