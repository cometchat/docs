---
title: "Groups"
description: "Display CometChat Android UI Kit groups with avatars, member counts, group type indicators, search, filtering, join, and conversation actions."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Group Members" icon="user-group" href="/ui-kit/android/v5/group-members">
