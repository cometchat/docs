...
description: "Format @mentions in CometChat Android UI Kit messages with custom styles, mention suggestions, group member mentions, and tap handling."
---
...
| Related | [ShortCut Formatter](/ui-kit/android/v5/shortcut-formatter-guide) \| [All Guides](/ui-kit/android/v5/guide-overview) |
...
Use `setTextFormatters()` on [CometChatMessageComposer](/ui-kit/android/v5/message-composer), [CometChatMessageList](/ui-kit/android/v5/message-list), or [CometChatConversations](/ui-kit/android/v5/conversations).
...
<CardGroup cols={2}>
  <Card title="Message Composer" icon="keyboard" href="/ui-kit/android/v5/message-composer">
  ...
  <Card title="ShortCut Formatter" icon="bolt" href="/ui-kit/android/v5/shortcut-formatter-guide">
