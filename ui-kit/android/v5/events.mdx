---
title: "Events"
description: "Handle CometChat Android UI Kit events for users, groups, messages, conversations, calls, and UI-level interactions."
---
...
<CardGroup cols={2}>
  <Card title="Methods Reference" icon="code" href="/ui-kit/android/v5/methods">
