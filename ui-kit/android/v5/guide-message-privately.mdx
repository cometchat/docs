...
description: "Start private one-to-one chats from CometChat Android UI Kit group conversations with message options, user lookup, and navigation."
---
...
| Related | [Message List](/ui-kit/android/v5/message-list), [Message Composer](/ui-kit/android/v5/message-composer), [Message Header](/ui-kit/android/v5/message-header), [All Guides](/ui-kit/android/v5/guide-overview) |
