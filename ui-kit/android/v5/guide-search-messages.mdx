...
description: "Add CometChat Android UI Kit message search with query input, scoped results, message selection, and navigation to matching chats."
---
...
| Related | [All Guides](/ui-kit/android/v5/guide-overview) |
...
Before starting, complete the [Getting Started](/ui-kit/android/v5/getting-started) guide.
...
<CardGroup cols={2}>
  <Card title="Search" icon="magnifying-glass" href="/ui-kit/android/v5/search">
    The search component reference
  </Card>
  <Card title="Message List" icon="messages" href="/ui-kit/android/v5/message-list">
    Display messages in a conversation
  </Card>
  <Card title="All Guides" icon="book" href="/ui-kit/android/v5/guide-overview">
