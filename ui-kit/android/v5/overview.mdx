...
<Note>
🚀 **CometChat Android UI Kit v6 is now available!** It features a completely revamped component architecture and improved theming. [Try the v6 →](/ui-kit/android/overview)
</Note>
...
<CardGroup cols={2}>
  <Card title="Integration Guide" icon="rocket" href="/ui-kit/android/v5/getting-started">
...
<CardGroup cols={2}>
  ...
  <Card title="Features" icon="comments" href="/ui-kit/android/v5/core-features">
...
<CardGroup cols={3}>
  ...
  <Card title="Migration Guide" icon="arrow-up" href="/ui-kit/android/v5/upgrading-from-v4">
    Upgrading from v4
  </Card>
</CardGroup>
