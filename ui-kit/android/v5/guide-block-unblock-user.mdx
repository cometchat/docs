...
description: "Block and unblock users in CometChat Android UI Kit with user relationship checks, SDK methods, and composer UI updates."
---
...
| Related | [Message Composer](/ui-kit/android/v5/message-composer), [Message List](/ui-kit/android/v5/message-list), [All Guides](/ui-kit/android/v5/guide-overview) |
