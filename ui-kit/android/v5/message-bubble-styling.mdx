...
description: "Customize CometChat Android UI Kit message bubbles with incoming and outgoing styles, borders, corner radius, and per-message-type styling."
---
...
| Related | [Theme Introduction](/ui-kit/android/v5/theme-introduction) \| [Component Styling](/ui-kit/android/v5/component-styling) \| [Message List](/ui-kit/android/v5/message-list) |
