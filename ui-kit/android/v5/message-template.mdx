...
description: "Define CometChat Android UI Kit message templates with custom bubble structure, content views, header views, reply views, and interactions."
---

A `MessageTemplate` defines and customizes both the structure and the behavior of the [MessageBubble](/ui-kit/android/v5/message-bubble-styling#message-bubbles). It acts as a schema for creating `MessageBubble` components, allowing you to manage the appearance and interactions of message bubbles within your application.
...
- You need to change how a specific message type (text, image, etc.) renders in the [MessageList](/ui-kit/android/v5/message-list)
...
- Familiarity with the [MessageList](/ui-kit/android/v5/message-list) component
- Familiarity with [MessageBubble styling](/ui-kit/android/v5/message-bubble-styling#message-bubbles)
...
- **Default behavior**: Displays the [Text Bubble](/ui-kit/android/v5/message-bubble-styling#text-bubble), [Image Bubble](/ui-kit/android/v5/message-bubble-styling#image-bubble), [File Bubble](/ui-kit/android/v5/message-bubble-styling#file-bubble), [Audio Bubble](/ui-kit/android/v5/message-bubble-styling#audio-bubble), or [Video Bubble](/ui-kit/android/v5/message-bubble-styling#video-bubble), depending on the message type
...
<CardGroup cols={2}>
  ...
  <Card title="Message Bubble Styling" icon="paintbrush" href="/ui-kit/android/v5/message-bubble-styling">
