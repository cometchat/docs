---
title: "Call Buttons"
description: "Add CometChat Android UI Kit call buttons for voice and video calls with user or group targets, click callbacks, and error handling."
---
...
<CardGroup cols={2}>
  <Card title="Call Logs" icon="clock-rotate-left" href="/ui-kit/android/v5/call-logs">
    View call history
  </Card>
  ...
  <Card title="Incoming Call" icon="phone-arrow-down-left" href="/ui-kit/android/v5/incoming-call">
