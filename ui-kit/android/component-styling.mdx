...
Mention styling is controlled by `CometChatMentionStyle`, applied to mentions rendered via `CometChatMentionsFormatter` inside messages.
...
- **Where to change it**: `res/values/themes.xml` (XML Views) or `style` parameter (Compose)
- **Applies to**: mentions rendered by `CometChatMentionsFormatter` (styled via `CometChatMentionStyle`)
...
The `CometChatCallButtons` component renders voice and video call buttons.
...
The `CometChatAIConversationStarterView` component renders AI-powered conversation starters.
...
- **Applies to**: `CometChatAIConversationStarterView`
...
The `CometChatAIConversationSummaryView` component renders AI-generated summaries of chats.
...
- **Applies to**: `CometChatAIConversationSummaryView`
...
The `CometChatAISmartRepliesView` component renders AI-generated reply suggestions.
...
- **Applies to**: `CometChatAISmartRepliesView`
