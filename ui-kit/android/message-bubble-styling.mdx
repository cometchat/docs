...
<Frame>
  <img src="/images/imagesbubble.png" alt="Images Bubble rendering a grid of image attachments with a +N overflow overlay on the last tile" />
</Frame>
...
<Frame>
  <img src="/images/videosbubble.png" alt="Videos Bubble rendering a grid of video thumbnails, each with a centered play badge, and a +N overflow overlay on the last tile" />
</Frame>
...
<Frame>
  <img src="/images/audiobubble.png" alt="Audios Bubble rendering stacked audio player rows, each with a play button, seek bar, time, file name, and download control, plus a Show N more toggle" />
</Frame>
...
<Frame>
  <img src="/images/filesbubble.png" alt="Files Bubble rendering a stack of file cards, each with a file-type icon, file name, and size metadata, plus a Show N more toggle" />
</Frame>
