...
> See the [Conversation List + Message View](/ui-kit/android/conversation-message-view) guide for a complete layout.
...
| `setPinConversationOptionVisibility(View.GONE)` | — | Hide the built-in Pin/Unpin conversation option |
...
CometChatConversations(
    style = CometChatConversationsStyle.default().copy(
        ...
        itemStyle = CometChatConversationListItemStyle.default().copy(
            backgroundColor = Color.White,
            titleTextColor = Color(0xFF141414),
            subtitleTextColor = Color(0xFF727272),
            avatarStyle = CometChatAvatarStyle.default().copy(cornerRadius = 12.dp),
            badgeStyle = BadgeCountStyle.default().copy(backgroundColor = Color(0xFFF76808)),
            dateStyle = DateStyle.default().copy(textColor = Color(0xFFA1A1A1)),
            receiptStyle = CometChatReceiptsStyle.default().copy(),
            statusIndicatorStyle = CometChatStatusIndicatorStyle.default().copy(),
            typingIndicatorStyle = TypingIndicatorStyle.default().copy()
        )
    )
)
```
...
<CardGroup cols={2}>
  <Card title="Conversation List + Message View" icon="comments" href="/ui-kit/android/conversation-message-view">
  ...
  <Card title="View Slots" icon="puzzle-piece" href="/ui-kit/android/customization-view-slots">
