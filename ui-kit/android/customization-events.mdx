...
- [Events Reference](/ui-kit/android/events) — Full list of all event types.
- [Customization Overview](/ui-kit/android/customization-overview) — SDK Listeners vs UIKit Events distinction.
