...
<Note>
The live preview below is the shared cross-platform Storybook reference (rendered from the React UI Kit). The Android composer's multi-attachment staging tray follows the same design.
</Note>
