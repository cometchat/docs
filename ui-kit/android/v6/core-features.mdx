...
{/* TODO(ENG-36737): replace with a screenshot of the multi-select picker + attachment tray + grid bubble — the current image shows the legacy single-attachment action sheet */}
