...
<Note>
The live preview below is the shared cross-platform Storybook reference (rendered from the React UI Kit). The Android staging tray follows the same design and states.
</Note>
