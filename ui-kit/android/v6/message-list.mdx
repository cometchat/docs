---
title: "Message List component in Android UI Kit v6"
description: "Render CometChat conversations on Android with the CometChatMessageList component, supporting real-time updates, reactions, threaded replies, and actions."
---
