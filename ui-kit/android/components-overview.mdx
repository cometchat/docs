...
| CometChatAIAssistantChatHistory | AI assistant conversation history | `setOnItemClick`, `setNewChatButtonClick` | [AI Assistant Chat History](/ui-kit/android/ai-assistant-chat-history) |
