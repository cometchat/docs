...
<CardGroup cols={2}>
  <Card title="Kotlin (XML Views)" icon="code" href="/ui-kit/android/getting-started-kotlin">
    Step-by-step integration using `chatuikit-kotlin` with XML layouts and ViewBinding
  </Card>
  <Card title="Jetpack Compose" icon="wand-magic-sparkles" href="/ui-kit/android/getting-started-jetpack">
    Step-by-step integration using `chatuikit-compose` with Composables
  </Card>
</CardGroup>
