...
<Callout type="tip">
 Quickly integrate chat with **prebuilt UI components**, theming, and real-time features – no need to build from scratch.
</Callout>
...
<Cards>
  ...
  <Card title="Group Chat & Messaging" />
  <Card title="Voice & Video Calling" />
...
⚠️ Replace `APP_ID`, `AUTH_KEY`, and `REGION` with your actual CometChat credentials.
...
<Accordion title="Conversation List + Message View">
...
<Accordion title="One-to-One / Group Chat">
...
<Accordion title="Tab-Based Messaging UI (All-in-One)">
...
<Cards>
  <Card title="Sample App" href="https://github.com/cometchat/cometchat-uikit-android/tree/v5/sample-app-kotlin" />
  <Card title="Core Features" href="./core-features" />
  <Card title="Components" href="./components-overview" />
  <Card title="Themes" href="./theme" />
  <Card title="Build with SDK" href="./../../../sdk/javascript/overview" />
</Cards>
***
