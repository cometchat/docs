...
| Key components | [Message Composer](/ui-kit/android/message-composer) (Stickers, Polls, Whiteboard, Document), [Message List](/ui-kit/android/message-list) (Translation, Link Preview, Thumbnails) |
