...
Start with [Styles](/ui-kit/android/customization-styles) for quick visual changes, or [ViewModel & Data](/ui-kit/android/customization-viewmodel-data) for behavior customization.
