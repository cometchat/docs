...
| `setLoadLastAgentConversation` | Loads the most recent existing agent conversation on start | `.setLoadLastAgentConversation(true);` |
...
<Tab title="Kotlin">
```kotlin lines
cometChatMessageList.setLoadLastAgentConversation(true)
```
</Tab>
...
| Load last agent conversation | Activity/Fragment | `setLoadLastAgentConversation(boolean)` | `.setLoadLastAgentConversation(true);` |
