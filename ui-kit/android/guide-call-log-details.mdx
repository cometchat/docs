...
- **CometChat Android UI Kit v6** (`com.cometchat:chatuikit-kotlin-android` or `com.cometchat:chatuikit-compose-android`) and **CometChat Calls SDK** added in `build.gradle`.  
