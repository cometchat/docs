---
title: "CometChat UIKit Android — Group Management"
...
**Goal:** Add a FAB to launch the group-management dialog.
...
**Goal:** Initialize UIKit views and respond to FAB clicks.
...
**Goal:** Allow users to create or join a group via Core SDK.
...
**Goal:** Fetch and display the current member list.
...
**Goal:** Select users not in the group and add them.
...
**Goal:** Perform moderation actions on selected members.
