...
- Android Studio project with CometChat Android UI Kit v6 (`com.cometchat:chatuikit-kotlin-android` or `com.cometchat:chatuikit-compose-android`) added to `build.gradle`.  
