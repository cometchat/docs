...
<Note>
Before proceeding, ensure you have completed the [UI Kit integration](/ui-kit/android/getting-started) and the [Dashboard Setup](/campaigns#setup-flow) for Campaigns.
</Note>
...
See the full [CometChatNotificationFeed component documentation](/ui-kit/android/notification-feed) for all configuration options, styling, and customization.
...
<CardGroup cols={2}>
  ...
  <Card title="CometChatNotificationFeed" icon="bell" href="/ui-kit/android/notification-feed">
