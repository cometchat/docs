...
For a comprehensive understanding and guide on implementing and using the AI Assist Bot, refer to our specific guide on the [AI Assist Bot](https://assets.cometchat.io/legacy-docs/ai-chatbots/ai-bots/bots.html).

Once you have successfully activated the [AI Assist Bot](https://assets.cometchat.io/legacy-docs/ai-chatbots/ai-bots/bots.html) from your CometChat Dashboard, the feature will automatically be incorporated into the Action sheet of [MessageComposer](/ui-kit/android/v4/message-composer) Component of UI Kits.
