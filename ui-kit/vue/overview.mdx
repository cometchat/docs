---
title: "Overview"
description: "Use CometChat Vue UI Kit to add prebuilt chat components, messaging features, calls, customization, and sample app references."
---
...
Connect the **CometChat Docs MCP** so your AI coding agent reads CometChat's current documentation instead of guessing at APIs:
...
No authentication required. The server is read-only. For Claude Desktop, VS Code, and Codex, see [MCP Integration](/mcp-server).
