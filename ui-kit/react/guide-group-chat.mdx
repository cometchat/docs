---
title: "Group Chat Guide - CometChat React UI Kit"
sidebarTitle: "Group Chat"
description: "Implement group management including create, join, members, roles, and ownership transfer in CometChat React UI Kit v6."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/custom-text-formatter-guide"
prev_page: "/ui-kit/react/guide-call-log-details"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Call Log Details](/ui-kit/react/guide-call-log-details) | [Reference →](/ui-kit/react/methods)
</Info>
