---
title: "Message Composer Component - CometChat React UI Kit"
description: "Compose and send messages with rich text, media, attachments, mentions, and voice notes using the CometChatMessageComposer component. Supports custom actions, AI features, and CSS styling."
sidebarTitle: "Message Composer"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/message-template"
prev_page: "/ui-kit/react/message-list"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Message List](/ui-kit/react/message-list) | [Customization →](/ui-kit/react/theme)
</Info>

<Warning>
**Dashboard Prerequisite:** Mentions support in MessageComposer requires enabling Mentions at Dashboard → Chat → Features → Mentions. [See Core Features](/ui-kit/react/core-features) for details.
</Warning>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">Display sent and received messages</Card>
  <Card title="Message Template" icon="file-code" href="/ui-kit/react/message-template">Customize message bubbles</Card>
  <Card title="Mentions Formatter" icon="at" href="/ui-kit/react/mentions-formatter-guide">Add @mentions support</Card>
</CardGroup>
