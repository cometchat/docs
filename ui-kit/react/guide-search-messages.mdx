---
title: "Search Messages Guide - CometChat React UI Kit"
sidebarTitle: "Search Messages"
description: "Add full-text message search across conversations with result routing and navigation in CometChat React UI Kit v6."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/guide-call-log-details"
prev_page: "/ui-kit/react/guide-message-privately"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Message Privately](/ui-kit/react/guide-message-privately) | [Reference →](/ui-kit/react/methods)
</Info>
