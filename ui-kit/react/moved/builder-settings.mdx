...
<Tip>
Use these settings to quickly toggle features on/off without changing UI code. Changes reflect immediately in the Builder-based UI.
</Tip>
...
<Tip>
These features require enabling AI providers and configuring credentials in your app dashboard before they appear in the UI.
</Tip>
...
<Tip>
You can reorder `tabs` to prioritize sections. Set `chatType` to `group` to open the app in group chat view by default.
</Tip>
...
<Tip>
When using `theme: "system"`, ensure your app supports both light and dark color tokens to avoid contrast issues.
</Tip>
