---
title: "Events Reference - CometChat React UI Kit"
description: "Complete reference for CometChat React UI Kit v6 events including conversation, user, group, message, and call events for decoupled component communication."
journey_stage: "api-reference"
step_number: 7
total_steps: 8
next_page: "/ui-kit/react/upgrading-from-v5"
prev_page: "/ui-kit/react/methods"
required_components: []
---

<Info>
📍 **Step 7 of 8: API Reference** — [← Methods](/ui-kit/react/methods) | [Migration →](/ui-kit/react/upgrading-from-v5)
</Info>
...
<Tip>
**Need practical examples?** Check the [Guides](/ui-kit/react/guide-overview) for step-by-step recipes using these methods and events.
</Tip>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Methods" icon="code" href="/ui-kit/react/methods">API methods reference</Card>
