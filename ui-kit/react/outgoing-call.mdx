---
title: "Outgoing Call Component - CometChat React UI Kit"
description: "Display and manage outgoing voice and video calls with cancel controls using the CometChatOutgoingCall component in your React chat app."
sidebarTitle: "Outgoing Call"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/call-buttons"
prev_page: "/ui-kit/react/incoming-call"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Incoming Call](/ui-kit/react/incoming-call) | [Customization →](/ui-kit/react/theme)
</Info>

<Warning>
**Additional SDK Required:** OutgoingCall requires the CometChat Calls SDK. [See Call Features](/ui-kit/react/call-features) for installation steps.
</Warning>
