---
title: "Call Log Details Guide - CometChat React UI Kit"
sidebarTitle: "Call Log Details"
description: "Build a detailed call insights screen with metadata, participants, and recordings in CometChat React UI Kit v6."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/guide-group-chat"
prev_page: "/ui-kit/react/guide-search-messages"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Search Messages](/ui-kit/react/guide-search-messages) | [Reference →](/ui-kit/react/methods)
</Info>
