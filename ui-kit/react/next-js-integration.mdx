---
title: "Next.js Integration - CometChat React UI Kit"
sidebarTitle: "Integration"
description: "Step-by-step guide to integrate CometChat React UI Kit into your Next.js app. Install dependencies, initialize, authenticate, and run your first chat experience."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/next-conversation"
...
<CardGroup cols={3}>
  ...
  <Card title="One-to-One Chat" icon="message" href="/ui-kit/react/next-one-to-one-chat">
