...
<CardGroup cols={2}>
  <Card
    ...
    icon="comments"
    iconType="solid"
    href="/ui-kit/react/next-conversation"
  >
    Add a conversation list with message support to your app.
  </Card>
  ...
  <Card
    ...
    icon="user"
    iconType="solid"
    href="/ui-kit/react/next-one-to-one-chat"
  >
    Enable direct, private conversations between users.
  </Card>
  ...
  <Card
    ...
    icon="table-columns"
    iconType="solid"
    href="/ui-kit/react/next-tab-based-chat"
  >
    Organize and navigate chats with a tabbed interface.
  </Card>
  ...
  >
    Customize layouts, themes, and UI components to match your brand.
  </Card>
</CardGroup>
