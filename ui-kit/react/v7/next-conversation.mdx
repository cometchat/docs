...
| Prerequisite | Complete [Next.js Integration](/ui-kit/react/v7/integration-nextjs) first |
...
This assumes you've already completed [Next.js Integration](/ui-kit/react/v7/integration-nextjs) (project created, UI Kit installed, init + login working).
...
<CardGroup cols={2}>
  <Card title="One-to-One / Group Chat" icon="message" href="/ui-kit/react/v7/next-one-to-one-chat">
    Single chat window without a sidebar
  </Card>
  <Card title="Tab-Based Chat" icon="table-columns" href="/ui-kit/react/v7/next-tab-based-chat">
