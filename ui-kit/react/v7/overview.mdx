...
<CardGroup cols={2}>
  <Card title="React.js" icon="react" href="/ui-kit/react/v7/integration-react">
    Vite or Create React App
  </Card>
  <Card title="Next.js" icon="server" href="/ui-kit/react/v7/integration-nextjs">
    App Router with client-side rendering
  </Card>
  <Card title="React Router" icon="route" href="/ui-kit/react/v7/integration-react-router">
    SPA with React Router v6+
  </Card>
  <Card title="Astro" icon="rocket" href="/ui-kit/react/v7/integration-astro">
...
<CardGroup cols={2}>
  <Card title="Components" icon="grid-2" href="/ui-kit/react/v7/components-overview">
