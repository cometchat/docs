...
- [Thread Header](/ui-kit/react/v7/components/thread-header) — customize the thread header appearance
- [Message List](/ui-kit/react/v7/components/message-list) — configure message list rendering and options
