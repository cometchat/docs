...
<iframe
  src="https://storybook.cometchat.io/react/iframe.html?id=components-bubbles-message-bubble-text--with-translation&viewMode=story&shortcuts=false&singleStory=true"
  className="w-full rounded-xl"
  loading="lazy"
  style={{height: "350px", border: "1px solid #e0e0e0"}}
  title="CometChat Text Bubble — With Translation"
