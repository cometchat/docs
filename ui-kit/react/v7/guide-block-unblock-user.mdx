...
- [Message Composer](/ui-kit/react/v7/components/message-composer) — learn about composer customization
- [Conversations](/ui-kit/react/v7/components/conversations) — build a full conversations list
