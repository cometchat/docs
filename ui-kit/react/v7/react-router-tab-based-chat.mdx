...
| Prerequisite | Complete [React Router Integration](/ui-kit/react/v7/integration-react-router) first |
...
This assumes you've already completed [React Router Integration](/ui-kit/react/v7/integration-react-router) (project created, UI Kit installed, init + login working).
...
<CardGroup cols={2}>
  <Card title="Conversation List + Messages" icon="comments" href="/ui-kit/react/v7/react-router-conversation">
