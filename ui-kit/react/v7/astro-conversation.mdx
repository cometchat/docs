...
| Prerequisite | Complete [Astro Integration](/ui-kit/react/v7/integration-astro) first |
...
This assumes you've already completed [Astro Integration](/ui-kit/react/v7/integration-astro) (project created, UI Kit installed, init + login working).
...
<CardGroup cols={2}>
  <Card title="One-to-One / Group Chat" icon="message" href="/ui-kit/react/v7/astro-one-to-one-chat">
    Single chat window without a sidebar
  </Card>
  <Card title="Tab-Based Chat" icon="table-columns" href="/ui-kit/react/v7/astro-tab-based-chat">
