...
<CardGroup cols={2}>
  <Card title="Groups" icon="users" href="/ui-kit/react/v7/components/groups">
    Browse and select groups
  </Card>
  <Card title="Banned Members" icon="ban" href="/ui-kit/react/v7/components/banned-members">
    View and unban banned group members
  </Card>
  <Card title="Add Members" icon="user-plus" href="/ui-kit/react/v7/components/add-members">
