...
<CardGroup cols={2}>
  ...
  <Card title="Thread Header" icon="comments" href="/ui-kit/react/v7/components/thread-header">
    Display thread context above a threaded message list
  </Card>
  <Card title="Plugins Overview" icon="puzzle-piece" href="/ui-kit/react/v7/plugins/overview">
