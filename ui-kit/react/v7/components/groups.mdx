...
<CardGroup cols={2}>
  <Card title="Group Members" icon="user-group" href="/ui-kit/react/v7/components/group-members">
    View and manage members of a group
  </Card>
  <Card title="Conversations" icon="comments" href="/ui-kit/react/v7/components/conversations">
    View recent conversations including group chats
  </Card>
  <Card title="Message List" icon="comment-dots" href="/ui-kit/react/v7/components/message-list">
