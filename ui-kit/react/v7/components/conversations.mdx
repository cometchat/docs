...
<CardGroup cols={2}>
  <Card title="Users" icon="user" href="/ui-kit/react/v7/components/cometchat-users">
  ...
  <Card title="Search" icon="magnifying-glass" href="/ui-kit/react/v7/components/search">
