...
- A working CometChat React UI Kit v7 setup (completed the [Integration Guide](/ui-kit/react/v7/integration-react))
...
- [Message Header](/ui-kit/react/v7/components/message-header) — full props reference including call button visibility
- [Call Logs](/ui-kit/react/v7/components/call-logs) — display call history
- [CometChatProvider](/ui-kit/react/v7/cometchat-provider) — all provider configuration options
