...
First, make sure that you've correctly integrated the UI Kit library into your project. If you haven't done this yet or are facing difficulties, refer to our [Getting Started](/ui-kit/react/react-js-integration) guide (or a framework variant like [Next.js](/ui-kit/react/next-js-integration) / [React Router](/ui-kit/react/react-router-integration) / [Astro](/ui-kit/react/astro-integration)).
