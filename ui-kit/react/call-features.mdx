...
<Note>
Ensure your app is wrapped in `CometChatProvider` with valid credentials and `callingEnabled={true}`. See [React.js Integration](/ui-kit/react/integration-react).
</Note>
