...
<Tip>
Call features require the CometChat Calls SDK to be properly integrated. Make sure you have the necessary permissions and configurations in your CometChat dashboard.
</Tip>
...
<CardGroup cols={1}>
  <Card
    title="Incoming Call Component"
    icon="phone"
    iconType="solid"
    href="/ui-kit/react/incoming-call"
  >
    Learn how to implement and customize the incoming call functionality in your React app.
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card
    title="Outgoing Call Component"
    icon="phone"
    iconType="solid"
    href="/ui-kit/react/outgoing-call"
  >
    Learn how to implement and customize the outgoing call functionality in your React app.
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card
    title="Call Logs Component"
    icon="clock"
    iconType="solid"
    href="/ui-kit/react/call-logs"
  >
    Learn how to implement and customize call logging functionality in your React app.
  </Card>
</CardGroup>
