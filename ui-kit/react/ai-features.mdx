...
<Note>
The [AI Assistant Chat](/ui-kit/react/components/ai-assistant-chat) component requires `CometChatAIPlugin` to be configured in your `CometChatProvider` plugins. See the [AI Assistant Chat](/ui-kit/react/components/ai-assistant-chat) component page for setup details.
</Note>
