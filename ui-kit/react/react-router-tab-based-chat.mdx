...
description: "Build a tab-based chat interface with Chat, Call Logs, and Users tabs in React Router."
---
...
Create a route component for the tabbed chat page. Init and login are completed in `src/main.tsx` (see [React Router Integration](/ui-kit/react/integration-react-router)).
...
export default function TabbedChatPage() {
  ...
  const [selectedConversation, setSelectedConversation] = useState<CometChat.Conversation | undefined>(undefined);
      ...
      <div className="tabbed-chat">
        <div className="sidebar">
          ...
          <div className="sidebar-list">
            ...
            {activeTab === "users" && (
              <CometChatUsers onItemClick={handleUserClick} activeUser={selectedUser} />
            )}
          </div>
        </div>
