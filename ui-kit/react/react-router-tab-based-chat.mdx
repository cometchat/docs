---
title: "Tab-Based Chat Experience - React Router Chat Layout"
sidebarTitle: "Tab Based Chat Experience"
description: "Build a tab-based chat layout with CometChat React UI Kit. Copy-paste ready code for React Router."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/core-features"
prev_page: "/ui-kit/react/react-router-one-to-one-chat"
required_components: []
---
