...
| Other frameworks | [React.js](/integration-react) · [React Router](/integration-react-router) · [Astro](/integration-astro) |

</Accordion>

This guide walks you through adding CometChat to a Next.js (App Router) app. By the end you'll have a working chat UI.

{/* TODO:IMAGE - Screenshot of the final result: two-panel chat layout in Next.js */}
...
`'use client'` is required because CometChat components use browser APIs. `CometChatProvider` handles init, login, and all context setup automatically. For advanced use cases (custom login flows, individual providers), see the [CometChatProvider](/cometchat-provider) guide.
...
{/* TODO:IMAGE - Screenshot of the running app with conversations + messages */}
...
{/* TODO:IMAGE - Two-panel layout screenshot */}
...
{/* TODO:IMAGE - Single chat window screenshot */}
...
{/* TODO:IMAGE - Tab-based layout screenshot */}
...
If your Next.js app runs inside an `<iframe>`, additional configuration is needed to ensure dialogs and portals mount in the correct frame. Documentation will be available once iframe support is finalized.
