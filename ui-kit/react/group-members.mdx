---
title: "Group Members Component - CometChat React UI Kit"
description: "Display and manage group members with roles, scopes, online status, and member management actions using the CometChatGroupMembers component. Configure kick, ban, and scope change actions."
sidebarTitle: "Group Members"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/message-header"
prev_page: "/ui-kit/react/groups"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Groups](/ui-kit/react/groups) | [Customization →](/ui-kit/react/theme)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Groups" icon="users" href="/ui-kit/react/groups">Browse and manage groups</Card>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">Display group messages</Card>
  <Card title="Group Chat Guide" icon="book" href="/ui-kit/react/guide-group-chat">Build a group chat experience</Card>
</CardGroup>
