...
You can still use `CometChatUIKit.init()` + `login()` and compose individual providers. See [CometChatProvider — Individual Providers](/ui-kit/react/cometchat-provider#approach-2%3A-individual-providers-advanced).
