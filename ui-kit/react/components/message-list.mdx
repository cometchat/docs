...
<Note>
Available from **7.2.0**. This prop existed in v6, was dropped in 7.0.0 in favour of the plugin system, and was restored in 7.2.0. On 7.0.x–7.1.x it is not available.
