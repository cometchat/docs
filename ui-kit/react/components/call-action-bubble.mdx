...
It is the component the [Call Action Plugin](/ui-kit/react/plugins/call-action) forwards to, and it renders through the presentational `CometChatActionBubble` base primitive.
