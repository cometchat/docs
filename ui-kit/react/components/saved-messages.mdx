...
<Note>
**Added in 7.2.0.** `CometChatSavedMessages` is not available in earlier v7 releases — upgrade to 7.2.0 or later to use it.
</Note>
...
<iframe
  src="https://storybook.cometchat.io/react/iframe.html?id=components-messages-saved-messages--default&viewMode=story&shortcuts=false&singleStory=true"
