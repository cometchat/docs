...
[Open in Storybook ↗](https://storybook.cometchat.io/react/?path=/story/components-flag-message-dialog--default)
</Info>

<iframe
  src="https://storybook.cometchat.io/react/iframe.html?id=components-flag-message-dialog--default&viewMode=story&shortcuts=false&singleStory=true"
