---
title: "AI Assistant Chat component in React UI Kit v7"
description: "AI agent chat interface in the CometChat React UI Kit v7 with streaming responses, suggested messages, tool calling, and one-to-one or group conversations."
---
