...
<Note>
**Added in 7.1.0.** `CometChatVoiceNoteBubble` is not available in earlier v7 releases — on 7.0.x, upgrade to 7.1.0 or later to use it. Recorded voice notes route here; attached audio files route to `CometChatAudiosBubble`.
</Note>
