...
It is the component the [Group Action Plugin](/ui-kit/react/plugins/group-action) forwards to, and it renders through the presentational `CometChatActionBubble` base primitive. Group action bubbles have no icon and no sender attribution.

<Info>
**Live Preview** — interact with the group action bubble.

[Open in Storybook ↗](https://storybook.cometchat.io/react/?path=/story/components-bubbles-group-action-bubble--joined)
</Info>

<iframe
  src="https://storybook.cometchat.io/react/iframe.html?id=components-bubbles-group-action-bubble--joined&viewMode=story&shortcuts=false&singleStory=true"
