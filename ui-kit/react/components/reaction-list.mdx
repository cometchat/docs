...
<iframe
  src="https://storybook.cometchat.io/react/iframe.html?id=components-misc-reaction-list--default&viewMode=story&shortcuts=false&singleStory=true"
...
<CardGroup cols={2}>
  <Card title="Reactions" icon="face-smile" href="/ui-kit/react/components/reactions">
