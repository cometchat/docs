...
<Frame><img src="/images/e06ce245-groups_overview_web_screens-76f09cda3f72c774c46829a547f37f3d.png" /></Frame>
...
| `List` | Scrollable group list | `itemView`, `className` | `itemView` |
| `Item` | Individual group row | `leadingView`, `titleView`, `subtitleView`, `trailingView`, `className` | Per-item view props |
...
<CardGroup cols={2}>
  <Card title="Group Members" icon="user-group" href="/components/group-members">
    View and manage members of a group
  </Card>
  <Card title="Conversations" icon="comments" href="/components/conversations">
    View recent conversations including group chats
  </Card>
  <Card title="Message List" icon="comment-dots" href="/components/message-list">
