...
<Frame><img src="/images/fc565456-group_members_overview_web_screens-448397c54784d0c68f66dfdf98656483.png" /></Frame>
...
<CardGroup cols={2}>
  <Card title="Groups" icon="users" href="/components/groups">
    Browse and select groups
  </Card>
  <Card title="Banned Members" icon="ban" href="/components/banned-members">
    View and unban banned group members
  </Card>
  <Card title="Add Members" icon="user-plus" href="/components/add-members">
