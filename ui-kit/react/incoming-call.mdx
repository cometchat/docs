---
title: "Incoming Call Component - CometChat React UI Kit"
description: "Display and manage incoming voice and video calls with accept and decline controls using the CometChatIncomingCall component in your React chat app."
sidebarTitle: "Incoming Call"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/outgoing-call"
prev_page: "/ui-kit/react/thread-header"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Thread Header](/ui-kit/react/thread-header) | [Customization →](/ui-kit/react/theme)
</Info>

<Warning>
**Additional SDK Required:** IncomingCall requires the CometChat Calls SDK. [See Call Features](/ui-kit/react/call-features) for installation steps.
</Warning>
...
<CardGroup cols={3}>
  ...
  <Card title="Call Buttons" icon="phone" href="/ui-kit/react/call-buttons">Add call buttons to chat</Card>
  <Card title="Call Logs" icon="clock-rotate-left" href="/ui-kit/react/call-logs">Display call history</Card>
</CardGroup>
