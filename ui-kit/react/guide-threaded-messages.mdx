---
title: "Threaded Messages Guide - CometChat React UI Kit"
sidebarTitle: "Threaded Messages"
description: "Implement threaded message replies with parent context, reply list, and focused thread composer in CometChat React UI Kit v6."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/guide-block-unblock-user"
prev_page: "/ui-kit/react/guide-overview"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Guides Overview](/ui-kit/react/guide-overview) | [Reference →](/ui-kit/react/methods)
</Info>
