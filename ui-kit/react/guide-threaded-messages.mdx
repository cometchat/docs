...
- [Thread Header](/components/thread-header) — customize the thread header appearance
- [Message List](/components/message-list) — configure message list rendering and options
- [CometChatProvider](/cometchat-provider) — learn about provider configuration
