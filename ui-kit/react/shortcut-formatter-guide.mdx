---
title: "ShortCut Formatter Guide - CometChat React UI Kit"
description: "Implement !shortcut style text expansions with extension APIs or dialogs in CometChat React UI Kit v6. Custom keyboard shortcuts for chat."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/methods"
prev_page: "/ui-kit/react/url-formatter-guide"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← URL Formatter](/ui-kit/react/url-formatter-guide) | [Reference →](/ui-kit/react/methods)
</Info>
