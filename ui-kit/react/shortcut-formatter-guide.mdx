...
<Step title="Import the Formatter">
...
<Step title="Extend the Formatter Class">
...
<Step title="Set Up Tracking Character">
Set up the `trackCharacter` and define any necessary private fields.
<Accordion title="Show Code Snippet" icon="code">
```javascript
...
<Step title="Handle Key Events">
Implement the `onKeyDown` method to handle key events and trigger actions based on defined shortcuts.
<Accordion title="Show Code Snippet" icon="code">
```javascript
...
<Step title="Add Custom Formatter Methods">
