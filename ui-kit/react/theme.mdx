---
title: "Theme & Styling - CometChat React UI Kit"
sidebarTitle: "Overview"
description: "Customize the look and feel of CometChat React UI Kit v6. Override CSS variables, configure dark/light mode, and apply brand colors to chat components."
journey_stage: "customization"
step_number: 5
total_steps: 8
next_page: "/ui-kit/react/theme/color-resources"
prev_page: "/ui-kit/react/ai-assistant-chat"
required_components: []
---

<Info>
📍 **Step 5 of 8: Theme & Style** — [← Components](/ui-kit/react/components-overview) | [Guides →](/ui-kit/react/guide-overview)
</Info>
...
<Tip>
**Theming works best after your features are functional.** If you haven't integrated your components yet, start with [Components](/ui-kit/react/components-overview) first.
</Tip>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Color Resources" icon="palette" href="/ui-kit/react/theme/color-resources">Customize color variables</Card>
  <Card title="Guides" icon="book" href="/ui-kit/react/guide-overview">Step-by-step recipes</Card>
  <Card title="Migration Guide" icon="arrow-right" href="/ui-kit/react/upgrading-from-v5">Upgrade from V5</Card>
</CardGroup>
