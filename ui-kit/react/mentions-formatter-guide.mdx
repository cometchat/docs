...
<Step title="Initialize the Formatter">
Initialize an instance of the formatter and configure it with any required settings, such as the list of users or groups to mention.
</Step>

<Step title="Process Chat Messages">
Once the formatter is initialized, you can process chat messages to format mentions appropriately:
...
<CardGroup cols={1}>
  <Card
    ...
    icon="at"
    iconType="solid"
    href="/ui-kit/react/message-composer"
  >
    Learn how to use the <code>CometChatMentionsFormatter</code> class in components like <b>CometChatConversations</b>, <b>CometChatMessageList</b>, and <b>CometChatMessageComposer</b> to render mentions cleanly.
  </Card>
</CardGroup>
