---
title: "Mentions Formatter Guide - CometChat React UI Kit"
description: "Add @mentions with styled tokens, suggestion list, and click handling in CometChat React UI Kit v6. Format user and group member mentions."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/url-formatter-guide"
prev_page: "/ui-kit/react/custom-text-formatter-guide"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Text Formatter](/ui-kit/react/custom-text-formatter-guide) | [Reference →](/ui-kit/react/methods)
</Info>
