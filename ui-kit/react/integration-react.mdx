...
| Other frameworks | [Next.js](/integration-nextjs) · [React Router](/integration-react-router) · [Astro](/integration-astro) |

</Accordion>

This guide walks you through adding CometChat to a React.js app. By the end you'll have a working chat UI.

{/* TODO:IMAGE - Screenshot of the final result: two-panel chat layout */}
...
`CometChatProvider` handles init, login, plugin registration, theming, locale, and real-time events — no manual setup needed. For advanced use cases (custom login flows, individual providers), see the [CometChatProvider](/cometchat-provider) guide.
