...
{/* TODO:IMAGE - Single chat window showing MessageHeader + MessageList + MessageComposer */}
...
<CardGroup cols={2}>
  ...
  <Card title="Tab-Based Chat" icon="table-columns" href="/react-router-tab-based-chat">
