...
Create a route component for the chat page. `CometChatProvider` handles SDK init and login from the credentials you pass it, the same setup as the integration guide.
