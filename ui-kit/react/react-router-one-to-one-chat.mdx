---
title: "One-to-One/Group Chat - React Router Chat Layout"
sidebarTitle: "One To One/Group Chat"
description: "Build a one-to-one or group chat layout with CometChat React UI Kit. Copy-paste ready code for React Router."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/react-router-tab-based-chat"
prev_page: "/ui-kit/react/react-router-conversation"
required_components: []
---

<Info>
📍 **Step 2 of 8: Setup & First Run** — [← Integration](/ui-kit/react/react-router-integration) | [Features →](/ui-kit/react/core-features)
</Info>
