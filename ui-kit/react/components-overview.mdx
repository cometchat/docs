---
title: "Components overview for the React UI Kit v7"
description: "Understand the component architecture, usage patterns, and available components in the CometChat React UI Kit v7 for building composable chat layouts."
---
