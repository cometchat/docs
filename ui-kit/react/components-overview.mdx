...
| `CometChatMessageBubble` | Message bubble container with alignment, receipts, options, and reactions | [Message Bubble](/components/message-bubble) |
...
| `CometChatReactions` | Reaction chips bar with reactor list popover | [Reactions](/components/reactions) |
| `CometChatReactionList` | Full reactor list with tabs and pagination | [Reaction List](/components/reaction-list) |
| `CometChatActionBubble` | Renders group action and call action system messages | [Action Bubble](/components/action-bubble) |
