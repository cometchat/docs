...
Examples: Avatar, Button, Date, ContextMenu, SearchBar, ConfirmDialog, Popover, MediaRecorder, MessageBubble, Reactions, ActionBubble.
...
Bubble components are documented in the [Plugins](/ui-kit/react/plugins/overview) section alongside their parent plugin. See [Plugins Overview](/ui-kit/react/plugins/overview) for how to customize message rendering.
...
| `CometChatCallActionBubble` | Self-extracting bubble for call status system messages (missed, outgoing, incoming, ended) | [Call Action Bubble](/ui-kit/react/components/call-action-bubble) |
| `CometChatGroupActionBubble` | Self-extracting bubble for group membership system messages (joined, left, kicked, banned, scope change) | [Group Action Bubble](/ui-kit/react/components/group-action-bubble) |
