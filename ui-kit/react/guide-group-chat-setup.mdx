...
- [Groups](/components/groups) — browse and join existing groups
- [Group Members](/components/group-members) — manage group membership
- [Message Header](/components/message-header) — customize the group header
- [CometChatProvider](/cometchat-provider) — configure the root provider
