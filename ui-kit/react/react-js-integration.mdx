---
title: "React.js Integration - CometChat React UI Kit"
sidebarTitle: "Integration"
description: "Step-by-step guide to integrate CometChat React UI Kit into your React.js app. Install dependencies, initialize, authenticate, and run your first chat experience."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/react-conversation"
prev_page: "/ui-kit/react/overview"
required_components: []
---

<Info>
📍 **Step 2 of 8: Setup & First Run** — [← Overview](/ui-kit/react/overview) | [Features →](/ui-kit/react/core-features)
</Info>
...
<Tip>
**You've set up CometChat.** Your app is ready to run with a predefined chat experience.
Pick an experience below, then head to [Features](/ui-kit/react/core-features) to discover what else you can add.
</Tip>
...
<CardGroup cols={3}>
  <Card title="Conversation List + Messages" icon="comments" href="/ui-kit/react/react-conversation">
    Build a conversation list with message view
  </Card>
  <Card title="One-to-One Chat" icon="message" href="/ui-kit/react/react-one-to-one-chat">
    Build a direct messaging experience
  </Card>
  <Card title="Tab-Based Chat" icon="table-columns" href="/ui-kit/react/react-tab-based-chat">
    Build a tabbed chat interface
  </Card>
  <Card title="Explore Features" icon="puzzle-piece" href="/ui-kit/react/core-features">
    Discover all available chat features
  </Card>
</CardGroup>
