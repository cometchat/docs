...
<Tip>
You can **fork** the sandbox, insert your **CometChat credentials** (App ID, Region, Auth Key.) in the code, and immediately preview how the UI and messages respond in real time.
</Tip>
...
<CardGroup cols={2}>
  <Card
    title="Integrate Conversation List + Message"
    icon="comments"
    iconType="solid"
    href="/ui-kit/react/react-conversation"
  >
    Quickly add a conversation list with messages into your app.
  </Card>

  <Card
    title="Integrate One-to-One Chat"
    icon="user"
    iconType="solid"
    href="/ui-kit/react/react-one-to-one-chat"
  >
    Enable direct messaging between individual users.
  </Card>
  ...
  <Card
    ...
    icon="table-columns"
    iconType="solid"
    href="/ui-kit/react/react-tab-based-chat"
  >
    Organize conversations using a tabbed chat interface.
  </Card>
  ...
  >
    Customize layouts, themes, and components to fit your brand.
  </Card>
</CardGroup>
