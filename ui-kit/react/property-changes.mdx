---
title: "Property Changes V5 to V6 - CometChat React UI Kit"
description: "Detailed reference of renamed, added, and removed properties and methods when upgrading from CometChat React UI Kit v5 to v6. Component-by-component migration guide."
journey_stage: "migration"
step_number: 8
total_steps: 8
next_page: ""
prev_page: "/ui-kit/react/upgrading-from-v5"
required_components: []
---

<Info>
📍 **Step 8 of 8: Migration** — [← Upgrading from V5](/ui-kit/react/upgrading-from-v5)
</Info>
...
<CardGroup cols={3}>
  ...
  <Card title="Core Features" icon="puzzle-piece" href="/ui-kit/react/core-features">Discover V6 features</Card>
</CardGroup>
