...
| Prerequisite | Complete [Next.js Integration](/integration-nextjs) first |
...
This assumes you've already completed [Next.js Integration](/integration-nextjs) (project created, UI Kit installed, init + login working).
...
```css title="app/chat/chat.module.css"
...
<CardGroup cols={2}>
  <Card title="One-to-One / Group Chat" icon="message" href="/next-one-to-one-chat">
    Single chat window without a sidebar
  </Card>
  <Card title="Tab-Based Chat" icon="table-columns" href="/next-tab-based-chat">
