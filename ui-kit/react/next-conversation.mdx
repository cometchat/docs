---
title: "Conversation List + Message View - Next.js Chat Layout"
sidebarTitle: "Conversation List + Message View"
description: "Build a conversation list + message view chat layout with CometChat React UI Kit. Copy-paste ready code for Next.js."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/next-one-to-one-chat"
prev_page: "/ui-kit/react/next-js-integration"
required_components: []
---
