...
| --- | --- | --- | --- |
| `@cometchat/chat-uikit-react` | v6 → v7 | Plugin system replaces templates/textFormatters; compound components replace string props; individual hide*Option props consolidated; view props become render props on MessageBubble | [Migration Overview](/migration-overview) |
...
<CardGroup cols={2}>
  <Card title="Migration Overview" icon="arrow-up" href="/migration-overview">
