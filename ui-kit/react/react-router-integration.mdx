...
When your React app uses React Router (v5 or v6) and runs inside an `<iframe>`, you need to ensure CometChat UI Kit mounts into the correct document context. Wrap your routes inside `CometChatFrameProvider`, typically in your entry file (`index.js`/`index.tsx`) or in `App.js`/`App.tsx`.

### Option 1: Wrap at Entry Point
...
### Option 2: Wrap Inside App Component
