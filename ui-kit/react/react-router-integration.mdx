...
<Steps>
<Step title="Create a React Router Project">
...
<CardGroup cols={2}>
  <Card
    ...
    icon="comments"
    iconType="solid"
    href="/ui-kit/react/react-router-conversation"
  >
    Add a conversation list with messages to your React Router-based app.
  </Card>
  ...
  <Card
    ...
    icon="user"
    iconType="solid"
    href="/ui-kit/react/react-router-one-to-one-chat"
  >
    Set up direct messaging between users using React Router.
  </Card>
  ...
  <Card
    ...
    icon="table-columns"
    iconType="solid"
    href="/ui-kit/react/react-router-tab-based-chat"
  >
    Use a tabbed layout to organize chats with React Router.
  </Card>
  ...
  >
    Customize themes and UI components to align with your brand.
  </Card>
</CardGroup>
