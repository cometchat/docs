---
title: "React Router Integration - CometChat React UI Kit"
sidebarTitle: "Integration"
description: "Step-by-step guide to integrate CometChat React UI Kit into your React Router app. Install dependencies, initialize, authenticate, and run your first chat experience."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/react-router-conversation"
...
<CardGroup cols={3}>
  ...
  <Card title="One-to-One Chat" icon="message" href="/ui-kit/react/react-router-one-to-one-chat">
