---
title: "Message Privately Guide - CometChat React UI Kit"
sidebarTitle: "Message Privately"
description: "Launch a direct 1:1 chat from a group member profile in CometChat React UI Kit v6. Private messaging from group context."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/guide-search-messages"
prev_page: "/ui-kit/react/guide-new-chat"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← New Chat](/ui-kit/react/guide-new-chat) | [Reference →](/ui-kit/react/methods)
</Info>
