---
title: "Conversation List + Message View - Astro Chat Layout"
sidebarTitle: "Conversation List + Message View"
description: "Build a conversation list + message view chat layout with CometChat React UI Kit. Copy-paste ready code for Astro."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/astro-one-to-one-chat"
prev_page: "/ui-kit/react/astro-integration"
required_components: []
---

<Info>
📍 **Step 2 of 8: Setup & First Run** — [← Integration](/ui-kit/react/astro-integration) | [Features →](/ui-kit/react/core-features)
</Info>
