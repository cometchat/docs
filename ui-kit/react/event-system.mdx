---
title: "Event system in the React UI Kit v7"
description: "Unified pub/sub event system in the CometChat React UI Kit v7 that merges SDK listener events with local UI events, including card actions and message events."
---
