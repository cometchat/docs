---
title: "Thread Header Component - CometChat React UI Kit"
description: "Display the parent message and reply count of a threaded conversation using the CometChatThreadHeader component. Navigate and manage threaded message discussions in your React chat app."
sidebarTitle: "Thread Header"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/incoming-call"
prev_page: "/ui-kit/react/message-template"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Message Template](/ui-kit/react/message-template) | [Customization →](/ui-kit/react/theme)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">Display thread messages</Card>
  <Card title="Threaded Messages Guide" icon="book" href="/ui-kit/react/guide-threaded-messages">Build threaded conversations</Card>
  <Card title="Customize Theme" icon="palette" href="/ui-kit/react/theme">Style the thread header</Card>
</CardGroup>
