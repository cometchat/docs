---
title: "Conversations Component - CometChat React UI Kit"
description: "Display and manage chat conversations with the CometChat Conversations component. Configure filters, actions, events, and custom views for your React chat app."
sidebarTitle: "Conversations"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/users"
prev_page: "/ui-kit/react/components-overview"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Components Overview](/ui-kit/react/components-overview) | [Customization →](/ui-kit/react/theme)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">Display messages for a conversation</Card>
  <Card title="Users" icon="user" href="/ui-kit/react/users">Browse and select users</Card>
  <Card title="Customize Theme" icon="palette" href="/ui-kit/react/theme">Style your conversation list</Card>
</CardGroup>
