...
You can customize the appearance of the Assistant Chat component using CSS. Below are some examples of how you can style specific elements of the component.

#### Suggested message Pill Styling
...
### Empty Chat Image Views

You can provide a custom image for the empty chat image state using the `emptyChatImageView` prop.
...
You can override the empty chat greeting view using the `emptyChatGreetingView` prop.
