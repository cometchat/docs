---
title: "AI Assistant Chat Component - CometChat React UI Kit"
description: "Build an AI agent chat experience with streaming responses, quick suggestions, chat history, and custom tools using the CometChatAIAssistantChat component in your React chat app."
sidebarTitle: "AI Assistant Chat"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/theme"
prev_page: "/ui-kit/react/search"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Search](/ui-kit/react/search) | [Customization →](/ui-kit/react/theme)
</Info>

<Warning>
**Dashboard Prerequisite:** AI Assistant Chat requires AI configuration in your CometChat Dashboard at Dashboard → AI. [See AI Features](/ui-kit/react/ai-features) for setup details.
</Warning>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="AI Features" icon="robot" href="/ui-kit/react/ai-features">Explore all AI features</Card>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">Display chat messages</Card>
  <Card title="Customize Theme" icon="palette" href="/ui-kit/react/theme">Style the AI assistant</Card>
</CardGroup>
