...
| Report Message Dialog | The Report Message Dialog component displays predefined reporting reasons and allows users to select appropriate categories and provide additional remarks or details about the reported message. |
