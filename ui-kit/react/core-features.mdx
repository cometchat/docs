...
<Note>
**No setup required.** Core features work out of the box once you've integrated the UI Kit. Just follow the [Getting Started](/ui-kit/react/react-js-integration) guide, create users, and send your first message.
</Note>
