---
title: "New Chat Guide - CometChat React UI Kit"
sidebarTitle: "New Chat"
description: "Build a unified new chat entry point for starting 1:1 or group conversations in CometChat React UI Kit v6."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/guide-message-privately"
prev_page: "/ui-kit/react/guide-block-unblock-user"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Block/Unblock](/ui-kit/react/guide-block-unblock-user) | [Reference →](/ui-kit/react/methods)
</Info>
