---
title: "Color Resources & CSS Variables - CometChat React UI Kit"
description: "Complete reference of all CSS variables and color tokens available in the CometChat React UI Kit v6, including primary, neutral, and semantic color palettes for light and dark modes."
journey_stage: "customization"
step_number: 5
total_steps: 8
next_page: "/ui-kit/react/theme/message-bubble-styling"
prev_page: "/ui-kit/react/theme"
required_components: []
---

<Info>
📍 **Step 5 of 8: Theme & Style** — [← Theme Overview](/ui-kit/react/theme) | [Guides →](/ui-kit/react/guide-overview)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message Bubble Styling" icon="message" href="/ui-kit/react/theme/message-bubble-styling">Customize message bubbles</Card>
  <Card title="Localization" icon="globe" href="/ui-kit/react/localize">Add language support</Card>
