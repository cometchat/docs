---
title: "Message Bubble Styling - CometChat React UI Kit"
description: "Customize incoming and outgoing message bubble colors, backgrounds, and styles using CSS variables and class selectors in the CometChat React UI Kit v6."
journey_stage: "customization"
step_number: 5
total_steps: 8
next_page: "/ui-kit/react/localize"
prev_page: "/ui-kit/react/theme/color-resources"
required_components: []
---

<Info>
📍 **Step 5 of 8: Theme & Style** — [← Color Resources](/ui-kit/react/theme/color-resources) | [Guides →](/ui-kit/react/guide-overview)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message Template" icon="file-code" href="/ui-kit/react/message-template">Customize message types</Card>
