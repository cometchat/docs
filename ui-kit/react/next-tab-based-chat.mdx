...
<Steps>
<Step title="Create a Tab Component">
...
These icons are available in the **CometChat UI Kit assets folder**.
<CardGroup cols={1}>
  <Card
    title="GitHub Assets Folder"
    icon="folder"
    iconType="solid"
    href="https://github.com/cometchat/cometchat-uikit-react/tree/v6/sample-app/src/assets"
  >
    Access the assets folder in the React sample app repository.
  </Card>
</CardGroup>
