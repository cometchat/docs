...
description: "Build a tab-based chat interface with Chat, Call Logs, Users, and Settings tabs in Next.js (App Router)."
---
...
<CardGroup cols={2}>
  <Card title="Conversation List + Messages" icon="comments" href="/next-conversation">
