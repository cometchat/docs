---
title: "Tab-Based Chat Experience - Next.js Chat Layout"
sidebarTitle: "Tab Based Chat Experience"
description: "Build a tab-based chat layout with CometChat React UI Kit. Copy-paste ready code for Next.js."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/core-features"
prev_page: "/ui-kit/react/next-one-to-one-chat"
required_components: []
---
