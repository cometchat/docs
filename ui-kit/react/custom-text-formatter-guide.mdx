---
title: "Custom Text Formatter Guide - CometChat React UI Kit"
description: "Extend the CometChatTextFormatter base class to implement custom inline text patterns with regex and callbacks in CometChat React UI Kit v6."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/mentions-formatter-guide"
prev_page: "/ui-kit/react/guide-group-chat"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Group Chat](/ui-kit/react/guide-group-chat) | [Reference →](/ui-kit/react/methods)
</Info>
