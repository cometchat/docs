---
title: "Conversation List + Message View - React.js Chat Layout"
sidebarTitle: "Conversation List + Message View"
description: "Build a conversation list + message view chat layout with CometChat React UI Kit. Copy-paste ready code for React.js."
journey_stage: "getting-started"
step_number: 2
total_steps: 8
next_page: "/ui-kit/react/react-one-to-one-chat"
prev_page: "/ui-kit/react/react-js-integration"
required_components: []
---
