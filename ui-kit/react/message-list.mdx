---
title: "Message List Component - CometChat React UI Kit"
description: "Render a scrollable list of sent and received messages with text, media, reactions, read receipts, and threaded replies using the CometChatMessageList component. Supports custom message templates and date separators."
sidebarTitle: "Message List"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/message-composer"
prev_page: "/ui-kit/react/message-header"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Message Header](/ui-kit/react/message-header) | [Customization →](/ui-kit/react/theme)
</Info>

<Warning>
**Dashboard Prerequisites:** Some features in MessageList require Dashboard configuration:
- **Reactions**: Enable at Dashboard → Chat → Features → Reactions ([see Core Features](/ui-kit/react/core-features))
- **Mentions**: Enable at Dashboard → Chat → Features → Mentions ([see Core Features](/ui-kit/react/core-features))
- **Moderation**: Configure at Dashboard → Chat → Moderation ([see Core Features](/ui-kit/react/core-features))
</Warning>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message Composer" icon="pen" href="/ui-kit/react/message-composer">Add message input</Card>
  <Card title="Message Template" icon="file-code" href="/ui-kit/react/message-template">Customize message bubbles</Card>
  <Card title="Threaded Messages Guide" icon="book" href="/ui-kit/react/guide-threaded-messages">Add threaded conversations</Card>
</CardGroup>
