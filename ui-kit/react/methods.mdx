---
title: "Methods Reference - CometChat React UI Kit"
description: "Complete API reference for CometChat React UI Kit v6 methods including init, login, logout, createUser, and message-sending wrappers."
journey_stage: "api-reference"
step_number: 7
total_steps: 8
next_page: "/ui-kit/react/events"
prev_page: "/ui-kit/react/shortcut-formatter-guide"
required_components: []
---

<Info>
📍 **Step 7 of 8: API Reference** — [← Guides](/ui-kit/react/guide-overview) | [Migration →](/ui-kit/react/upgrading-from-v5)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Events" icon="bolt" href="/ui-kit/react/events">Subscribe to real-time events</Card>
