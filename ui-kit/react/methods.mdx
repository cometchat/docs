...
<CardGroup cols={1}>
  <Card
    title="Chat SDK Wrapper"
    icon="layer-group"
    iconType="solid"
    href="/sdk/javascript/overview"
    cta="Explore Chat SDK"
    arrow
  >
    The CometChat UI Kit encapsulates key Chat SDK methods within a wrapper to efficiently manage internal eventing—simplifying developer experience through abstraction.
  </Card>
</CardGroup>
