...
`CometChatUrlsFormatter` extends [CometChatTextFormatter](/ui-kit/react/v6/custom-text-formatter-guide) to detect URLs in text messages and render them as clickable links.
