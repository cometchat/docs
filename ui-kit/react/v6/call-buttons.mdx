---
title: "Call Buttons"
description: "Add CometChat React UI Kit call buttons for voice and video calls with user or group targets, click callbacks, and error handling."
---
...
Refer to [CometChatOutgoingCall](/ui-kit/react/v6/outgoing-call) for details on each view slot.
