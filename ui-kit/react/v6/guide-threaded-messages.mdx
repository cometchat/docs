...
Before starting, complete the [Getting Started](/ui-kit/react/v6/react-js-integration) guide for your framework.
...
<CardGroup cols={2}>
  ...
  <Card title="Thread Header" href="/ui-kit/react/v6/thread-header">
