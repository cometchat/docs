...
| Other frameworks | [React.js](/ui-kit/react/v6/react-js-integration) · [Next.js](/ui-kit/react/v6/next-js-integration) · [React Router](/ui-kit/react/v6/react-router-integration) |
...
<Card title="Build Conversation List + Message View" href="/ui-kit/react/v6/astro-conversation" icon="comments">
...
<Card title="Build One-to-One / Group Chat" href="/ui-kit/react/v6/astro-one-to-one-chat" icon="message">
  Step-by-step guide to build this layout
</Card>
...
<Card title="Build Tab-Based Chat" href="/ui-kit/react/v6/astro-tab-based-chat" icon="table-columns">
  Step-by-step guide to build this layout
</Card>
