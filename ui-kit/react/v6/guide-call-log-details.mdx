...
| Related | [All Guides](/ui-kit/react/v6/guide-overview) |
...
Before starting, complete the [Getting Started](/ui-kit/react/v6/react-js-integration) guide for your framework and install `@cometchat/calls-sdk-javascript`.
...
<CardGroup cols={2}>
  <Card title="Call Logs" href="/ui-kit/react/v6/call-logs">
    The call logs component reference.
  </Card>
  <Card title="Call Features" href="/ui-kit/react/v6/call-features">
