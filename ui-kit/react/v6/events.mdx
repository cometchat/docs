---
title: "Events in the CometChat React UI Kit v6"
description: "Reference for CometChat React UI Kit v6 events covering conversations, users, groups, messages, calls, and card action taps for cross-component communication."
---
