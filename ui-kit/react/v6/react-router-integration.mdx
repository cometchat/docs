...
description: "Integrate CometChat React UI Kit with React Router using app credentials, package setup, initialization, login, and routed chat views."
---
...
| Other frameworks | [React.js](/ui-kit/react/v6/react-js-integration) · [Next.js](/ui-kit/react/v6/next-js-integration) · [Astro](/ui-kit/react/v6/astro-integration) |
...
<Card title="Build Conversation List + Message View" href="/ui-kit/react/v6/react-router-conversation" icon="comments">
...
<Card title="Build One-to-One / Group Chat" href="/ui-kit/react/v6/react-router-one-to-one-chat" icon="message">
  Step-by-step guide to build this layout
</Card>
...
<Card title="Build Tab-Based Chat" href="/ui-kit/react/v6/react-router-tab-based-chat" icon="table-columns">
  Step-by-step guide to build this layout
</Card>
