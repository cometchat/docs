...
Custom message bubble templates via [CometChatMessageTemplate](/ui-kit/react/v6/message-template).
...
See [CometChatMessageTemplate](/ui-kit/react/v6/message-template).
...
See [CometChatMentionsFormatter](/ui-kit/react/v6/mentions-formatter-guide).
