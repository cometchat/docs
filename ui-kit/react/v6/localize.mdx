...
<Warning>
The translation configurations in this section are to be defined inside the [CometChat's init() method callback](/ui-kit/react/v6/react-js-integration#step-3:-initialize-cometchat-ui-kit).
</Warning>
