...
description: "Build focused CometChat React UI Kit one-to-one or group chat screens with headers, message lists, composers, and direct navigation."
---
...
| Prerequisite | Complete [React.js Integration](/ui-kit/react/v6/react-js-integration) Steps 1–5 first |
...
This assumes you've already completed [React.js Integration](/ui-kit/react/v6/react-js-integration) (project created, UI Kit installed, init + login working, CSS imported).
...
<CardGroup cols={2}>
  ...
  <Card title="React.js Integration" icon="react" href="/ui-kit/react/v6/react-js-integration">
