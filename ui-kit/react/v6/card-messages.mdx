---
title: "Render Card Messages in the React UI Kit v6"
description: "Render developer, persisted agent, and streaming agent Card Messages in the CometChat React UI Kit v6 and handle card actions via the ccCardActionClicked event."
---
