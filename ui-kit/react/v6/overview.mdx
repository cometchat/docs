...
<Note>
🚀 **CometChat React UI Kit v7 (beta) is now available!** It features a revamped component architecture, improved customization, and enhanced performance. [Switch to v7 →](/ui-kit/react/overview)
</Note>
