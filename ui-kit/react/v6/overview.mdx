...
No authentication required. Not needed for the initial integration — the skill handles it without the MCP. For VS Code, Codex, and Claude, see [MCP Integration](/mcp-server).
