...
<Note>
🚀 **CometChat React UI Kit v7 is now available!** It features a revamped component architecture, improved customization, and enhanced performance. [Switch to v7 →](/ui-kit/react/overview)
</Note>
...
<CardGroup cols={2}>
  <Card title="React.js" icon="react" href="/ui-kit/react/v6/react-js-integration">
    Vite or Create React App
  </Card>
  <Card title="Next.js" icon={<img src="/images/icons/nextjs.svg" alt="Next.js" />} href="/ui-kit/react/v6/next-js-integration">
    App Router with client-side rendering
  </Card>
  <Card title="React Router" icon={<img src="/images/icons/react-router.svg" alt="React Router" />} href="/ui-kit/react/v6/react-router-integration">
    SPA with React Router v6+
  </Card>
  <Card title="Astro" icon={<img src="/images/icons/astro.svg" alt="Astro" />} href="/ui-kit/react/v6/astro-integration">
...
<CardGroup cols={2}>
  <Card title="Components" icon="grid-2" href="/ui-kit/react/v6/components-overview">
    Browse all prebuilt UI components
  </Card>
  <Card title="Features" icon="comments" href="/ui-kit/react/v6/core-features">
...
<CardGroup cols={3}>
  ...
  <Card title="Migration Guide" icon="arrow-up" href="/ui-kit/react/v6/upgrading-from-v5">
    Upgrading from v5
  </Card>
</CardGroup>
