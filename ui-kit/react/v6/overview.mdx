...
<CardGroup cols={2}>
  ...
  <Card title="Next.js" icon={<img src="/docs/images/icons/nextjs.svg" alt="Next.js" />} href="/ui-kit/react/v6/next-js-integration">
    App Router with client-side rendering
  </Card>
  <Card title="React Router" icon={<img src="/docs/images/icons/react-router.svg" alt="React Router" />} href="/ui-kit/react/v6/react-router-integration">
    SPA with React Router v6+
  </Card>
  <Card title="Astro" icon={<img src="/docs/images/icons/astro.svg" alt="Astro" />} href="/ui-kit/react/v6/astro-integration">
