...
| Theming | CSS variables replace inline style objects. See [Theming](/ui-kit/react/v6/theme) |
...
In CometChat v6 UI Kit, the [`CometChatLocalize.init()`](/ui-kit/react/v6/localize#initialize-cometchatlocalize) method accepts a [localization setting](/ui-kit/react/v6/localize#localizationsettings) instead of individual parameters.
...
In CometChat v6 UI Kit, translations can be added or overridden using the [`init()`](/ui-kit/react/v6/localize#initialize-cometchatlocalize) method or the [`addTranslation()`](/ui-kit/react/v6/localize#add-custom-translations) method.
...
CometChat v5 UI Kit lacked support for date formatting, but CometChat v6 UI Kit introduces the [`CalendarObject`](/ui-kit/react/v6/localize#calendarobject) for date and time formatting.
...
CometChat v5 UI Kit did not handle missing translation keys, whereas CometChat v6 UI Kit introduces a [`missingKeyHandler`](/ui-kit/react/v6/localize#initialize-cometchatlocalize) for better control.
...
<CardGroup cols={2}>
  <Card title="React.js Integration" href="/ui-kit/react/v6/react-js-integration">
    Fresh v6 setup guide for React.js.
  </Card>
  <Card title="Components Overview" href="/ui-kit/react/v6/components-overview">
    Explore all v6 prebuilt UI components.
  </Card>
  <Card title="Theme" href="/ui-kit/react/v6/theme">
    New CSS variable-based theming system.
  </Card>
  <Card title="Methods" href="/ui-kit/react/v6/methods">
