...
| Full token list | [Color Resources](/ui-kit/react/v6/theme/color-resources) &#124; [GitHub source](https://github.com/cometchat/cometchat-uikit-react/blob/v6/src/styles/css-variables.css) |
...
For the complete list, see [Color Resources](/ui-kit/react/v6/theme/color-resources).
...
Outgoing bubbles use orange; incoming bubbles use a light slate. For more variants, see [Message Bubble Styling](/ui-kit/react/v6/theme/message-bubble-styling).
