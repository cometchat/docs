...
description: "Build CometChat UI Kit conversation list and message view layouts in Next.js with navigation, headers, lists, and composers."
---
...
| Prerequisite | Complete [Next.js Integration](/ui-kit/react/v6/next-js-integration) Steps 1–5 first |
...
This assumes you've already completed [Next.js Integration](/ui-kit/react/v6/next-js-integration) (project created, UI Kit installed, CSS imported).
...
<CardGroup cols={2}>
  ...
  <Card title="Next.js Integration" icon={<img src="/docs/images/icons/nextjs.svg" alt="Next.js" />} href="/ui-kit/react/v6/next-js-integration">
