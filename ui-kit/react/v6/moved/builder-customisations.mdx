...
description: "Customizing Your UI Kit Builder Integration — CometChat documentation."
---
...
1. **Refer to the UI Kit Documentation**\
   Browse the [**UI Kit components overview**](/ui-kit/react/v6/components-overview) to find the component you'd like to customize.\
   *Example*: [**Message List**](/ui-kit/react/v6/message-list)
...
2. **Locate Customization Options**\
   ...
   *Example*: [**Sticky DateTime Format**](/ui-kit/react/v6/message-list#sticky-datetime-format)
...
1. **Component to Customize**:\
   [Message List](/ui-kit/react/v6/message-list)

2. **Customization Option**:\
   [`stickyDateTimeFormat`](/ui-kit/react/v6/message-list#sticky-datetime-format)
