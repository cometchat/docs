...
description: "Build CometChat UI Kit conversation list and message view layouts in React Router with navigation, headers, lists, and composers."
---
...
| Prerequisite | Complete [React Router Integration](/ui-kit/react/v6/react-router-integration) Steps 1–5 first |
...
This assumes you've already completed [React Router Integration](/ui-kit/react/v6/react-router-integration) (project created, UI Kit installed, CSS imported).
...
<CardGroup cols={2}>
  ...
  <Card title="React Router Integration" icon="react" href="/ui-kit/react/v6/react-router-integration">
