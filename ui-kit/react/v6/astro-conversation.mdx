...
description: "Build CometChat UI Kit conversation list and message view layouts in Astro with navigation, headers, lists, and composers."
---
...
| Prerequisite | Complete [Astro Integration](/ui-kit/react/v6/astro-integration) Steps 1–5 first |
...
This assumes you've already completed [Astro Integration](/ui-kit/react/v6/astro-integration) (project created, React added, UI Kit installed).
...
<CardGroup cols={2}>
  ...
  <Card title="Astro Integration" icon={<img src="/images/icons/astro.svg" alt="Astro" />} href="/ui-kit/react/v6/astro-integration">
