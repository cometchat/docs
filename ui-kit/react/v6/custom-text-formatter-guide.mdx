...
| Related | [ShortCut Formatter](/ui-kit/react/v6/shortcut-formatter-guide) \| [Mentions Formatter](/ui-kit/react/v6/mentions-formatter-guide) \| [All Guides](/ui-kit/react/v6/guide-overview) |
...
A hashtag formatter used with [CometChatMessageList](/ui-kit/react/v6/message-list) and [CometChatMessageComposer](/ui-kit/react/v6/message-composer).
...
<CardGroup cols={2}>
  <Card title="Mentions Formatter" href="/ui-kit/react/v6/mentions-formatter-guide">
