...
<Note>
Before proceeding, ensure you have completed the [UI Kit integration](/ui-kit/react/v6/getting-started) and the [Dashboard Setup](/campaigns#setup-flow) for Campaigns.
</Note>
...
See the full [CometChatNotificationFeed component documentation](/ui-kit/react/v6/notification-feed) for all configuration options, styling, and customization.
...
<CardGroup cols={2}>
  ...
  <Card title="CometChatNotificationFeed" icon="bell" href="/ui-kit/react/v6/notification-feed">
