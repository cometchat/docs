...
<Note>
Before proceeding, ensure you have completed the [UI Kit integration](/ui-kit/react/v6/overview) and the [Dashboard Setup](/campaigns#setup-flow) for Campaigns.
</Note>
