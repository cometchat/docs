...
`CometChatDetails` is a [Component](/ui-kit/react/v4/components-overview#components) that provides additional information and settings related to a specific user.
