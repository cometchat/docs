...
This element uses [Icon element](/ui-kit/react/v4/icon) and [Label element](/ui-kit/react/v4/label) to show text and icon(with background) and along with an alignment property to align the icon around the text. The purpose of this element is to initiate an action.
