---
title: "Block & Unblock Users Guide - CometChat React UI Kit"
sidebarTitle: "Block/Unblock Users"
description: "Implement block and unblock user functionality in CometChat React UI Kit v6 with composer state management and event handling."
journey_stage: "advanced-recipes"
step_number: 6
total_steps: 8
next_page: "/ui-kit/react/guide-new-chat"
prev_page: "/ui-kit/react/guide-threaded-messages"
required_components: []
---

<Info>
📍 **Step 6 of 8: Advanced Recipes** — [← Threaded Messages](/ui-kit/react/guide-threaded-messages) | [Reference →](/ui-kit/react/methods)
</Info>
