---
title: "Upgrading From V5 to V6 - CometChat React UI Kit"
description: "Step-by-step migration guide for upgrading from CometChat React UI Kit v5 to v6 with breaking changes, new patterns, and localization updates."
journey_stage: "migration"
step_number: 8
total_steps: 8
next_page: "/ui-kit/react/property-changes"
prev_page: "/ui-kit/react/events"
required_components: []
---

<Info>
📍 **Step 8 of 8: Migration** — [← Reference](/ui-kit/react/methods) | [Property Changes →](/ui-kit/react/property-changes)
</Info>
...
<Tip>
**Migrating from V5?** After updating, review the [Components](/ui-kit/react/components-overview) section for the new V6 API patterns.
</Tip>
...
<CardGroup cols={3}>
  <Card title="Property Changes" icon="list-check" href="/ui-kit/react/property-changes">V5 to V6 property mapping</Card>
  <Card title="Overview" icon="house" href="/ui-kit/react/overview">Start fresh with V6</Card>
  <Card title="Browse Components" icon="cubes" href="/ui-kit/react/components-overview">Explore V6 components</Card>
</CardGroup>
