---
title: "Message Header Component - CometChat React UI Kit"
description: "Display user or group details in the chat toolbar with avatar, name, status, typing indicator, and back navigation using the CometChatMessageHeader component. Supports custom views and CSS styling."
sidebarTitle: "Message Header"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/message-list"
prev_page: "/ui-kit/react/group-members"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Group Members](/ui-kit/react/group-members) | [Customization →](/ui-kit/react/theme)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Message List" icon="list" href="/ui-kit/react/message-list">Display messages below the header</Card>
  <Card title="Message Composer" icon="pen" href="/ui-kit/react/message-composer">Add message input below the list</Card>
  <Card title="Customize Theme" icon="palette" href="/ui-kit/react/theme">Style the message header</Card>
</CardGroup>
