...
<Warning>
**Beta Release** - React UI Kit v7 is currently in beta. Breaking changes may be introduced before the GA release.
</Warning>
...
| Source | {/* TODO: Update when v7 branch is public */} [GitHub](https://github.com/cometchat/cometchat-uikit-react/tree/v7) |
...
<CardGroup cols={2}>
  <Card title="React.js" icon="react" href="/integration-react">
    Vite or Create React App
  </Card>
  <Card title="Next.js" icon="server" href="/integration-nextjs">
    App Router with client-side rendering
  </Card>
  <Card title="React Router" icon="route" href="/integration-react-router">
    SPA with React Router v6+
  </Card>
  <Card title="Astro" icon="rocket" href="/integration-astro">
...
<CardGroup cols={3}>
  ...
  <Card title="Migration Guide" icon="arrow-up" href="/migration/overview">
    Upgrading from v6
  </Card>
</CardGroup>
