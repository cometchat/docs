---
title: "React UI Kit Overview - CometChat"
sidebarTitle: "Overview"
description: "Get started with CometChat React UI Kit v6. Build chat, voice, and video features into your React app with pre-built components."
journey_stage: "overview"
step_number: 1
total_steps: 8
next_page: "/ui-kit/react/react-js-integration"
prev_page: ""
required_components: []
---

<Info>
📍 **Step 1 of 8: Welcome** — [Getting Started →](/ui-kit/react/react-js-integration)
</Info>
