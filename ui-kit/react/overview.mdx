...
| Peer deps | `react` >=18 <21, `react-dom` >=18 <21, `@cometchat/chat-sdk-javascript` ^4 |
...
The versions above are correct as of `@cometchat/chat-uikit-react@7.2.1`. The authoritative ranges are always the `peerDependencies` block of the version you install — check it with `npm view @cometchat/chat-uikit-react peerDependencies`.
</Note>
