...
<CardGroup cols={1}>
  <Card
    ...
    arrow
  >
    Explore JSON files for all supported languages in the CometChat UI Kit repository.
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card
    ...
    arrow
  >
    View the full TypeScript class file that handles localization in the CometChat UI Kit.
  </Card>
</CardGroup>
