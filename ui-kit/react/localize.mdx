---
title: "Localization & Translations - CometChat React UI Kit"
sidebarTitle: "Localize"
description: "Configure multi-language localization, custom translations, and date/time formatting in CometChat React UI Kit v6. Supports 19 languages with fallback and auto-detection."
journey_stage: "customization"
step_number: 5
total_steps: 8
next_page: "/ui-kit/react/sound-manager"
prev_page: "/ui-kit/react/theme/message-bubble-styling"
required_components: []
---

<Info>
📍 **Step 5 of 8: Theme & Style** — [← Message Bubble Styling](/ui-kit/react/theme/message-bubble-styling) | [Guides →](/ui-kit/react/guide-overview)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Sound Manager" icon="volume-high" href="/ui-kit/react/sound-manager">Customize notification sounds</Card>
