...
Plugins act as a routing layer — they decide which bubble component to render for a given message type and provide context menu options and conversation previews. The bubble components themselves are standalone and can be used independently of the plugin system.
