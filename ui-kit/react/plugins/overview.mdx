...
| --- | --- | --- |
| [Text](/plugins/text) | `text` | Formatted text with mentions, URLs, markdown |
| [Image](/plugins/image) | `image` | Image grid with captions, click-to-fullscreen |
| [Video](/plugins/video) | `video` | Video player with thumbnail |
| [File](/plugins/file) | `file` | File card with download button |
| [Audio](/plugins/audio) | `audio` | Waveform audio player |
| [Polls](/plugins/polls) | `extension_poll` | Poll creation + voting bubble |
| [Stickers](/plugins/stickers) | `extension_sticker` | Sticker image bubble |
| [Collaborative Document](/plugins/collaborative-document) | `extension_document` | Document collaboration link |
| [Collaborative Whiteboard](/plugins/collaborative-whiteboard) | `extension_whiteboard` | Whiteboard collaboration link |
| [Group Action](/plugins/group-action) | `groupMember` | "User joined", "User left" system messages |
| [Call Action](/plugins/call-action) | `audio`, `video` (call category) | "Missed call", "Call ended" system messages |
| [Delete](/plugins/delete) | Any (deleted) | "This message was deleted" placeholder |
...
For a complete tutorial with sending, receiving, and styling, see [Creating a Custom Plugin](/plugins/custom-plugin).
...
<CardGroup cols={2}>
  <Card title="Text Plugin" icon="font" href="/plugins/text">
  ...
  <Card title="Custom Plugin" icon="puzzle-piece" href="/plugins/custom-plugin">
    Build your own plugin from scratch
  </Card>
  <Card title="Text Formatters" icon="wand-magic-sparkles" href="/plugins/text-formatters">
