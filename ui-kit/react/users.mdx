---
title: "Users Component - CometChat React UI Kit"
description: "Display and manage the list of all available users with avatars, names, and online/offline status using the CometChatUsers component. Configure search, filters, and custom views."
sidebarTitle: "Users"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/groups"
prev_page: "/ui-kit/react/conversations"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Conversations](/ui-kit/react/conversations) | [Customization →](/ui-kit/react/theme)
</Info>
...
<CardGroup cols={3}>
  ...
  <Card title="Block/Unblock Guide" icon="ban" href="/ui-kit/react/guide-block-unblock-user">Block and unblock users</Card>
</CardGroup>
