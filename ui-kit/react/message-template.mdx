...
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| **type**        | Sets the type of `CometChatMessage`. Maps your MessageTemplate to the corresponding message type.                                                                        | `type("text")`                |
| **category**    | Sets the category of the `MessageTemplate` and links it with a `CometChatMessage` of the same category. [Learn more](/sdk/javascript/message-structure-and-hierarchy)     | `category("custom")`          |
| **headerView**  | Assigns a custom header view to the Message Bubble. Default shows sender’s name.                                                                                         | `headerView(() => <Header />)`|
| **contentView** | Assigns a custom content view to the Message Bubble. Default displays text, image, file, audio, or video bubble depending on message type.                              | `contentView(() => <Content />)` |
| **footerView**  | Assigns a custom footer view to the Message Bubble. Default shows reactions.                                                                                             | `footerView(() => <Footer />)` |
| **bottomView**  | Assigns a custom bottom view. Default includes link previews or “load more” button for long messages.                                                                   | `bottomView(() => <Bottom />)` |
| **bubbleView**  | Assigns a fully custom bubble view. By default, this is composed of `headerView`, `contentView`, `statusInfoView`, and `footerView`.                                     | `bubbleView(() => <Bubble />)` |
| **statusInfoView** | Assigns a custom status info view. Default shows receipt and timestamp.                                                                                                | `statusInfoView(() => <StatusInfo />)` |
| **options**     | Defines the list of user actions on a message like react, edit, or delete.                                                                                               | `options(["react", "delete"])` |
...
```
<AccordionGroup>
<Accordion title="Existing Templates">
...
<Accordion title="StatusInfoView">
