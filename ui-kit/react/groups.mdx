---
title: "Groups Component - CometChat React UI Kit"
description: "Display and manage the list of all available groups with icons, names, member counts, and group type indicators using the CometChatGroups component. Configure filters, actions, and custom views."
sidebarTitle: "Groups"
journey_stage: "component-integration"
step_number: 4
total_steps: 8
next_page: "/ui-kit/react/group-members"
prev_page: "/ui-kit/react/users"
required_components: []
---

<Info>
📍 **Step 4 of 8: Component Integration** — [← Users](/ui-kit/react/users) | [Customization →](/ui-kit/react/theme)
</Info>
...
## Next Steps
<CardGroup cols={3}>
  <Card title="Group Members" icon="users" href="/ui-kit/react/group-members">Manage group members</Card>
  <Card title="Group Chat Guide" icon="book" href="/ui-kit/react/guide-group-chat">Build a group chat experience</Card>
  <Card title="Customize Theme" icon="palette" href="/ui-kit/react/theme">Style your groups list</Card>
</CardGroup>
