...
Open `http://localhost:4321/chat`. You should see the chat window load with the conversation for the UID or GUID you set.
...
<CardGroup cols={2}>
  <Card title="Conversation List + Messages" icon="comments" href="/astro-conversation">
