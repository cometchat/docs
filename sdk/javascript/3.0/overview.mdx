...
This guide demonstrates how to add chat to a JavaScript application using CometChat. Before you begin, we strongly recommend you read the [Key Concepts](/sdk/javascript/3.0/key-concepts) guide.
...
* Please refer to the [Chat Widget](https://assets.cometchat.io/legacy-docs/widget/html/legacy.html) section to integrate Chat Widget in your Website.
