...
Please follow the [setup](/sdk/javascript/3.0/setup) instructions to upgrade to latest version of V3 before proceeding further
...
You can read more about the `markAsDelivered()` method [here](/sdk/javascript/3.0/messaging-receipts#mark-messages-as-delivered).
...
You can read more about the `markAsRead()` method [here](/sdk/javascript/3.0/messaging-receipts#mark-messages-as-read).
