...
All three calling flows — [Call Session](/calls/v4/javascript/call-session), [Standalone Calling](/calls/v4/javascript/standalone-calling), and [Ringing](/calls/v4/javascript/ringing) — use the same `OngoingCallListener`.
...
| `onSessionTimeout()`                   | —                                                                         | The call was auto-terminated due to inactivity. _v4.1.0+_                 |
