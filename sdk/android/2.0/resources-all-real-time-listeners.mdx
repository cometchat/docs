...
1. [UserListener](/sdk/android/2.0/resources-all-real-time-listeners#user-listener)
2. [GroupListener](/sdk/android/2.0/resources-all-real-time-listeners#group-listener)
3. [MessageListener](/sdk/android/2.0/resources-all-real-time-listeners#message-listener)
4. [CallListener](/sdk/android/2.0/resources-all-real-time-listeners#call-listener)
