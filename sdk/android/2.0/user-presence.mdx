...
When you [retrieve the list of users](/sdk/android/2.0/retrieve-users), in the [User](/sdk/android/2.0/user-management#user-class) object, you will receive 2 keys:
