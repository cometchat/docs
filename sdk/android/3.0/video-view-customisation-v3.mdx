...
Once you have decided to implement [Default Calling](/sdk/android/3.0/default-calling-v3) or [Direct Calling](/sdk/android/3.0/direct-calling-v3) calling and followed the steps to implement them. Just few additional methods will help you quickly customize the main video container.

Please make sure your callSettings is configured accordingly for [Default Calling](/sdk/android/3.0/default-calling-v3) or [Direct Calling](/sdk/android/3.0/direct-calling-v3).
