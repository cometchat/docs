...
This guide demonstrates how to add chat to an Android application. Before you begin, we strongly recommend you read the [Key Concepts](/sdk/android/3.0/key-concepts) guide.
...
* [Presence Subscription](/sdk/android/3.0/user-presence): Represents the subscription type for user presence (real-time online/offline status)
...
* Please refer [Android Java UI Kit](/ui-kit/android/v3/overview) section to integrate Android Java UI Kit inside your app.
