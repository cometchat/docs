...
When you [retrieve the list of users](/sdk/android/3.0/users-retrieve-users), in the [User](/sdk/android/3.0/users-user-management#user-class) object, you will receive 2 keys:
