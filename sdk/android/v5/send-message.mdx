...
files.add(new File("/storage/emulated/0/Download/photo-3.jpg"));
...
val files = listOf(
    ...
    File("/storage/emulated/0/Download/photo-3.jpg")
)
...
MediaUploadListener uploadListener = new MediaUploadListener() {
    ...
    // Rejected — NOT retryable (size/invalid file, or a server policy denial).
