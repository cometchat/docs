...
Using CometChat, you can send four types of messages:
...
4. A [Card Message](/sdk/android/v5/send-message#card-message), a structured, interactive card message (receive-only — created via the REST API).
