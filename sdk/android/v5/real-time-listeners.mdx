...
<Tab title="Java">
```java
CometChat.addAIAssistantListener(UNIQUE_LISTENER_ID, new CometChat.CallListener() {
  @Override
...
<Tab title="Kotlin">
```kotlin
CometChat.addAIAssistantListener(UNIQUE_LISTENER_ID, object : CometChat.CallListener() {
