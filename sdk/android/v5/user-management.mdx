...
description: "Programmatically create and log in CometChat users from your Android app to map your app's own users to CometChat."
---
...
2. You [log in the user to CometChat](/sdk/android/v5/authentication-overview) (programmatically)
...
For more details on the fields present in the User class, please check [this](/sdk/android/v5/user-management#user-class)
