...
Know more about auto mode connection [click here](/sdk/android/v5/connection-behaviour#auto-mode)
...
Know more about manual mode connection [click here](/sdk/android/v5/connection-behaviour#manual-mode)
