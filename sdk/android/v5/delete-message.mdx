...
While [deleting a message](/sdk/android/v5/delete-message#delete-a-message) is straightforward, receiving events for deleted messages with CometChat has two parts:

1. Adding a listener to receive [real-time message deletes](/sdk/android/v5/delete-message#real-time-message-delete-events) when your app is running.
2. Calling a method to retrieve [missed message delete events](/sdk/android/v5/delete-message#missed-message-delete-events)-me when your app was not running.
