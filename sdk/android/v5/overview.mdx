...
<Warning>
This is SDK v5 (`5.0.4`). It includes breaking changes from v4 — see the [Migration Guide](/sdk/android/v5/upgrading-from-v4) before upgrading.
</Warning>
...
```groovy
dependencies { 
  implementation "com.cometchat:chat-sdk-android:5.0.4"
}
```
