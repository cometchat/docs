...
| -------- | ------ | -------------- |
| macOS | ✅ Supported | Precompiled (UE 5.5 and 5.7) or build from source |
| Windows (Win64) | ✅ Supported | Precompiled (UE 5.5) or build from source |
| iOS | ✅ Supported | Build from source |
| Android | ✅ Supported | Build from source |

<Note>
iOS and Android compile from source and link the bundled static libraries automatically — see [Setup](/sdk/unreal/setup) for both paths.
</Note>
