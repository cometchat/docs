...
1. [User Listener](/sdk/ionic/3.0/resources-all-real-time-listeners#user-listener)
2. [Group Listener](/sdk/ionic/3.0/resources-all-real-time-listeners#group-listener)
3. [Message Listener](/sdk/ionic/3.0/resources-all-real-time-listeners#message-listener)
4. [Call Listener](/sdk/ionic/3.0/resources-all-real-time-listeners#call-listener)
