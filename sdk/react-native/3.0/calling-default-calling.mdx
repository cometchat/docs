...
As mentioned in the [Overview](/sdk/react-native/3.0/calling-default-calling) section, Once the call is initiated, there are three options that can be possible:
