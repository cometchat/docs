...
1. [User Listener](/sdk/react-native/2.0/resources-all-real-time-listeners#user-listener)
2. [Group Listener](/sdk/react-native/2.0/resources-all-real-time-listeners#group-listener)
3. [Message Listener](/sdk/react-native/2.0/resources-all-real-time-listeners#message-listener)
