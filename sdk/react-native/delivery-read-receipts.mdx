...
| Method | Description |
| --- | --- |
| Key Methods | `addMessageListener()`, `getMessageReceipts()`, `markAsDelivered()`, `markAsRead()`, `markConversationAsDelivered()`, `markConversationAsRead()`, `markMessageAsUnread()`, `removeMessageListener()` |
