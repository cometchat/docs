...
- **`@react-native-async-storage/async-storage` is a required peer dep** — the SDK persists
  session state through it. Install and pod-install it, or `init` fails at runtime.
