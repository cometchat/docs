...
description: "Migration guide for upgrading from CometChat iOS SDK v2.x to v3.x with breaking changes and new features."
---
...
- **v3 compatibility:** v3 apps only work with v3.x SDKs (not v2.x)
- **Migration:** Use CometChat Dashboard to migrate v2 app to v3
- **Setup:** Follow [Setup guide](/sdk/ios/setup) for v3 installation
- **Related:** [Upgrading from V3](/sdk/ios/upgrading-from-v3-to-v4) · [Setup](/sdk/ios/setup) · [Overview](/sdk/ios/overview)
</Info>
