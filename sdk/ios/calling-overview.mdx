...
description: "Voice and video calling integration with CometChat for iOS, including one-on-one calls, group calls, and conferences."
---

CometChat's Calling SDK enables you to add voice and video calling to your iOS application. The Calling SDK works alongside the Chat SDK to provide a complete communication experience including 1-on-1 calls, group calls, and conference sessions.
