---
title: "Rate Limits"
description: "Understanding CometChat API rate limits for iOS SDK operations including core, messaging, and calling limits."
---
...
- **Core operations:** 10,000 requests/minute (login, create user, join group, etc.)
- **Messaging:** 30 messages/second per user
- **Calls:** Based on plan — check Dashboard for specifics
- **Note:** Limits are cumulative across operation types
- **Related:** [Overview](/sdk/ios/overview) · [Setup](/sdk/ios/setup) · [Key Concepts](/sdk/ios/key-concepts)
</Info>
