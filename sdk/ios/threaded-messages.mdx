...
description: "Send, receive, and fetch CometChat threaded messages in iOS conversations using parent message IDs."
---
...
<CardGroup cols={2}>
  <Card title="Thread Subscription" icon="bell" href="/sdk/ios/thread-subscription">
    Subscribe to or unsubscribe from a thread, and fetch the threads a user participates in
  </Card>
