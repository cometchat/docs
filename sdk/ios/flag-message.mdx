...
- **Flag message:** `CometChat.flagMessage(messageId:onSuccess:onError:)`
...
```json
{
  "message": "Message 37783 has been flagged successfully."
}
```
</Tab>
...
```json
{
  "errorCode": "ERR_MODERATION_NOT_ENABLED",
  "errorMessage": "Moderation feature is not enabled for this app."
}
```
</Tab>
</Tabs>
