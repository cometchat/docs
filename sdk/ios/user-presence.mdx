...
<Accordion title="Sample Payloads - subscribeToUserPresence">
<Tabs>
<Tab title="Request">
```json
{
...
<Tab title="Info Response">
```json
{
  "note": "User presence subscription is configured via AppSettings.subscribePresenceForAllUsers() during SDK initialization",
  "status": "configured_globally"
}
```
</Tab>
</Tabs>
