...
description: "Edit CometChat text and custom messages after sending them with the iOS SDK and update message state in chats."
---
...
Tags are your own free-form labels and are unrelated to pinning a message — to pin one, use [Pin & Save Messages](/sdk/ios/pin-save-message).

```swift
let tags = ["important", "follow-up"]
let textMessage = TextMessage(receiverUid: "cometchat-uid-2", text: "Tagged message", receiverType: .user)
textMessage.id = 12345
