...
description: "Understanding the message categories, types, and hierarchy in the CometChat iOS SDK."
---
...
- **Categories:** `message`, `action`, `call`, `custom`
- **Message types:** `text`, `image`, `video`, `audio`, `file`
- **Action types:** Group member actions (joined, left, kicked, banned, etc.)
- **Custom types:** User-defined types for custom messages
