...
description: "Guide to customizing the video container and layout in CometChat iOS SDK calls."
---
...
- **Related:** [Call Session](/sdk/ios/direct-calling) · [Presenter Mode](/sdk/ios/presenter-mode) · [Calling Overview](/sdk/ios/calling-overview)
</Info>
