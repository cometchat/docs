...
- **Fetch messages with mentions:** `MessagesRequest.MessageRequestBuilder().mentionsWithTagInfo(true).build()`
...
<Accordion title="Sample Payloads - mentionsWithTagInfo">
<Tabs>
<Tab title="Request">
```json
{
  ...
  "messages": [
    {
      ...
      "sentAt": 1771586600,
      "text": "Hello <@uid:cometchat-uid-2>",
      "mentionedUsers": [
        {
          "uid": "cometchat-uid-2",
          "name": "George Alan",
