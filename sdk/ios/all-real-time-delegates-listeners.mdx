...
- **Related:** [User Presence](/sdk/ios/user-presence) · [Receive Message](/sdk/ios/receive-message) · [Ringing](/sdk/ios/calling-overview)
...
| **onMessagePinned(message:** [`BaseMessage`](/sdk/reference/messages#basemessage)**)** | *Available since v4.1.9.* This event is triggered when a message is pinned. Broadcast to everyone in the conversation. See [Pin & Save Messages](/sdk/ios/pin-save-message). |
| **onMessageUnpinned(message:** [`BaseMessage`](/sdk/reference/messages#basemessage)**)** | *Available since v4.1.9.* This event is triggered when a message is unpinned. Broadcast to everyone in the conversation. |
| **onMessageSaved(message:** [`BaseMessage`](/sdk/reference/messages#basemessage)**)** | *Available since v4.1.9.* This event is triggered when a message is saved. Private — reaches only the saving user's other devices. |
| **onMessageUnsaved(message:** [`BaseMessage`](/sdk/reference/messages#basemessage)**)** | *Available since v4.1.9.* This event is triggered when a message is unsaved. Private — reaches only the saving user's other devices. |
...
<CardGroup cols={2}>
  ...
  <Card title="Login Listeners" icon="right-to-bracket" href="/sdk/ios/authentication-overview">
