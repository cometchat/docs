---
title: "AI Moderation"
description: "Automatically review CometChat messages for inappropriate content in Flutter apps using AI moderation rules and message status updates."
---
...
| Purpose | Automatically review CometChat messages for inappropriate content in Flutter apps using AI moderation rules and message status updates. |
| Key methods | `addMessageListener()` · `removeMessageListener()` · `sendMessage()` |
| Key classes | `TextMessage` · `BaseMessage` · `CometChatException` · `MediaMessage` |
| Listener callbacks | `onMessageModerated()` |
...
| Full reference | [`TextMessage`](/sdk/reference/messages#textmessage) · [`BaseMessage`](/sdk/reference/messages#basemessage) · [`CometChatException`](/sdk/reference/auxiliary#cometchatexception) · [`MediaMessage`](/sdk/reference/messages#mediamessage) |
