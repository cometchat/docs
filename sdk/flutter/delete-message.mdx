...
description: "Delete CometChat messages in Flutter apps and handle real-time or missed message deletion events."
---
...
| Purpose | Delete CometChat messages in Flutter apps and handle real-time or missed message deletion events. |
| Key methods | `addMessageListener()` · `deleteMessage()` |
| Key classes | `BaseMessage` · `CometChatException` |
| Listener callbacks | `onMessageDeleted()` |
...
| Related | [Send A Message](/sdk/flutter/send-message) · [Edit A Message](/sdk/flutter/edit-message) |
