---
title: "Setup"
description: "Install, configure, initialize, and log in users with the CometChat Flutter SDK using app keys and region."
---
...
| Purpose | Install, configure, initialize, and log in users with the CometChat Flutter SDK using app keys and region. |
| Key methods | `init()` |
...
| Related | [Authentication](/sdk/flutter/authentication-overview) · [Chat SDK](/sdk/flutter/overview) |
