...
description: "Filter CometChat messages in Flutter apps by limit, message ID, timestamp, user, group, category, type, and other request options."
---
...
We recommend before trying this, you refer to the [Message Structure and Hierarchy](/sdk/flutter/messaging-overview#message-structure-and-hierarchy) guide to get familiar with the various categories of messages.
...
We recommend you refer to the [Message Structure and Hierarchy](/sdk/flutter/messaging-overview#message-structure-and-hierarchy) guide to get familiar with the various types of messages before trying this out.
