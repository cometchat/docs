---
title: "Join A Group"
description: "Join CometChat public and password-protected groups in Flutter apps using group GUIDs and password validation."
---
...
| Purpose | Join CometChat public and password-protected groups in Flutter apps using group GUIDs and password validation. |
| Key methods | `addGroupListener()` · `joinGroup()` |
| Key classes | `Group` · `Action` · `CometChatException` · `User` · `CometChatGroupType` |
| Listener callbacks | `onGroupMemberJoined()` |
