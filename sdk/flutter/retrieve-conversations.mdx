...
description: "Fetch, filter, tag, and search CometChat conversations in Flutter apps using conversation request builders."
---
...
| Purpose | Fetch, filter, tag, and search CometChat conversations in Flutter apps using conversation request builders. |
| Key methods | `getConversation()` · `getConversationFromMessage()` · `tagConversation()` |
...
| Related | [Delete A Conversation](/sdk/flutter/delete-conversation) · [Receive A Message](/sdk/flutter/receive-messages) |
