...
For more details, see the [Message Structure and Hierarchy](/sdk/flutter/v4/message-structure-and-hierarchy) guide.
...
| Interactive Message | Message with actionable UI elements (forms, cards, buttons) | [Interactive Messages](/sdk/flutter/v4/interactive-messages) |
