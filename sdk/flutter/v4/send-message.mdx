...
You can also send [Interactive Messages](/sdk/flutter/v4/interactive-messages) for forms, cards, and custom UI elements.
...
It is also possible to send interactive messages from CometChat , to know more [click here](/sdk/flutter/v4/interactive-messages)
