...
For the complete SDK error code reference, see [Error Codes](/sdk/flutter/v4/error-codes). Common errors you'll encounter:
...
| `TOO_MANY_REQUEST` | Rate limit exceeded | See [Rate Limits](/sdk/flutter/v4/rate-limits) |
...
<CardGroup cols={2}>
  ...
  <Card title="Best Practices" icon="check" href="/sdk/flutter/v4/best-practices">
    Recommended patterns and practices
  </Card>
  <Card title="Error Codes" icon="triangle-exclamation" href="/sdk/flutter/v4/error-codes">
