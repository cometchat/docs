...
description: "Create CometChat public, private, and password-protected groups in Flutter apps with group GUID, name, type, and password."
---
...
| Purpose | Create CometChat public, private, and password-protected groups in Flutter apps with group GUID, name, type, and password. |
| Key methods | `createGroup()` · `createGroupWithMembers()` |
| Key classes | `Group` · `GroupMember` · `CometChatMemberScope` · `CometChatException` · `CometChatGroupType` |
...
| Related | [Join A Group](/sdk/flutter/join-group) · [Update A Group](/sdk/flutter/update-group) · [Delete A Group](/sdk/flutter/delete-group) · [Add Members To A Group](/sdk/flutter/group-add-members) |
