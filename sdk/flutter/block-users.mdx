---
title: "Block Users"
description: "Block and unblock CometChat users in Flutter apps to stop direct communication and manage blocked user lists."
---
...
| Purpose | Block and unblock CometChat users in Flutter apps to stop direct communication and manage blocked user lists. |
| Key methods | `blockUser()` · `unblockUser()` |
| Key classes | `User` · `CometChatException` · `CometChatBlockedUsersDirection` |
...
| Related | [Retrieve Users](/sdk/flutter/retrieve-users) · [User Management](/sdk/flutter/user-management) |
