...
description: "Edit CometChat text and custom messages in Flutter apps and handle real-time or missed edit events."
---
...
| Purpose | Edit CometChat text and custom messages in Flutter apps and handle real-time or missed edit events. |
| Key methods | `addMessageListener()` · `editMessage()` |
| Key classes | `BaseMessage` · `TextMessage` · `CometChatException` |
| Listener callbacks | `onMessageEdited()` |
...
| Related | [Send A Message](/sdk/flutter/send-message) · [Delete A Message](/sdk/flutter/delete-message) |
