...
description: "Fetch CometChat group members in Flutter apps with group GUID, pagination limits, search keywords, and member scopes."
---
...
| Purpose | Fetch CometChat group members in Flutter apps with group GUID, pagination limits, search keywords, and member scopes. |
| Key classes | `Group` · `CometChatUserStatus` · `CometChatException` · `GroupMember` |
...
| Related | [Add Members To A Group](/sdk/flutter/group-add-members) · [Change Member Scope](/sdk/flutter/group-change-member-scope) |
| Full reference | [`Group`](/sdk/reference/entities#group) · [`CometChatException`](/sdk/reference/auxiliary#cometchatexception) · [`GroupMember`](/sdk/reference/entities#groupmember) |
