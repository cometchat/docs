...
description: "Create, update, and manage CometChat users in Flutter apps before login using user objects, auth keys, and REST API workflows."
---
...
| Purpose | Create, update, and manage CometChat users in Flutter apps before login using user objects, auth keys, and REST API workflows. |
| Key methods | `createUser()` · `updateCurrentUserDetails()` |
| Key classes | `User` · `CometChatException` |
...
| Related | [Users](/sdk/flutter/users-overview) · [Retrieve Users](/sdk/flutter/retrieve-users) |
