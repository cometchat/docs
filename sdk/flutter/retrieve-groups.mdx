...
description: "Fetch CometChat groups in Flutter apps with pagination, search keywords, joined-only filters, tags, and group request builders."
---
...
| Purpose | Fetch CometChat groups in Flutter apps with pagination, search keywords, joined-only filters, tags, and group request builders. |
...
| Related | [Groups](/sdk/flutter/groups-overview) · [Join A Group](/sdk/flutter/join-group) |
