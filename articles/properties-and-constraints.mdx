...
| Pinned messages per conversation                | 100 per conversation, whether pinned by users or by the app                                                                                                            |
| Saved messages per user                         | 100 per user. Saved messages are private to the user who saved them.                                                                                                   |
| Pinned conversations per user                   | 5 per user                                                                                                                                                             |
| Globally pinned conversations per app           | 5 per app, shown at the top for every end user                                                                                                                         |
