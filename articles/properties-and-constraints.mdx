...
| Pinned messages per conversation                | Configured per app. Pins made on behalf of a user and pins made as the app (without `onBehalfOf`) count against separate budgets.                                      |
| Saved messages per user                         | Configured per app. Saved messages are private to the user who saved them.                                                                                             |
